...
## Version 1.3 — Content Factory Standard

Canonical release: 2026-08-31. This release incorporates the founder-approved clarification of necessary, neutral coverage of religion and politics. Versions 1.0, 1.1 and 1.2 remain immutable historical baselines; the learning principles and real-world taxonomy are unchanged.
...
- educational;
- durable;
- fair, objective and non-polarising in its treatment.

Sensitivity is assessed from the proposed topic, its educational purpose and its actual treatment. A field name, taxonomy code or the presence of a religion, theology, political science or civics branch does not by itself make a field ineligible for creation or review.

##### Necessary, Neutral Knowledge Coverage

When religion, politics or another potentially sensitive subject is part of the real knowledge being explained, MapKAI may introduce it simply and proportionately. This includes an introductory account of a field's questions, branches, methods, institutions, beliefs, practices or relevant historical development.

Necessary, neutral coverage may proceed through the normal creator and independent-review chain without a blanket field-level hold, provided that:

- the coverage has a clear educational reason grounded in the real field, concept, historical development or application;
- the amount of detail fits the artifact's cognitive purpose; an Overview should provide orientation rather than become a dispute or a detailed doctrinal or partisan argument;
- the treatment is factual, fair, objective, respectful, non-persuasive and non-extreme;
- descriptions of beliefs, doctrines and political positions are clearly attributed to their traditions or proponents, rather than asserted as MapKAI's beliefs or recommendations;
- established facts, interpretations, value judgements and contested claims are distinguished where relevant;
- meaningful differences are represented fairly in proportion to the evidence; objectivity does not require presenting unsupported claims as equal to established evidence;
- material factual and historical claims have appropriate reliable sources, and sensitive passages receive explicit independent review of necessity, neutrality and sourcing.

For example, an Arts and Humanities Overview may explain that religion and theology examine beliefs, texts, practices and questions of meaning without endorsing a religion or claiming its superiority. A Social Sciences Overview may explain how political science studies power, institutions and collective decisions without promoting a party, candidate or ideology. A Religion or Political Science introduction may orient learners within the real field under the same conditions.

Do not erase real branches or alter the canonical taxonomy to avoid making this distinction.

##### High-Risk Topics and Treatment

Until separately approved scope and review standards exist, the factory must not autonomously advance content centred on:

- contemporary partisan advocacy, election campaigning or persuasion for a party or candidate;
- ideological advocacy or propaganda;
- religious persuasion, or claims that a religion is true or superior;
- inflammatory political or religious identity conflicts;
- extremist advocacy, glorification or recruitment;
- geopolitical propaganda or advocacy;
- highly polarising contemporary culture-war disputes.

A brief, necessary educational description of such a phenomenon is not automatically an endorsement. Its necessity, attribution, sourcing and treatment must be judged in context. A promise to be neutral does not by itself clear a high-risk central topic.

When a proposed artifact centres a high-risk topic, or the reviewer cannot establish the necessity, neutrality, factual basis or safe scope of its sensitive passages, mark:

`SENSITIVE_TOPIC_REVIEW_REQUIRED`

and hold the affected artifact for a human decision. A question not covered by policy remains `POLICY_CLARIFICATION_REQUIRED`. Do not hold unrelated fields automatically.

The hold must state the actual scope concern or quote the relevant passage. A field identifier or a taxonomy inventory alone is not sufficient evidence of a boundary violation.

This boundary also qualifies the use of potentially sensitive examples elsewhere in the policy, including the modern-reality examples in Principle 17. The least-sensitive-example rule below remains binding whenever another example would explain the idea equally well.

The core principles are:

> **Necessary knowledge deserves fair, objective treatment. Unnecessary controversy should not be introduced.**
