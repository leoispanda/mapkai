...
## Version 1.0 — Independent Quality-Control Standard

### Status and relationship

MapKAI Review Policy v1.0 is an independent quality-control standard for the MapKAI Content Factory.
...
Independently check the final artifact against the current canonical Creating Policy v1.1. This is not a creator self-check.
...
The reviewer must perform a final independent verification against canonical Creating Policy v1.1.
