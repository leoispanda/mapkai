...
## Version 1.2 — Independent Quality-Control Standard

### Status and relationship

MapKAI Review Policy v1.2 is an independent quality-control standard for the MapKAI Content Factory.

The immutable v1.0 and v1.1 baselines remain available for historical review records. This v1.2 release preserves the five-layer review architecture and taxonomy metadata compliance, and aligns sensitive-content review with the founder-approved necessary, neutral coverage rule.

It operates under the current canonical Creating Policy:

**policy/mapkai-creating-policy-v1.3.md**
...
Independently check the final artifact against the current canonical Creating Policy v1.3. This is not a creator self-check.
...
It protects learners from unnecessary controversy, persuasion, extreme treatment and unsupported claims while preserving fair, objective coverage of the real field. Religion, theology, political science and civics are legitimate knowledge areas; their presence in a taxonomy is not a violation.

### Scope and treatment assessment

The reviewer must distinguish:

- no material sensitive content;
- necessary, proportionate and neutral educational coverage;
- an unnecessary sensitive example that can be replaced locally;
- a high-risk central topic or treatment requiring a human decision.

A normal field introduction or brief description of a relevant belief, institution, political concept or historical context may PASS after the complete review chain. Do not block an umbrella field solely because one of its branches concerns religion or politics, and do not delete real branches to avoid reviewing them.

### Violation condition

The artifact violates this gate when it:

- centres high-risk advocacy, campaigning, religious persuasion, extremist glorification, inflammatory identity conflict, geopolitical propaganda or a highly polarising contemporary dispute without the separately approved scope and review required by Creating Policy;
- introduces sensitive material for a hook, drama, analogy, familiarity, storytelling or intellectual tension when a lower-sensitivity example explains the idea equally well;
- endorses a religion, party, candidate or ideology instead of describing it for an educational purpose;
- presents a belief or contested interpretation as an established universal fact;
- stereotypes or disparages groups, or uses inflammatory or extreme framing;
- claims objectivity while selectively representing evidence, or gives unsupported claims false equivalence with established evidence;
- proceeds despite unresolved necessity, neutrality, factuality, sourcing or scope.

### Evidence requirement

For material sensitive passages, record:

- the exact passage and artifact location;
- its topic and educational purpose;
- why its inclusion is necessary, and whether a lower-sensitivity alternative would work equally well;
- reliable source references and the factual status of the claims;
- attribution of beliefs, positions and contested interpretations;
- an explicit neutrality, proportionality and non-persuasion check;
- the conclusion and any remaining concern.

The review must include a sensitive-content assessment even when the conclusion is that no material sensitive content is present. A keyword scan, a field name or the creator's assurance is not enough to establish neutrality or a violation.

### Repairability and consequence

- Necessary, proportionate, well-sourced and objective coverage may PASS when every other applicable gate and quality requirement also passes.
- An unnecessary sensitive example may result in REVISE with `SENSITIVE_EXAMPLE_UNNECESSARY` and a concrete replacement.
- Advocacy, extreme treatment, a materially misleading claim or a structural boundary violation requires REBUILD or BLOCKED according to the evidence and repair path.
- A high-risk central topic or unresolved necessity, neutrality, factuality, sourcing or scope requires `SENSITIVE_TOPIC_REVIEW_REQUIRED` and BLOCKED pending a human decision.

Scope is assessed at the artifact and passage level. The same real field can contain ordinary educational material and topics that require a hold. Neither the absence of deterministic signals nor a neutral-sounding prompt is a final review decision.
...
The reviewer must perform a final independent verification against canonical Creating Policy v1.3.
