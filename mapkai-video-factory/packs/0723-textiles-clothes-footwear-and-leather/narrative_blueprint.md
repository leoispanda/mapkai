# Narrative Blueprint: Textiles (clothes, footwear and leather)

**Selected engine:** journey
...
Begin at one concrete scale of textiles (clothes, footwear and leather) and travel through the connected levels required to understand it.
...
The tension is between an intuitive local answer and the broader structure that Textiles (clothes, footwear and leather) is designed to reveal.
