# MapKAI Editorial Knowledge Pack: Medical diagnostic and treatment technology

**Formal field:** Medical diagnostic and treatment technology (医学诊断与治疗技术) · **Code:** 0914 · **Group:** Health · **Knowledge continent:** Health and Welfare

## Field Identity

Medical diagnostic and treatment technology is a formal field within Health. It develops specialised knowledge, methods, and judgment for questions that belong to this part of Health and Welfare.

The identity of a field is not just a label for subject matter. It is a compact agreement about what counts as a worthwhile question, what evidence deserves trust, and what kinds of explanation are adequate. Medical diagnostic and treatment technology shares a border with neighbouring disciplines because real problems rarely respect academic boundaries. Its distinctiveness lies in the angle it brings to that shared terrain: it asks the central question below with characteristic tools, then tests or interprets the answers in its own way.

## Central Question

What must we understand about medical diagnostic and treatment technology in order to make better explanations, choices, and interventions?
...
### Applied Medical diagnostic and treatment technology 

Applied Medical diagnostic and treatment technology — using those ideas in real settings. In this overview, treat it as one intellectual territory within the larger map: a way the field extends its central question into a region where a different kind of evidence, model, or practical consequence becomes necessary. Its boundary with the other regions matters because no single perspective can carry the whole question alone.

### Boundary questions 

Boundary questions — where Medical diagnostic and treatment technology needs neighbouring fields to explain the whole problem. In this overview, treat it as one intellectual territory within the larger map: a way the field extends its central question into a region where a different kind of evidence, model, or practical consequence becomes necessary. Its boundary with the other regions matters because no single perspective can carry the whole question alone.
...
Therapy and rehabilitation (0915) is a neighbouring MapKAI field whose questions overlap with this one. In this overview, treat it as a boundary where concepts, evidence, or practical problems cross from one field into another: a way the field extends its central question into a region where a different kind of evidence, model, or practical consequence becomes necessary. Its boundary with the other regions matters because no single perspective can carry the whole question alone.
...
A general learner should be able to recognise the characteristic questions of Medical diagnostic and treatment technology, identify the kind of evidence it trusts, and know when another field is needed.
...
- **After the Threshold Was Lowered** — A hospital director lowers a laboratory threshold to miss fewer affected people, only to discover that the same move sends many unaffected people into follow-up.
- **The Doctor Who Saw Every Shadow** — After missing a faint abnormality, imaging doctor Gu Qing marks every gray shadow suspicious until false alarms fill the corridor and obscure the original problem.
- **Twelve Thermometers That Agreed and Were Wrong** — Twelve thermometers in a community clinic agree perfectly, but their shared master thermometer reveals that agreement can preserve the same hidden bias.
