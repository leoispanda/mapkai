...
Begin with two plausible explanations of the same law problem and let their conflict expose the field's method.
...
The tension is between an intuitive local answer and the broader structure that Law is designed to reveal.
