# Narrative Blueprint: Domestic services
...
Begin with an apparently sensible claim about domestic services and show the condition under which it reverses or becomes incomplete.
...
The tension is between an intuitive local answer and the broader structure that Domestic services is designed to reveal.
