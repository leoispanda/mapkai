...
Begin at one concrete scale of fine arts and travel through the connected levels required to understand it.
...
The tension is between an intuitive local answer and the broader structure that Fine arts is designed to reveal.
