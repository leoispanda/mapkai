# MapKAI Editorial Knowledge Pack: Teacher training without subject specialisation

**Formal field:** Teacher training without subject specialisation (非学科专项教师培养) · **Code:** 0113 · **Group:** Education · **Knowledge continent:** Education

## Field Identity

Teacher training without subject specialisation is a formal field within Education. It develops specialised knowledge, methods, and judgment for questions that belong to this part of Education.

The identity of a field is not just a label for subject matter. It is a compact agreement about what counts as a worthwhile question, what evidence deserves trust, and what kinds of explanation are adequate. Teacher training without subject specialisation shares a border with neighbouring disciplines because real problems rarely respect academic boundaries. Its distinctiveness lies in the angle it brings to that shared terrain: it asks the central question below with characteristic tools, then tests or interprets the answers in its own way.

## Central Question

What must we understand about teacher training without subject specialisation in order to make better explanations, choices, and interventions?
...
Societies cannot pass knowledge, skills, and judgment to another generation by accident.
...
It studies learning as a process shaped by attention, development, teaching, curriculum, evidence, and institutions.
...
### Foundations of Teacher training without subject specialisation 

Foundations of Teacher training without subject specialisation — its core concepts and vocabulary. In this overview, treat it as one intellectual territory within the larger map: a way the field extends its central question into a region where a different kind of evidence, model, or practical consequence becomes necessary. Its boundary with the other regions matters because no single perspective can carry the whole question alone.

### Education methods 

Education methods — the evidence and practices that make claims testable or interpretable. In this overview, treat it as one intellectual territory within the larger map: a way the field extends its central question into a region where a different kind of evidence, model, or practical consequence becomes necessary. Its boundary with the other regions matters because no single perspective can carry the whole question alone.

### Applied Teacher training without subject specialisation 

Applied Teacher training without subject specialisation — using those ideas in real settings. In this overview, treat it as one intellectual territory within the larger map: a way the field extends its central question into a region where a different kind of evidence, model, or practical consequence becomes necessary. Its boundary with the other regions matters because no single perspective can carry the whole question alone.

### Boundary questions 

Boundary questions — where Teacher training without subject specialisation needs neighbouring fields to explain the whole problem. In this overview, treat it as one intellectual territory within the larger map: a way the field extends its central question into a region where a different kind of evidence, model, or practical consequence becomes necessary. Its boundary with the other regions matters because no single perspective can carry the whole question alone.
...
learning by doing In this overview, treat it as a landmark shift in the field's mental model: a way the field extends its central question into a region where a different kind of evidence, model, or practical consequence becomes necessary. Its boundary with the other regions matters because no single perspective can carry the whole question alone.
...
curriculum In this overview, treat it as a landmark shift in the field's mental model: a way the field extends its central question into a region where a different kind of evidence, model, or practical consequence becomes necessary. Its boundary with the other regions matters because no single perspective can carry the whole question alone.

### assessment

assessment In this overview, treat it as a landmark shift in the field's mental model: a way the field extends its central question into a region where a different kind of evidence, model, or practical consequence becomes necessary. Its boundary with the other regions matters because no single perspective can carry the whole question alone.

### instructional design

instructional design In this overview, treat it as a landmark shift in the field's mental model: a way the field extends its central question into a region where a different kind of evidence, model, or practical consequence becomes necessary. Its boundary with the other regions matters because no single perspective can carry the whole question alone.
...
It developed from family teaching and apprenticeship through mass schooling, teacher education, psychology, and modern learning research.
...
schools In this overview, treat it as a concrete route from abstract reasoning to practical consequence: a way the field extends its central question into a region where a different kind of evidence, model, or practical consequence becomes necessary. Its boundary with the other regions matters because no single perspective can carry the whole question alone.

### teacher development

teacher development In this overview, treat it as a concrete route from abstract reasoning to practical consequence: a way the field extends its central question into a region where a different kind of evidence, model, or practical consequence becomes necessary. Its boundary with the other regions matters because no single perspective can carry the whole question alone.

### assessment

assessment In this overview, treat it as a concrete route from abstract reasoning to practical consequence: a way the field extends its central question into a region where a different kind of evidence, model, or practical consequence becomes necessary. Its boundary with the other regions matters because no single perspective can carry the whole question alone.

### educational technology

educational technology In this overview, treat it as a concrete route from abstract reasoning to practical consequence: a way the field extends its central question into a region where a different kind of evidence, model, or practical consequence becomes necessary. Its boundary with the other regions matters because no single perspective can carry the whole question alone.
...
Education science (0111) is a neighbouring MapKAI field whose questions overlap with this one. In this overview, treat it as a boundary where concepts, evidence, or practical problems cross from one field into another: a way the field extends its central question into a region where a different kind of evidence, model, or practical consequence becomes necessary. Its boundary with the other regions matters because no single perspective can carry the whole question alone.

### Training for pre-school teachers (0112) is a neighbouring MapKAI field whose questions overlap with this one.

Training for pre-school teachers (0112) is a neighbouring MapKAI field whose questions overlap with this one. In this overview, treat it as a boundary where concepts, evidence, or practical problems cross from one field into another: a way the field extends its central question into a region where a different kind of evidence, model, or practical consequence becomes necessary. Its boundary with the other regions matters because no single perspective can carry the whole question alone.

### Teacher training with subject specialisation (0114) is a neighbouring MapKAI field whose questions overlap with this one.

Teacher training with subject specialisation (0114) is a neighbouring MapKAI field whose questions overlap with this one. In this overview, treat it as a boundary where concepts, evidence, or practical problems cross from one field into another: a way the field extends its central question into a region where a different kind of evidence, model, or practical consequence becomes necessary. Its boundary with the other regions matters because no single perspective can carry the whole question alone.
...
A general learner should be able to recognise the characteristic questions of Teacher training without subject specialisation, identify the kind of evidence it trusts, and know when another field is needed.
...
- **Three Short Lines in the Margin** — Racing to prepare perfect workbooks for an inspection, a teacher discovers that the untidy margins contain the clue her marks have missed.
- **Three Small Tables in the Classroom** — Separate help keeps a lesson moving until a shared expedition exposes how much knowledge the classroom has placed out of reach.
- **The Ten Minutes Lost Each Day** — A teacher tries louder instructions, stricter timing, and finally gives up a lesson so the class can build a dependable way to change tasks.
