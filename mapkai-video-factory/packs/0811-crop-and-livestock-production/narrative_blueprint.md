# Narrative Blueprint: Crop and livestock production

**Selected engine:** journey

## Central Narrative Device

A harvest appears to come from one field, until we notice every unseen relationship that made it possible.
...
Begin at one concrete scale of crop and livestock production and travel through the connected levels required to understand it.
...
The tension is between an intuitive local answer and the broader structure that Crop and livestock production is designed to reveal.
...
A general learner should be able to recognise the characteristic questions of Crop and livestock production, identify the kind of evidence it trusts, and know when another field is needed.
