# Narrative Blueprint: Library, information and archival studies

**Selected engine:** intellectual conflict

## Central Narrative Device

A city appears chaotic until a map reveals the rules that quietly organise its movement.
...
Begin with two plausible explanations of the same library, information and archival studies problem and let their conflict expose the field's method.
...
The tension is between an intuitive local answer and the broader structure that Library, information and archival studies is designed to reveal.
...
A general learner should be able to recognise the characteristic questions of Library, information and archival studies, identify the kind of evidence it trusts, and know when another field is needed.
