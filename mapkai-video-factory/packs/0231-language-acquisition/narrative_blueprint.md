# Narrative Blueprint: Language acquisition
...
Begin with two plausible explanations of the same language acquisition problem and let their conflict expose the field's method.
...
The tension is between an intuitive local answer and the broader structure that Language acquisition is designed to reveal.
