# MapKAI Editorial Knowledge Pack: Language acquisition

**Formal field:** Language acquisition (语言习得) · **Code:** 0231 · **Group:** Languages · **Knowledge continent:** Arts and Humanities

## Field Identity

Language acquisition is a formal field within Languages. It develops specialised knowledge, methods, and judgment for questions that belong to this part of Arts and Humanities.

The identity of a field is not just a label for subject matter. It is a compact agreement about what counts as a worthwhile question, what evidence deserves trust, and what kinds of explanation are adequate. Language acquisition shares a border with neighbouring disciplines because real problems rarely respect academic boundaries. Its distinctiveness lies in the angle it brings to that shared terrain: it asks the central question below with characteristic tools, then tests or interprets the answers in its own way.

## Central Question

What must we understand about language acquisition in order to make better explanations, choices, and interventions?
...
Languages methods — the evidence and practices that make claims testable or interpretable. In this overview, treat it as one intellectual territory within the larger map: a way the field extends its central question into a region where a different kind of evidence, model, or practical consequence becomes necessary. Its boundary with the other regions matters because no single perspective can carry the whole question alone.
...
A general learner should be able to recognise the characteristic questions of Language acquisition, identify the kind of evidence it trusts, and know when another field is needed.
...
- **Bread Before Grammar** — A new baker can recite the city's grammar but cannot fill an order until words arrive with loaves, gestures, and a date she can see.
- **The Error That Kept Moving** — A trade apprentice's mistakes keep changing form, while her customers understand more of what she is trying to do.
- **The Red Line Beneath the Ending** — A tailoring apprentice understands whole orders yet keeps missing the quiet ending that separates work already done from work still promised.
