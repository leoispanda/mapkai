# Narrative Blueprint: Basic programmes and qualifications

**Selected engine:** dilemma

## Central Narrative Device

A traveller discovers that the map is useless until they can read its symbols.
...
The tension is between an intuitive local answer and the broader structure that Basic programmes and qualifications is designed to reveal.
