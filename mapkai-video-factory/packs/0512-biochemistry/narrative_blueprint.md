# Narrative Blueprint: Biochemistry
...
Begin with a minimal, serious hypothetical world in which one ordinary feature of biochemistry is altered. Follow what breaks.
...
The tension is between an intuitive local answer and the broader structure that Biochemistry is designed to reveal.
...
A general learner should be able to recognise the characteristic questions of Biochemistry, identify the kind of evidence it trusts, and know when another field is needed.
