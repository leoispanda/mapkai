# MapKAI Editorial Knowledge Pack: Occupational health and safety

**Formal field:** Occupational health and safety (职业健康与安全) · **Code:** 1022 · **Group:** Hygiene and occupational health services · **Knowledge continent:** Services

## Field Identity

Occupational health and safety is a formal field within Hygiene and occupational health services. It develops specialised knowledge, methods, and judgment for questions that belong to this part of Services.

The identity of a field is not just a label for subject matter. It is a compact agreement about what counts as a worthwhile question, what evidence deserves trust, and what kinds of explanation are adequate. Occupational health and safety shares a border with neighbouring disciplines because real problems rarely respect academic boundaries. Its distinctiveness lies in the angle it brings to that shared terrain: it asks the central question below with characteristic tools, then tests or interprets the answers in its own way.

## Central Question

What must we understand about occupational health and safety in order to make better explanations, choices, and interventions?
...
Applied Occupational health and safety — using those ideas in real settings. In this overview, treat it as one intellectual territory within the larger map: a way the field extends its central question into a region where a different kind of evidence, model, or practical consequence becomes necessary. Its boundary with the other regions matters because no single perspective can carry the whole question alone.

### Boundary questions 

Boundary questions — where Occupational health and safety needs neighbouring fields to explain the whole problem. In this overview, treat it as one intellectual territory within the larger map: a way the field extends its central question into a region where a different kind of evidence, model, or practical consequence becomes necessary. Its boundary with the other regions matters because no single perspective can carry the whole question alone.
...
A general learner should be able to recognise the characteristic questions of Occupational health and safety, identify the kind of evidence it trusts, and know when another field is needed.
...
- **A New Mask for Every Worker** — A furniture factory responds to stronger solvent fumes with better masks but never asks whether the fumes can be kept out of the workshop.
- **The Night Shift When Five Defences Were Open** — After a packaging-machine injury, the manager blames the worker who pressed the final button; the investigation finds aligned gaps in five earlier defences.
- **The Lifeboat That Had Never Been Needed** — A ferry gradually skips lifeboat checks to depart on time; years without an emergency become the strongest reason to keep skipping them.
