# Narrative Blueprint: Natural environments and wildlife

**Selected engine:** discovery

## Central Narrative Device

A familiar event becomes a mystery when the first explanation fails a careful measurement.
...
The tension is between an intuitive local answer and the broader structure that Natural environments and wildlife is designed to reveal.
