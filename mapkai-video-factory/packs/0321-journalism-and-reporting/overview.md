# MapKAI Editorial Knowledge Pack: Journalism and reporting

**Formal field:** Journalism and reporting (新闻与报道) · **Code:** 0321 · **Group:** Journalism and information · **Knowledge continent:** Social Sciences, Journalism and Information

## Field Identity

Journalism and reporting is a formal field within Journalism and information. It develops specialised knowledge, methods, and judgment for questions that belong to this part of Social Sciences, Journalism and Information.

The identity of a field is not just a label for subject matter. It is a compact agreement about what counts as a worthwhile question, what evidence deserves trust, and what kinds of explanation are adequate. Journalism and reporting shares a border with neighbouring disciplines because real problems rarely respect academic boundaries. Its distinctiveness lies in the angle it brings to that shared terrain: it asks the central question below with characteristic tools, then tests or interprets the answers in its own way.

## Central Question

What must we understand about journalism and reporting in order to make better explanations, choices, and interventions?
...
### Foundations of Journalism and reporting 

Foundations of Journalism and reporting — its core concepts and vocabulary. In this overview, treat it as one intellectual territory within the larger map: a way the field extends its central question into a region where a different kind of evidence, model, or practical consequence becomes necessary. Its boundary with the other regions matters because no single perspective can carry the whole question alone.

### Journalism and information methods 

Journalism and information methods — the evidence and practices that make claims testable or interpretable. In this overview, treat it as one intellectual territory within the larger map: a way the field extends its central question into a region where a different kind of evidence, model, or practical consequence becomes necessary. Its boundary with the other regions matters because no single perspective can carry the whole question alone.

### Applied Journalism and reporting 

Applied Journalism and reporting — using those ideas in real settings. In this overview, treat it as one intellectual territory within the larger map: a way the field extends its central question into a region where a different kind of evidence, model, or practical consequence becomes necessary. Its boundary with the other regions matters because no single perspective can carry the whole question alone.

### Boundary questions 

Boundary questions — where Journalism and reporting needs neighbouring fields to explain the whole problem. In this overview, treat it as one intellectual territory within the larger map: a way the field extends its central question into a region where a different kind of evidence, model, or practical consequence becomes necessary. Its boundary with the other regions matters because no single perspective can carry the whole question alone.
...
A general learner should be able to recognise the characteristic questions of Journalism and reporting, identify the kind of evidence it trusts, and know when another field is needed.
...
- **The Dam That Broke Before Dawn** — Three callers report that the north dam has failed, but a reporter finds they are repeating one sentence from an inn.
- **A Noticeboard with Room for Three Things** — The newspaper can pin only three pages outside each day, and the town begins treating those three things as the whole city.
- **Three Voices from One Mouth** — A reporter finds three people who confirm a grain ship has sunk, then discovers they all heard the same story.
