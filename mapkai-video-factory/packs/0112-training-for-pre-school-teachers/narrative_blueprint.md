# Narrative Blueprint: Training for pre-school teachers

**Selected engine:** thought experiment
...
Begin with a minimal, serious hypothetical world in which one ordinary feature of training for pre-school teachers is altered. Follow what breaks.
...
The tension is between an intuitive local answer and the broader structure that Training for pre-school teachers is designed to reveal.
