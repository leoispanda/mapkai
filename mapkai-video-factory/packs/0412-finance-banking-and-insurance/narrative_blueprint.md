# Narrative Blueprint: Finance, banking and insurance

**Selected engine:** dilemma

## Central Narrative Device

A promise between strangers becomes possible only when money, records, and rules begin to agree.
...
The tension is between an intuitive local answer and the broader structure that Finance, banking and insurance is designed to reveal.
