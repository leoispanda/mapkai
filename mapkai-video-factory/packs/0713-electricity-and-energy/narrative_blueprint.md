# Narrative Blueprint: Electricity and energy
...
Begin with a familiar electricity and energy phenomenon that becomes puzzling under a careful question. Delay the definition until the puzzle creates a need for the field.
...
The tension is between an intuitive local answer and the broader structure that Electricity and energy is designed to reveal.
