...
Begin at one concrete scale of fisheries and travel through the connected levels required to understand it.
...
The tension is between an intuitive local answer and the broader structure that Fisheries is designed to reveal.
