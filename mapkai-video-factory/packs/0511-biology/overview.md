# MapKAI Editorial Knowledge Pack: Biology

**Formal field:** Biology (生物学) · **Code:** 0511 · **Group:** Biological and related sciences · **Knowledge continent:** Natural Sciences, Mathematics and Statistics

## Field Identity

Biology is a formal field within Biological and related sciences. It develops specialised knowledge, methods, and judgment for questions that belong to this part of Natural Sciences, Mathematics and Statistics.

The identity of a field is not just a label for subject matter. It is a compact agreement about what counts as a worthwhile question, what evidence deserves trust, and what kinds of explanation are adequate. Biology shares a border with neighbouring disciplines because real problems rarely respect academic boundaries. Its distinctiveness lies in the angle it brings to that shared terrain: it asks the central question below with characteristic tools, then tests or interprets the answers in its own way.

## Central Question

What must we understand about biology in order to make better explanations, choices, and interventions?
...
Foundations of Biology — its core concepts and vocabulary. In this overview, treat it as one intellectual territory within the larger map: a way the field extends its central question into a region where a different kind of evidence, model, or practical consequence becomes necessary. Its boundary with the other regions matters because no single perspective can carry the whole question alone.

### Biological and related sciences methods 

Biological and related sciences methods — the evidence and practices that make claims testable or interpretable. In this overview, treat it as one intellectual territory within the larger map: a way the field extends its central question into a region where a different kind of evidence, model, or practical consequence becomes necessary. Its boundary with the other regions matters because no single perspective can carry the whole question alone.

### Applied Biology 

Applied Biology — using those ideas in real settings. In this overview, treat it as one intellectual territory within the larger map: a way the field extends its central question into a region where a different kind of evidence, model, or practical consequence becomes necessary. Its boundary with the other regions matters because no single perspective can carry the whole question alone.

### Boundary questions 

Boundary questions — where Biology needs neighbouring fields to explain the whole problem. In this overview, treat it as one intellectual territory within the larger map: a way the field extends its central question into a region where a different kind of evidence, model, or practical consequence becomes necessary. Its boundary with the other regions matters because no single perspective can carry the whole question alone.
...
A general learner should be able to recognise the characteristic questions of Biology, identify the kind of evidence it trusts, and know when another field is needed.
...
- **The Moths That Never Changed Colour** — As the woods darken, pale moths become rarer, though a child never sees a single moth change colour.
- **The Greenhouse That Never Stood Still** — A greenhouse temperature stays in a narrow range all day, so an apprentice assumes every window and valve should remain still.
- **Good Seed in the Wrong Valley** — The most productive wheat from Gold Valley is sent to Mist Valley and loses its first contest to an overlooked local seed.
