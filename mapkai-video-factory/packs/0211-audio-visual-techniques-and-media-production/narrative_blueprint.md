# Narrative Blueprint: Audio-visual techniques and media production

**Selected engine:** intellectual conflict

## Central Narrative Device

An old object changes meaning each time it is placed beside a different object.
...
Begin with two plausible explanations of the same audio-visual techniques and media production problem and let their conflict expose the field's method.
...
The tension is between an intuitive local answer and the broader structure that Audio-visual techniques and media production is designed to reveal.
