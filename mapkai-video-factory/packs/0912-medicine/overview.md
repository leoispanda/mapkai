# MapKAI Editorial Knowledge Pack: Medicine

**Formal field:** Medicine (医学) · **Code:** 0912 · **Group:** Health · **Knowledge continent:** Health and Welfare

## Field Identity

Medicine is a formal field within Health. It develops specialised knowledge, methods, and judgment for questions that belong to this part of Health and Welfare.

The identity of a field is not just a label for subject matter. It is a compact agreement about what counts as a worthwhile question, what evidence deserves trust, and what kinds of explanation are adequate. Medicine shares a border with neighbouring disciplines because real problems rarely respect academic boundaries. Its distinctiveness lies in the angle it brings to that shared terrain: it asks the central question below with characteristic tools, then tests or interprets the answers in its own way.

## Central Question

What must we understand about medicine in order to make better explanations, choices, and interventions?
...
Applied Medicine — using those ideas in real settings. In this overview, treat it as one intellectual territory within the larger map: a way the field extends its central question into a region where a different kind of evidence, model, or practical consequence becomes necessary. Its boundary with the other regions matters because no single perspective can carry the whole question alone.

### Boundary questions 

Boundary questions — where Medicine needs neighbouring fields to explain the whole problem. In this overview, treat it as one intellectual territory within the larger map: a way the field extends its central question into a region where a different kind of evidence, model, or practical consequence becomes necessary. Its boundary with the other regions matters because no single perspective can carry the whole question alone.
...
A general learner should be able to recognise the characteristic questions of Medicine, identify the kind of evidence it trusts, and know when another field is needed.
...
- **The Headache That Rested on Sundays** — A factory doctor calls printing apprentice Xiaopu's workday headaches stress because they disappear on Sundays, until the same pattern spreads across the room and makes the convenient answer dangerous.
- **One Hundred and Twenty Red Slips** — A health director celebrates 120 positive screens in a low-risk workforce, until the red slips are sorted by the starting frequency of disease and the test's false-positive rate.
- **The Patient Missing from the Paper** — A young doctor follows a celebrated trial for roof worker Old Qi, then discovers that his ladders, wages, and most important treatment burden never appeared in the paper's table.
