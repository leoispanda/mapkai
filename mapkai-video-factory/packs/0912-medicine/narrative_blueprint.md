...
Begin with a familiar medicine phenomenon that becomes puzzling under a careful question. Delay the definition until the puzzle creates a need for the field.
...
The tension is between an intuitive local answer and the broader structure that Medicine is designed to reveal.
