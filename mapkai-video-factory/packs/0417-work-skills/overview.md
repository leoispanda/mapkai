# MapKAI Editorial Knowledge Pack: Work skills

**Formal field:** Work skills (工作技能) · **Code:** 0417 · **Group:** Business and administration · **Knowledge continent:** Business, Administration and Law

## Field Identity

Work skills is a formal field within Business and administration. It develops specialised knowledge, methods, and judgment for questions that belong to this part of Business, Administration and Law.

The identity of a field is not just a label for subject matter. It is a compact agreement about what counts as a worthwhile question, what evidence deserves trust, and what kinds of explanation are adequate. Work skills shares a border with neighbouring disciplines because real problems rarely respect academic boundaries. Its distinctiveness lies in the angle it brings to that shared terrain: it asks the central question below with characteristic tools, then tests or interprets the answers in its own way.

## Central Question

What must we understand about work skills in order to make better explanations, choices, and interventions?
...
Applied Work skills — using those ideas in real settings. In this overview, treat it as one intellectual territory within the larger map: a way the field extends its central question into a region where a different kind of evidence, model, or practical consequence becomes necessary. Its boundary with the other regions matters because no single perspective can carry the whole question alone.

### Boundary questions 

Boundary questions — where Work skills needs neighbouring fields to explain the whole problem. In this overview, treat it as one intellectual territory within the larger map: a way the field extends its central question into a region where a different kind of evidence, model, or practical consequence becomes necessary. Its boundary with the other regions matters because no single perspective can carry the whole question alone.
...
A general learner should be able to recognise the characteristic questions of Work skills, identify the kind of evidence it trusts, and know when another field is needed.
...
- **The Bench That Repaired More Than Machines** — A trainee learns repairs on a lunch bench, then saves the group by bringing in evidence its shared language cannot see.
- **The Fire Everyone Was Responsible For** — A theatre declares fire safety everyone's duty, then watches everyone run toward the manager while smoke fills the stage.
- **The Recipe That Obeyed Only Old Flour** — A baker who can repeat one recipe blindfolded meets flour that refuses every familiar motion.
