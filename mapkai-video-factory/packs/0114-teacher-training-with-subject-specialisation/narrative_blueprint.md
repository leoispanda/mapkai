# Narrative Blueprint: Teacher training with subject specialisation

**Selected engine:** dilemma

## Central Narrative Device

A craft survives only when its master can make another person see what their own hands cannot yet see.
...
Begin with a serious choice where two legitimate values cannot all be satisfied. Let the field reveal what the choice hides.
...
The tension is between an intuitive local answer and the broader structure that Teacher training with subject specialisation is designed to reveal.
