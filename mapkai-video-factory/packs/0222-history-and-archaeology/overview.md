# MapKAI Editorial Knowledge Pack: History and archaeology

**Formal field:** History and archaeology (历史与考古) · **Code:** 0222 · **Group:** Humanities (except languages) · **Knowledge continent:** Arts and Humanities

## Field Identity

History and archaeology is a formal field within Humanities (except languages). It develops specialised knowledge, methods, and judgment for questions that belong to this part of Arts and Humanities.

The identity of a field is not just a label for subject matter. It is a compact agreement about what counts as a worthwhile question, what evidence deserves trust, and what kinds of explanation are adequate. History and archaeology shares a border with neighbouring disciplines because real problems rarely respect academic boundaries. Its distinctiveness lies in the angle it brings to that shared terrain: it asks the central question below with characteristic tools, then tests or interprets the answers in its own way.

## Central Question

What must we understand about history and archaeology in order to make better explanations, choices, and interventions?
...
### Foundations of History and archaeology 
...
A general learner should be able to recognise the characteristic questions of History and archaeology, identify the kind of evidence it trusts, and know when another field is needed.
...
- **Three Victories at the Mountain Pass** — Commissioned to restore a heroic battle inscription, a historian finds three records that answer three different questions.
- **The Square That Grew Downward** — A ten-day excavation is nearly settled by the deepest coin, until a diagonal scar cuts through the square's tidy layers.
- **The Order That Arrived After the Victory** — A general celebrated for perfect foresight finds that the academy has erased the delayed order, broken bridge, and fog from his victory.
