...
Begin with a familiar pharmacy phenomenon that becomes puzzling under a careful question. Delay the definition until the puzzle creates a need for the field.
...
The tension is between an intuitive local answer and the broader structure that Pharmacy is designed to reveal.
...
A general learner should be able to recognise the characteristic questions of Pharmacy, identify the kind of evidence it trusts, and know when another field is needed.
