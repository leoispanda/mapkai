// Full public-facing Part One texts for the management essentials lessons.
// The page intentionally stops before the syllabus and reading-material sections.
globalThis.MAPKAI_MANAGEMENT_STORIES = {
  "day-1-value-and-capital": {
    storyTitle: "知识寓言｜《第二张航海表》",
    storyContent: `灰港商会决定建造一艘大船。造船师给它取名“北辰号”。他说，北辰号可以装下过去三艘船的货物；只要北方航线继续繁荣，五年之后，木材、铁矿和粮食带回来的收入，会堆成一座银币山。
...
**最危险的不是走北方，而是所有船都只能走北方。**`,
    storyTitleEn: "Knowledge Fable | The Second Navigation Table",
    storyContentEn: `The Grey Harbor Merchant Guild decided to build a great ship. The shipbuilder named it the North Star. He said it could carry the cargo of three earlier ships; if the northern route remained prosperous, timber, iron ore, and grain would bring back a mountain of silver within five years.
...
真正可靠的小饭店，不是永远没有红灯的小饭店，而是红灯亮起时，知道该停哪里、查什么、谁负责、什么时候再开门的小饭店。`,
    storyTitleEn: "Knowledge Fable | The Clean Checklist",
    storyContentEn: `There was a small restaurant at the corner of an old street. It was called Anan’s Kitchen.
...
A truly reliable small restaurant is not a restaurant that never has red lights. It is a restaurant that knows where to stop, what to check, who is responsible, and when it can open again when a red light appears.`,
  ...
  "day-4-strategy-and-action": {
    ...
    storyContent: `南城老街有一家川菜馆，叫“灯影楼”。店面不大，门口挂着一串旧灯笼。每天傍晚，厨房里的第一声铁锅响起，整条街就开始有了香气。花椒被热油一激，麻味先出来；干辣椒在锅边一翻，香味才慢慢沉下去。熟客说，灯影楼的菜好，不是因为最辣，而是因为它知道什么时候该辣，什么时候该收。
...
她的同事安娜刚好也在学车，听完后问：“你知道这个通过率是怎么算的吗？”
...
手动挡学员通过率；自动挡学员通过率；首次考试通过率；补考通过率；普通课程完成情况；强化课程完成情况。
...
安娜说：“通过率最高的驾校可能确实很好，但它的课程不一定适合你的时间和学习方式。”
...
教练严格控制谁可以参加考试；学员需要保持较高的训练频率；课程安排比较紧凑；大部分学员能够配合驾校的时间；统计只包括已经完成课程并正式参加首次考试的人。
...
体验课结束后，教练只是清楚地告诉她：“按照你现在的情况，可以先每周上一节。等你对道路判断更加稳定以后，再决定是否增加训练频率。现在还不能准确预测你需要多少节课。”
...
她先问：“你以前开过车吗？想学手动挡还是自动挡？每周能上几次课？你是想尽快考试，还是更在意慢慢建立信心？”

同事笑了。

“我只是问哪家通过率最高。”

小林回答：“通过率当然要看。但你还要知道，是谁参加了考试，谁没有参加，花了多少钱，以及他们是不是和你一样的学员。”`,
    storyTitleEn: "Everyday Story | The Driving School with the Highest Pass Rate",
    storyContentEn: `Xiaolin was preparing to learn to drive.
...
Xiaolin replied, “Of course the rate matters. But you also need to know who took the test, who did not, how much they paid, and whether they were learners like you.”`,
  ...
  "day-3-risk-and-governance": {
    ...
    storyContentEn: `Beside a university town stood a small pizza shop called Corner Slice. It had only six tables, but delivery made up half its business. Every Friday evening, the order printer kept spitting out tickets, and the owner, Amin, felt business was good.
