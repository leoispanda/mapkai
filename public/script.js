...
const sublensStoryDrafts = [
  ...
  },
  {
    ...
    storyBodyZh: "学校里有凸字书，但它们厚重、缓慢，也很少给盲学生真正“写回去”的机会。后来，一个士兵发明的夜间书写法传到学校：把点压进纸里，让人能在黑暗中摸读信息。这个少年试了试，却发现那套点太大，一个指尖很难一次读完，也不适合日常阅读。于是他不断缩小、测试、重新排列，直到六个凸点组成的小格子可以表达字母、标点、数字，后来还可以表达音乐。这个发现不只是技术，它改变了读写的尊严：一个人可以安静地读、私下地写、反复回看一行字，不必永远等待别人的声音带自己进入知识。这个人叫 Louis Braille，他发展出的 braille 读写系统，成为全球盲人和视障者基础读写能力的重要支柱。",
  ...
  },
  {
    ...
    storyBodyZh: "他做过销售，试过表演，也教过课，所以很懂那种从身体里冒出来的尴尬。晚间课程里，他看见店员、推销员、工程师和经理下班后赶来，身上带着同一种隐秘难题：他们有话可说，可一站到众人面前，身体就像遇到危险。于是他没有先讲漂亮理论，而是让他们站起来，讲一个真实小故事，倾听别人，记住名字，具体地赞美，再下周继续试。慢慢地，这门课变宽了。表达不只是声音，它还包括注意力、信心、同理心、记忆，以及让另一个人感觉自己被看见的能力。个人技能之所以可以被训练，不是因为人格可以被制造，而是因为勇气可以在一个个小小的公开行动里练习。这个人叫 Dale Carnegie，他的公众演讲和人际关系课程发展出《How to Win Friends and Influence People》，也影响了现代个人发展训练。",
  ...
  },
  {
    ...
    storyBodyZh: "那块让欧洲学者着迷的石碑，用几种文字写着同一份诏令，可象形文字仍然拒绝被读懂。他没有把那些符号只当作装饰，而是反复比较王名，尤其是椭圆框里的名字，把它们同希腊字母、以及他熟悉的科普特语联系起来。一个在某处看似图画的符号，在另一处开始表现得像声音。突破很慢，也充满竞争，而且并不是一个人凭空完成的；但他的关键一步改变了一切：这些符号不只是神圣图像，也能记录语言。一旦这一点被确认，纪念碑、墓葬、名字、祷文和官方记录，开始重新进入历史。这个人叫 Jean-Francois Champollion，他在 1822 年宣布对埃及象形文字的决定性破译，并成为 Egyptology 的奠基人物之一。",
  ...
  },
  {
    ...
    storyBodyZh: "他们加入的那所学院很小，小到学生会参与学校决策，和老师一起生活，处理材料，读哲学，建造东西，表演，争论，做饭，也常常在没有传统地图的情况下失败。那位教师著名的材料与形式课程，并不是从名作开始，而是从纸、颜色、玻璃、树叶、金属丝、压力、平衡，以及真正看见东西的纪律开始。围绕这些练习，舞者、诗人、作曲家、画家、织物艺术家、建筑师和思想者彼此靠近。艺术与人文的跨学科在这里不是多加几个主题，而是把制作、阅读、生活和感知当成同一种教育。这个人叫 Josef Albers，他在 Black Mountain College 的教学让跨学科艺术教育成为真实实验，而不只是口号。",
  ...
  },
  {
    ...
    storyBodyZh: "他坐进监狱、门廊、教堂、厨房、田野和小房间，录下那些很少进入官方文化的歌声。乍看之下，他是在采集音乐；但录音里也有口音、劳动节奏、玩笑、地方历史、种族暴力、迁徙、记忆，以及那些常被当成文化素材而不是文化作者的人所保有的尊严。这项工作很难放进一个格子。它既是音乐学，也是民俗学、档案建设、口述史、纪录实践，更是一种政治主张：每个共同体都应该有机会听见自己被保存。未另分类的艺术与人文，正生活在这种边界地带，分类不如对脆弱人类表达的照护重要。这个人叫 Alan Lomax，他的田野录音和 cultural equity 工作保存并重新解释了美国及世界各地的民间音乐与口述传统。",
...
const lensStoryOverridesZh = {
  "0300": {
    ...
    storyBodyZh: "她不是从安静书房里开始理解社会的。她住进一个工人和移民聚居的街区，听见母亲为孩子找托管，工人为工资争论，年轻人想学英语，病人不知道去哪里求助。问题看起来分散：贫困、语言、教育、卫生、劳动、住房、信息不通。她和同伴开始做调查、画地图、办课程、写报告，把街坊的生活经验变成城市能看见的公共知识。社会科学、新闻与信息在这里交汇：不是替别人说故事，而是把隐藏在日常里的结构、数据和声音放到同一张桌面上。这个人叫 Jane Addams，她创办 Hull House，并用社会调查、公共写作和社区实践推动美国社会科学、社会改革和公共信息工作的发展。",
  ...
  "0310": {
    ...
    storyBodyZh: "他的人生并不安稳，家族经历瘟疫，仕途几次卷入政治风浪。他开始怀疑，历史书里只记谁胜谁败是不够的。为什么一些群体能团结起来，为什么进入富裕城市后又慢慢松散，为什么税收、奢侈、教育、地理和共同体精神会一起改变政权命运？他把亲身见过的部落联盟、城市官僚和王朝循环放在一起分析，试着找出社会行为背后的力量。社会与行为科学的雏形就在这种追问里出现：人不是孤立行动，群体的凝聚、制度和环境会共同塑造历史。这个人叫 Ibn Khaldun，他在《Muqaddimah》中提出关于社会组织、王朝循环和 asabiyyah 的分析，被视为社会科学思想的重要先驱之一。",
  ...
  "0312": {
    ...
    storyBodyZh: "他本来是来考察监狱制度，却很快被更小的场景吸引。人们在教堂、报纸、协会和镇会里组织自己，争吵也合作；他们对政府保持警惕，却又愿意为了公共事务花时间。他看到民主不是一句口号，而是一整套习惯：结社、发言、妥协、地方自治、对多数权力的担忧，以及普通人学习公共判断的笨拙过程。政治科学与公民学在这里变得具体，因为制度不是只写在宪法上，也活在公民如何参加会议、读新闻、组织协会和约束权力里。这个人叫 Alexis de Tocqueville，他在《Democracy in America》中分析美国民主、结社生活和多数暴政问题，成为政治科学与公民研究的重要经典。",
  ...
  "0313": {
    ...
    storyBodyZh: "那位教师原本受过医学和生理学训练，也熟悉哲学问题。他关心意识，但不满足于只在书本里争论心灵是什么。他让学生听声音、看光点、按键、记录反应时间，并练习把自己的感觉描述得尽量准确。今天看来，这些方法有局限，也和现代心理学差距很大；但关键转向已经发生：心理活动可以进入实验室，可以被设计任务、记录时间、比较差异，也可以被看作身体和经验共同发生的过程。心理学不再只是关于灵魂的抽象谈论，而开始成为研究注意、感觉、反应和意识的经验科学。这个人叫 Wilhelm Wundt，他在莱比锡建立实验心理学实验室，被广泛视为现代实验心理学的重要奠基人。",
  ...
  "0314": {
    ...
    storyBodyZh: "他知道，如果只听报纸和政客的说法，这个社区会被简化成问题本身。于是他做了一件慢事：访问家庭、记录职业、收入、教育、住房、迁徙和邻里关系，把地图、统计和生活叙述放在一起。他不是把人当成数字，而是用数字抵抗懒惰的偏见；也不是把贫困归咎于某个群体，而是追问工作机会、歧视、居住条件和城市制度如何制造后果。社会学与文化研究在这里有了锋利的现实感：文化和社会结构不是空词，它们会落到哪条街、哪份工作、哪间屋子和哪一次被拒绝的机会里。这个人叫 W. E. B. Du Bois，他的《The Philadelphia Negro》成为美国城市社会学、实证社会研究和种族研究的重要经典。",
  ...
  "0319": {
    ...
    storyBodyZh: "她受过心理学和人类学训练，却越来越不愿把人的行为拆成孤立变量。孩子吃什么，不只取决于母亲是否知道营养，也取决于收入、种族隔离、学校制度、地方食物习惯、农场生产和政府项目。她做访谈、观察餐桌、记录家庭安排，也研究政策怎样进入厨房。这个工作很难只归入心理学、社会学、教育或公共卫生，因为它关心的是行为在真实社会生态中如何发生。未另分类的社会与行为科学正需要这样的眼睛：当问题横跨个人、家庭、机构和文化时，分类要服务理解，而不是挡住理解。这个人叫 Margaret Mead，她把人类学、儿童发展、食物习惯和社会政策连接起来，影响了社会行为研究对文化和日常生活的理解。",
    supportZh: "Margaret Mead 是美国人类学家，研究文化、儿童发展、性别、教育和日常生活实践。她参与过关于食物习惯、营养和社会行为的研究与公共讨论，体现了跨社会与行为科学的问题意识。",
  ...
  "0320": {
    ...
    storyBodyZh: "他关心的不是某一条新闻，而是人类怎样保存和共享所有已经写下来的东西。书、论文、报告、图片、剪报、统计表，如果不能被分类、编号、引用和检索，就像散在地上的碎片。他和同伴设计通用十进分类法，建立庞大的卡片目录，试图让任何地方的人都能提出问题并获得相关资料。这个梦想有时代局限，也带着欧洲中心的阴影，但它抓住了信息工作的核心：公共知识不是自然流动的，它需要索引、标准、媒介、机构和持续维护。这个人叫 Paul Otlet，他创建 Mundaneum 并推动文献学、知识组织和信息科学早期发展，被后世视为现代信息组织思想的重要先驱之一。",
  ...
  "0321": {
    ...
    storyBodyZh: "她没有满足于当时白人报纸常用的说法，也没有把恐惧写成空泛控诉。她收集报纸剪报，核对姓名、地点和借口，比较案件，追问所谓“罪名”怎样被制造出来为暴力辩护。她写文章、发表小册子、演讲，也因此遭到威胁，被迫离开原来的城市。新闻与报道在她手里不是中立地重复权力话语，而是在证据、勇气和公共责任之间建立联系。真正的记者工作，有时就是在多数人已经接受谎言的时候，仍然逐条核对事实。这个人叫 Ida B. Wells，她以反私刑调查报道和公共倡议成为美国调查新闻、民权运动和新闻责任史上的重要人物。",
  ...
  "0322": {
    ...
    storyBodyZh: "他看到很多图书馆像安静仓库，书被保护得很好，却不一定抵达需要它的人。数学训练让他喜欢秩序，但图书馆现场让他明白，秩序必须服务读者。他提出几条朴素却深刻的原则：书是为了使用的；每个读者有他的书；每本书有它的读者；节省读者时间；图书馆是生长的有机体。这些话听起来温和，其实改变了信息工作的重心：编目、分类、借阅、开放时间和馆员服务，都不只是内部技术，而是让社会记忆和个人问题相遇的方式。这个人叫 S. R. Ranganathan，他提出 Five Laws of Library Science，并发展 Colon Classification，成为图书馆与信息科学的重要奠基人物之一。",
  ...
  "0329": {
    ...
    storyBodyZh: "她看到的问题不是传统报纸能独自解决的。事件分散，消息混乱，很多人有手机却没有安全渠道把地点、危险和求助信息送到公共视野。于是开发者、志愿者和公民一起搭起平台，把短信、网页报告和地图连起来。它不等同于新闻社，也不只是技术产品，更不是政府档案；它在危机中把零散目击转为可视化信息，同时也暴露出核实、偏差和安全的难题。未另分类的新闻与信息正存在于这种边界地带：当现实太快、太分散、太危险，公共知识需要新的容器。这个人叫 Ory Okolloh，她提出并推动 Ushahidi 的早期构想，使众包危机地图成为新闻、信息技术和公民行动交汇的重要案例。",
  ...
  "0388": {
    ...
    storyBodyZh: "当时许多人仍相信坏空气是主要原因。他却把注意力放到人喝了什么水、住在哪里、谁离开、谁留下，以及哪些看似例外其实有共同解释。他不是一个人完成全部调查；当地牧师和居民提供了关键访问线索。病例被标到地图上后，Broad Street 水泵周围的黑点越来越密。这个判断既是医学问题，也是社会信息问题：数据要来自街道，访谈要校正地图，地图又要说服公共机构采取行动。跨学科的社会科学、新闻与信息在这里很清楚：证据要能穿过学科边界，才可能改变一个城市的决定。这个人叫 John Snow，他通过 Broad Street 霍乱调查和地图分析推动了流行病学、公共卫生和数据可视化的经典实践。",
  ...
  "0399": {
    ...
    storyBodyZh: "流行说法常把公共资源讲成两种结局：要么被市场私有化，要么由国家统一管理，否则人人都会多拿一点直到系统崩溃。她不满足于这个太整齐的故事。她和同伴比较世界各地的灌溉社群、渔业、牧场和森林，发现有些社区会自己制定边界、监测、惩罚、冲突解决和分层规则。它们不是完美乌托邦，也会失败，但它们证明社会现实比二分法复杂。未另分类的社会科学、新闻与信息需要这种耐心：有些制度知识藏在地方规则、口头协议和长期观察里，不一定属于单一学科。这个人叫 Elinor Ostrom，她通过共同池资源研究和制度分析获得诺贝尔经济学奖，改变了人们对集体治理的理解。",
  ...
  "0410": {
    ...
    storyBodyZh: "他不是工程师出身，也不是只看财务报表的人。他关心一个更朴素的问题：当公司越来越大，谁在决定目标？经理人的责任是什么？员工是不是只是一颗螺丝？顾客、社会和长期生存又放在哪里？他观察通用汽车这样的组织，发现管理不是命令链条那么简单，而是让知识、权责、绩效、创新和人的尊严保持可工作的关系。商业与行政在这里变成一门关于“组织如何有目的地行动”的学问。它既要看数字，也要看人；既要看效率，也要看责任。这个人叫 Peter Drucker，他通过《Concept of the Corporation》等作品奠定现代管理学的重要语言，被称为现代管理思想的重要奠基人之一。",
  ...
  "0411": {
    ...
    storyBodyZh: "城市贸易越来越复杂，单靠脑子记住谁欠谁、货从哪里来、钱到哪里去，已经很危险。他把商人实际使用的复式记账方法写进书里，说明每笔交易都要从两个方向进入账本：一边记录来源，一边记录去向。这个方法不是让商业变得道德完美，却让错误、欺骗、成本和责任更容易被发现。会计与税务的核心由此显露：数字不是单纯记录财富，而是在社会中建立可解释、可核对、可承担责任的证据。这个人叫 Luca Pacioli，他在 1494 年《Summa de arithmetica》中系统介绍复式记账，被后世称为会计学的重要奠基人物之一。",
  ...
  "0412": {
    ...
    storyBodyZh: "他关心的不是个体命运能不能被预测，而是许多人的寿命放在一起，会不会呈现可用于公共判断的规律。年金和保险长期依赖粗略估计，价格常常不公平。于是他整理 Breslau 的年龄与死亡数据，计算不同年龄的人还能活多久的概率。这个工作让金融、银行与保险中的核心问题变得清楚：钱不只在空间里流动，也在时间和风险里流动。保险不是消灭不确定性，而是用大量记录、概率和合同把不确定性分担开来。这个人叫 Edmond Halley，他制作的生命表成为精算科学和人寿保险定价史上的重要早期成果。",
  ...
  "0413": {
    ...
    storyBodyZh: "她看到冲突常被处理成输赢：老板命令，工人服从；部门争资源，谁声音大谁赢。可她越来越相信，真正的管理不该只是压制冲突，而要把不同经验组织起来，让问题本身把人带向新的解决方案。她提出“power with”而不是“power over”，强调协调、参与、情境判断和共同责任。她的思想一度不如科学管理那样显眼，却在后来影响组织行为、领导力和协作管理。管理与行政在她这里不是冷冰冰的流程，而是把人的经验、权力和目标重新安排到可合作的结构中。这个人叫 Mary Parker Follett，她以关于协作、权力和冲突整合的思想成为现代管理学的重要先驱之一。",
  ...
  "0414": {
    ...
    storyBodyZh: "他把广告当作可以测试的实验，而不是纯粹灵感。他关心标题能不能让人停下，优惠券能不能追踪回应，产品承诺是不是能进入人的日常习惯。推广牙膏时，广告不只是说产品好，而是抓住“牙齿表面那层膜”的感觉，让人每天用舌头确认自己是否需要清洁。这个方法后来也必须被批判，因为营销可以帮助人理解需求，也可以制造焦虑和欲望。但它确实让市场营销与广告的学科特征显出来：注意力、证据、行为触发、信任和伦理边界总是缠在一起。这个人叫 Claude Hopkins，他以《Scientific Advertising》和 Pepsodent 推广案例影响了现代广告测试、直效营销和消费行为传播。",
  ...
  "0415": {
    ...
    storyBodyZh: "他面对的不是浪漫的文学问题，而是办公室里极普通的痛点：信件太多，手写难读，副本难做，速度跟不上商业往来。早期机器笨重又不稳定，键位也不断调整。可一旦打字机进入办公室，文件格式、通信速度、记录保存、秘书职业和性别化劳动分工都被改变了。秘书与办公事务不是“杂活”的集合，而是组织记忆、沟通节奏和文件可靠性的基础设施。每一份议程、备忘录、合同副本和来往信件，都在帮助组织不用只靠个人记忆运转。这个人叫 Christopher Latham Sholes，他参与发明并推广早期实用打字机，对现代办公室文书和秘书工作产生了深远影响。",
  ...
  "0416": {
    ...
    storyBodyZh: "当时买东西常由店员在柜台后取货，顾客说，店员拿，价格和选择都被柜台隔开。他反过来设计商店动线：让顾客推开转门，沿着货架自己拿商品，看清包装和价格，最后到出口结账。这个改变不是简单节省人力，它重写了批发与零售销售的现场逻辑：陈列、包装、冲动购买、库存、价格标签、防盗和收银都变成同一套系统。顾客获得更多自由，也被新的货架设计影响选择。这个人叫 Clarence Saunders，他创办 Piggly Wiggly，把自助式超市模式推向商业实践，深刻影响现代零售销售。",
  ...
  "0417": {
    ...
    storyBodyZh: "他们不是只想让人更快工作。真正的问题是，为什么同样的任务有人疲惫，有人顺手；为什么工人要做那么多多余动作；为什么家庭劳动也被当成不值得研究的自然习惯。他们拍摄砌砖动作，分析手的路径，也研究厨房高度、工具摆放和休息。今天我们会警惕效率研究被用来压榨劳动者，但他们留下的一个重要提醒仍然成立：工作技能不是天生会的，也不只是态度好。它包括动作、工具、时间、沟通、身体保护和学习反馈。这个人叫 Frank Gilbreth 和 Lillian Gilbreth，他们通过 motion study 和工作流程研究影响了工业工程、人体工效和现代工作技能训练。",
  ...
  "0419": {
    ...
    storyBodyZh: "他看到一些手工劳动者每天辛苦，却因为借原料的钱来自高利贷，永远被锁在极小利润里。传统银行嫌他们没有抵押，慈善又未必改变生产关系。于是他试着借出很小的钱，观察人们是否能通过互助小组、还款纪律和本地信任建立新的可能。这个模式后来受到广泛赞扬，也面对关于债务压力、性别负担和商业化的批评；但它确实说明，有些商业与行政实践很难放入标准格子。它既像金融，也像发展项目、社会组织和制度实验。这个人叫 Muhammad Yunus，他创立 Grameen Bank 并推动 microcredit，使社会企业和小额金融成为商业与行政边界上的重要案例。",
  ...
  "0421": {
    ...
    storyBodyZh: "当时普通法常被认为只能在律师事务所和法院里慢慢熬出来，外人很难进入。判例、惯例、术语和程序像一片森林，既保护权利，也让许多人迷路。他开始公开讲授英格兰法律，把权利、财产、私人侵害和公共犯罪整理成系统叙述。后来他的书影响巨大，也带着时代局限，尤其在殖民和社会等级问题上需要被批判阅读。但法律作为学科的一个关键变化已经出现：规则不只是专业圈的秘密技术，也可以被讲解、出版、争论和教学。这个人叫 William Blackstone，他的《Commentaries on the Laws of England》成为普通法教育和英美法律思想史上的经典文本。",
  ...
  "0499": {
    ...
    storyBodyZh: "她没有按当时化妆品行业的常规走。包装可以简单，动物测试可以被质疑，原料故事可以告诉顾客，商业也可以公开站在环保和人权议题旁边。她的做法后来同样需要复杂评价：品牌扩张、供应链、并购和市场叙事都会让理想变得不纯粹。但这个案例说明，未另分类的商业、管理与法律常常出现在边界上：一件商品既是买卖，也是价值主张、合同关系、劳动条件、生态选择和公共传播。这个人叫 Anita Roddick，她创办 The Body Shop，并以环保、反动物测试和 ethical consumerism 影响了商业伦理与品牌行动主义。",
  ...
  "0500": {
    ...
    storyBodyZh: "他并不满足于把一朵植物采下来、写上名字，再放进柜子。越往高处走，他越觉得自然像一张相互牵连的网：海拔改变温度，温度改变植物带，植物又和土壤、湿度、地形、气候连在一起。他把这些关系画成一张图，让一座山同时呈现地理、植物、气候和测量数据。自然科学、数学与统计在这里形成共同语言：观察要精确，数字要进入图像，图像要帮助人看见联系，而不是只堆积事实。这个人叫 Alexander von Humboldt，他通过南美考察和 Naturgemalde 等作品推动了现代自然地理、生态思想和综合自然科学的发展。",
  ...
  "0510": {
    ...
    storyBodyZh: "他出发时还不是一个准备推翻传统观念的人，更像一个爱观察的年轻人：写笔记、收集昆虫、寄回标本、和船员一起经历风浪。真正改变他的不是某一个瞬间，而是大量小差异慢慢堆在一起：相近的岛屿有不同的鸟嘴，化石和现生动物彼此呼应，人工育种显示性状可以被选择。多年后，他才把这些线索组织成一个更大的解释：生命不是固定陈列，而是在变异、遗传、环境和选择中逐渐改变。生物及相关科学在这里不再只是给生命命名，也开始追问生命为什么会成为现在这样。这个人叫 Charles Darwin，他通过《On the Origin of Species》提出自然选择理论，成为现代进化生物学的重要奠基人。",
  ...
  "0511": {
    ...
    storyBodyZh: "他没有大学教授头衔，也没有现代实验室。他靠的是手艺、耐心和好奇：把镜片磨得更亮，把样本放到光下，把牙垢、雨水、湖水和血液拿来观察。透过那些小镜片，他看到会动的微小生命，看到细胞、细菌和精子等肉眼从未进入过日常经验的世界。起初这些发现很难让人相信，因为它们太小，也太陌生。可生物学从此多了一条通道：生命不只在植物、动物和人体外形里，也在看不见的尺度上活动。这个人叫 Antonie van Leeuwenhoek，他以自制显微镜观察微生物，被视为微生物学和显微观察史上的关键先驱。",
  ...
  "0512": {
    ...
    storyBodyZh: "当时很多人认为发酵必须依赖完整活细胞。可那瓶无细胞酵母汁仍然把糖变成酒精和二氧化碳，像是在提醒人们：生命活动背后还有更小的化学执行者。他反复确认不是污染，也不是残余细胞在偷偷工作。这个发现把问题从“细胞是否活着”推向“细胞内部是什么在催化反应”。生物化学的门由此被推开：生命不是脱离物质的神秘力量，它由酶、分子、能量和反应网络持续维持。这个人叫 Eduard Buchner，他发现无细胞发酵并推动酶学发展，因这项工作获得 1907 年诺贝尔化学奖。",
  ...
  "0519": {
    ...
    storyBodyZh: "她的工作很安静，也很孤独。显微镜下的染色体、田里的玉米穗、纸上的谱系图，被她年复一年地连在一起。许多人期待基因像固定位置上的字母，她却从异常颜色和断裂模式里看到另一种可能：某些遗传因子会移动，会调控别的基因表达。这个发现一开始并没有被充分理解，因为它超出了当时主流想象。未另分类的生物相关科学常常就在这种边缘发现中出现：问题横跨遗传、细胞、发育和调控，暂时没有舒服的格子。这个人叫 Barbara McClintock，她发现 transposable elements，后来获得 1983 年诺贝尔生理学或医学奖。",
    supportZh: "Barbara McClintock 通过玉米遗传学研究发现 transposable elements，也称 jumping genes。她的发现起初未被广泛理解，后被证明对基因调控和基因组动态具有重要意义，并获 1983 年诺贝尔生理学或医学奖。",
  ...
  "0520": {
    ...
    storyBodyZh: "她原本写过海洋，也擅长把科学写给普通读者。面对杀虫剂，她没有只问它能不能杀死目标害虫，而是追问它进入土壤、水、昆虫、鸟、鱼和人体之后会怎样移动。她阅读研究、整理案例、承受化工行业攻击，也小心避免把复杂生态写成简单恐吓。环境领域在这里变得清楚：人类技术不是只作用于一个点，它会穿过食物链、公共政策、商业利益和日常家庭。一个“有效”的工具，如果看不到长期代价，就可能把春天本身变安静。这个人叫 Rachel Carson，她的《Silent Spring》推动现代环境运动和农药监管讨论，成为环境科学与公共环保意识的重要经典。",
  ...
  "0521": {
    ...
    storyBodyZh: "他做的事看起来枯燥：校准仪器，排除局地污染，重复测量，保存长期记录。可正是这种近乎执拗的精确，让大气中二氧化碳逐年上升的趋势变得无法忽视。那条曲线还带着季节性起伏，像地球植被呼吸的节律：春夏下降，秋冬上升。环境科学在这里显示出力量，不是靠一次戏剧性灾难，而是靠持续、可比、可信的数据，把看不见的全球变化变成公共证据。这个人叫 Charles David Keeling，他建立的 Mauna Loa 二氧化碳长期记录形成 Keeling Curve，成为气候变化科学的核心证据之一。",
  ...
  "0522": {
    ...
    storyBodyZh: "她一开始没有传统博士训练，带着笔记本、望远镜和极大的耐心进入森林。很多天里，动物只是远远躲开。后来她看到一只黑猩猩把草茎伸进白蚁丘，再把沾满白蚁的草茎送入口中。这个小动作意义巨大：工具使用不再能轻易被说成只有人类才会。更重要的是，长期观察让每只动物有了个体性格、亲属关系、冲突、照料和学习。自然环境与野生动物研究因此不只是数有多少只动物，也要理解栖息地、行为、社会关系和人类干扰。这个人叫 Jane Goodall，她在 Gombe 的黑猩猩长期研究改变了灵长类行为学和野生动物保护的公众理解。",
  ...
  "0529": {
    ...
    storyBodyZh: "她没有把这些抱怨当作零散生活困难。树被砍掉，水源变差，土壤流失，妇女走更远的路找燃料，家庭和地方政治都被牵动。于是她从最朴素的动作开始：组织妇女育苗、种树、照看树，也让种树变成教育、收入、社区权利和民主参与的入口。未另分类的环境领域常常这样出现：它不只是生态学，也不只是扶贫、女性权益或政治改革，而是这些东西在同一片土地上纠缠。这个人叫 Wangari Maathai，她创立 Green Belt Movement，并因环境保护、妇女赋权和民主行动获得 2004 年诺贝尔和平奖。",
  ...
  "0530": {
    ...
    storyBodyZh: "他并不满足于背诵古代权威关于重物下落的说法。真实下落太快，不容易测；于是他把斜面变成放慢运动的工具，让时间、距离和速度之间的关系可以被观察。小球每次滚动都像在提醒他：自然不是只能被辩论，也可以被设计实验来询问。物理科学的精神在这里显现：把看似普通的运动拆成可测量关系，用数学表达规律，再让实验反复挑战直觉。这个人叫 Galileo Galilei，他通过落体、斜面和天文观察等研究推动近代物理科学和实验方法的发展。",
  ...
  "0531": {
    ...
    storyBodyZh: "当时流行的燃素说把燃烧解释成某种东西逃走。可他的天平总把问题拉回物质本身：如果燃烧后质量增加，是否说明空气中的某部分加入了反应？他和同伴改进仪器、命名氧气和氢气、整理元素概念，也推动化学语言从含混传统走向更可核对的体系。化学在这里不是神秘炼金，而是精确称量、封闭系统、命名规则和反应关系。这个人叫 Antoine Lavoisier，他通过燃烧理论、质量守恒和化学命名改革成为现代化学的重要奠基人之一。",
  ...
  "0532": {
    ...
    storyBodyZh: "他不是地质学正统圈里的权威人物。除了海岸线，他还比较化石分布、岩层、古气候痕迹和冰川证据，提出大陆曾经连在一起，后来漂移分开。许多地质学家一开始反对，尤其因为他无法解释大陆移动的可靠机制。这个理论长期被冷落，直到海底扩张、古地磁和板块构造证据出现，才重新获得力量。地球科学在这里显示出耐心：一条好问题有时先于完整机制出现，而地球的历史远比脚下的静止感更活跃。这个人叫 Alfred Wegener，他提出 continental drift 理论，为后来板块构造学说的发展提供了关键思想前身。",
  ...
  "0533": {
    ...
    storyBodyZh: "故事常被讲成苹果砸头的瞬间，其实更重要的是他愿意把两个世界连起来：苹果为什么落下，月亮为什么不直线飞走，而是绕着地球？如果同一种吸引力既作用在地面物体，也作用在天体上，那么自然界就不是由两套规则管理。他用数学表达运动定律和万有引力，把经验、几何和天文观测组织成新的体系。物理学由此展现出一种强大想象：最普通的下落，可能和宇宙尺度的运行属于同一个问题。这个人叫 Isaac Newton，他在《Philosophiae Naturalis Principia Mathematica》中提出运动定律和万有引力理论，奠定经典力学基础。",
  ...
  "0539": {
    ...
    storyBodyZh: "他原本想展示的是电学实验，却被一个看似偶然的小动作抓住：电流经过时，磁针不再安静指北。这个现象说明电和磁之间可能有深层联系。后来更多实验者接过问题，把电流、磁场、感应和力的关系逐渐展开。未另分类的物理科学常出现在这样的交界处：它不完全属于旧的电学，也不完全属于磁学，而是在现象逼迫分类改变时出现。科学进展有时不是给旧抽屉再贴标签，而是承认抽屉本身需要重做。这个人叫 Hans Christian Oersted，他发现电流的磁效应，推动电磁学作为统一研究领域的发展。",
  ...
  "0540": {
    ...
    storyBodyZh: "他面对的不是纯粹游戏，而是继承、贸易、测量、税收和土地分配中的真实计算。旧方法可以算，但不够统一，也不容易传播。他把印度数字和十进位计算介绍给阿拉伯语读者，又系统讨论线性和二次方程的解法。数学与统计的基础意义在这里很清楚：符号一旦变得可写、可教、可复用，复杂关系就能离开个人头脑，成为社会共同工具。这个人叫 Muhammad ibn Musa al-Khwarizmi，他的代数学著作和关于印度数字的作品影响了 algebra 与 algorithm 等概念的历史发展。",
  ...
  "0541": {
    ...
    storyBodyZh: "他没有从最华丽的图形讲起，而是从最小的东西开始：什么是点，什么是线，什么可以被假定，什么必须证明。一个命题接一个命题，像砖块一样搭起几何体系。重要的不只是结论，而是任何人都可以沿着理由回走，检查每一步是否成立。数学在这里显示出独特力量：它把直觉变成证明，把图形变成结构，把个人聪明变成可共享的推理秩序。这个人叫 Euclid，他编写《Elements》，成为几何学、证明传统和数学教育史上最重要的经典之一。",
  ...
  "0542": {
    ...
    storyBodyZh: "天文观测总有误差。这个年轻人慢慢学会，不必把每个偏差都当成失败；很多偏差放在一起，反而会显出一种分布。后来，他把这种耐心从天空带回城市。出生、死亡、婚姻、身高、犯罪记录，这些原本散在登记册里的数字，被他一列一列整理出来。一个人的一生不能被表格解释，但很多人的记录放在一起，会露出某种社会形状。他提出“平均人”的想法，启发很大，也很危险：平均值能让混乱变得可读，却也可能压平真实差异。这个人叫 Adolphe Quetelet，他把统计方法引入社会现象研究，并留下后来影响 BMI 的 Quetelet Index 源头。",
  ...
  "0588": {
    ...
    storyBodyZh: "她的工作头衔并不显赫，很多女性计算员被安排做重复而精细的记录。可她在麦哲伦云的变星中发现一种关系：某些造父变星变化周期越长，真实亮度越高。这个关系像一把宇宙尺子，只要知道周期，就能推算亮度，再进一步估计距离。自然科学、数学与统计在这里完全交织：天文观测提供材料，数学关系组织模式，统计比较让规律浮现。她的发现后来帮助人类测量银河系之外的距离。这个人叫 Henrietta Swan Leavitt，她发现造父变星周期-光度关系，成为现代宇宙距离尺度的重要基础。",
  ...
  "0599": {
    ...
    storyBodyZh: "传统几何喜欢光滑线条，可真实世界的云、山、树、河流和海岸都不那么听话。用大尺子量，很多弯曲被忽略；用小尺子量，细节不断冒出来，长度似乎没有稳定终点。他把这种粗糙、重复、自相似的形状发展成新的数学语言。这个方向既不像普通几何，也不只是物理或统计，却能帮助人描述自然界大量不规则形态。未另分类的自然科学、数学与统计就适合保存这种边界问题：分类暂时跟不上现象，但现象已经在要求新工具。这个人叫 Benoit Mandelbrot，他发展 fractal geometry，使分形成为理解自然形态、复杂系统和尺度问题的重要数学语言。",
  ...
  "0610": {
    ...
    storyBodyZh: "他不先关心消息内容是情书、新闻还是订单，而是问信号如何通过带噪声的通道，怎样编码，怎样减少不确定性，怎样在有限带宽里可靠传输。这个抽象看似冷，却非常有力：信息可以用 bit 计量，通信可以用数学模型分析，冗余、噪声、编码和容量都能被系统研究。信息与通信技术在这里不只是设备集合，而是一整套关于信息如何表示、传输、压缩和保护的思想。这个人叫 Claude Shannon，他在 1948 年发表《A Mathematical Theory of Communication》，奠定现代信息论基础。",
  ...
  "0611": {
    ...
    storyBodyZh: "他关心的不是让机器替人炫技，而是怎样增强人的思考和协作能力。打字、指向、编辑、共享屏幕、远程协作、超文本链接，这些今天看似普通的动作，当时像是从未来提前出现。他把计算机使用理解为人和工具共同构成的工作环境：手怎样移动，眼睛怎样寻找，团队怎样共享文档，想法怎样被外化和修改。计算机使用从此不只是会不会操作机器，而是怎样让数字工具进入人的认知、沟通和日常工作。这个人叫 Douglas Engelbart，他在 1968 年的 Mother of All Demos 中展示鼠标、窗口、超文本和协作计算等关键思想。",
  ...
  "0612": {
    ...
    storyBodyZh: "当时许多数据系统依赖复杂文件结构，应用程序必须知道数据怎样存放，改一点结构就可能牵动一片代码。他提出用关系模型表示数据：把数据看作表，把关系和约束说清楚，再用更高层的语言查询，而不是让每个程序都迷失在存储细节里。数据库与网络设计及管理的核心由此变得清楚：多人共享信息时，结构、独立性、一致性和查询能力比临时保存更重要。这个人叫 Edgar F. Codd，他提出 relational model，奠定关系型数据库理论基础，深刻影响 SQL 和现代数据管理系统。",
  ...
  "0613": {
    titleZh: "她看见机器不只会算数",
    summaryZh: "一台未完成的机器旁，最早的软件想象从数字、指令和符号之间出现。",
    sceneZh: "1833 年伦敦的一次聚会里，一个十七岁的女孩站在复杂机器旁，看齿轮如何试着替人计算。",
    storyBodyZh: "那时没有电脑，也没有屏幕。那台机器也没有真正完成，更像一个尚未抵达未来的模型。许多人看到的是更快的算术工具，她却被另一个问题吸引：如果数字可以代表数量，也可以代表音符、图案和关系，机器是不是不只会算账？多年后，她翻译关于 Analytical Engine 的文章，并写下比原文还长的注释。她把机器如何一步步计算 Bernoulli numbers 写成清楚操作表，也想象这种机器未来可能处理音乐、图形和更复杂符号。这个人叫 Ada Lovelace，她留下最早公开发表的程序式算法之一，并很早看见计算机器可能超越单纯算术。",
    supportZh: "Ada Lovelace 1843 年翻译 Menabrea 关于 Analytical Engine 的文章并加入长篇 Notes；其中 Note G 描述计算 Bernoulli numbers 的方法，常被称为最早公开发表的计算机程序之一。",
    knowledgePointZh: "软件与应用开发及分析关注需求、逻辑、指令、界面、测试和持续改进，也关注机器能表达什么。",
    reflectionQuestionZh: "一个程序真正重要的地方，是完成计算，还是让机器开始执行人的想法？",
  ...
  "0619": {
    ...
    storyBodyZh: "她喜欢把抽象问题讲得可操作，也相信计算机不该只属于少数能背机器指令的人。她推动自动编程和编译器思想，让人可以用更接近英语的方式表达商业计算任务，再由机器翻译成可执行指令。许多人起初怀疑机器怎么可能理解这种语言，但这条路改变了软件生产和普通组织使用计算机的可能。未另分类的信息与通信技术常常容纳这种跨界发明：它既是语言设计，也是工具、教育、商业流程和计算文化。这个人叫 Grace Hopper，她推动早期编译器和 COBOL 发展，成为现代编程语言和计算普及史上的关键人物。",
  ...
  "0688": {
    ...
    storyBodyZh: "他看到的不是单一工程问题。雷达给出信息，炮塔需要动作，目标在移动，系统根据误差反馈调整；类似过程也出现在神经系统、动物运动、通信网络和自动控制里。于是他把“控制与通信”作为共同问题来思考，提出 feedback、信息和系统调节的语言。ICT 的跨学科意义在这里出现：计算不只是电脑，通信不只是电线，控制不只是机器，而是生命、技术和组织都可能共享的结构。这个人叫 Norbert Wiener，他创立 cybernetics，使控制、通信、反馈和系统思想成为信息技术、自动化和跨学科研究的重要基础。",
  ...
  "0700": {
    ...
    storyBodyZh: "桥要跨得更远，隧道要穿过更危险的地层，铁路要让城市和港口重新连接，船要在大西洋上承受风浪、燃料和钢铁结构的限制。他常常大胆到让人害怕，也并非每个项目都顺利；成本、事故、健康和公众信任不断压过来。但正是在这种现实压力里，工程、制造与建筑的共同本质显出来：把材料、力、资金、时间、风险和人的移动需求组织成可运行的实体世界。这个人叫 Isambard Kingdom Brunel，他通过 Great Western Railway、Thames Tunnel、Clifton Suspension Bridge 和大型蒸汽船等项目成为工业时代工程史的重要人物。",
  ...
  "0710": {
    ...
    storyBodyZh: "他面对的不是普通计算题。建筑形态大胆，预算和政治压力不断增加，原本的曲面难以制造和支撑。工程团队必须把美学愿望、几何规则、预制构件、受力路径和施工方法重新组合，直到壳体可以被分解、制造和安装。这个过程并不完美，也伴随争议，但它说明工程行业的核心不只是按图施工。真正的工程要在愿望与现实之间翻译：哪些形状能被建造，哪些材料能承受，哪些步骤能让危险变小。这个人叫 Ove Arup，他领导 Sydney Opera House 工程工作，并推动结构工程与建筑设计深度协作的现代实践。",
  ...
  "0711": {
    ...
    storyBodyZh: "实验室里反应成功，不等于工厂就能稳定、安全、便宜地生产。温度、压力、流量、腐蚀、废气、管道和工人安全都会改变结果。他开始把不同化工行业中的共同操作抽出来讲：蒸馏、吸收、过滤、传热、物料平衡。这个思路让化学工程有了自己的对象：不是单个化学反应，而是把反应变成连续、可控、可规模化流程的全部条件。这个人叫 George E. Davis，他通过化学工程讲座和《A Handbook of Chemical Engineering》推动 chemical engineering 作为独立工程领域形成。",
  ...
  "0712": {
    ...
    storyBodyZh: "他关心的不只是把水变清，而是怎样让数十万人每天喝到足够安全的水。氯能杀菌，但剂量、接触时间、味道、管网污染和公众信任都要被精确处理。环境保护技术在这里不是某个漂亮设备，而是一整套工程判断：检测、消毒、输送、监测和维护，必须长期稳定地工作。人们最好永远不要想起它，因为想起它时往往已经出事。这个人叫 Abel Wolman，他与 Linn Enslow 发展供水氯化剂量控制方法，推动现代城市饮用水消毒和公共卫生工程。",
  ...
  "0713": {
    ...
    storyBodyZh: "直流系统可以点亮城市的一部分，但远距离输电困难。这个年轻人想象电流可以周期性改变方向，利用变压器升压降压，让电能走得更远。他的交流电机和多相系统并不是只解决一个机器问题，而是改变了发电、输电、工业动力和家庭用电的基础结构。电力与能源从这里显出系统性：能源不是插座里的瞬间便利，而是一张由发电机、线路、标准、商业竞争和公共安全组成的网络。这个人叫 Nikola Tesla，他的交流电机和多相交流系统专利对现代交流电力系统发展产生关键影响。",
  ...
  "0714": {
    ...
    storyBodyZh: "他改进蒸汽机时面对的不只是功率问题，还有稳定性。机器如果负载变化就失控，工厂就无法可靠运转。离心调速器通过旋转球感知速度变化，速度快时收小蒸汽，速度慢时放开，让机器根据自身状态自动修正。这个装置看似机械，却包含自动化的核心思想：传感、反馈、调节和控制。电子与自动化后来进入电路、传感器和软件，但这个早期机械反馈已经说明，机器可以不只是执行命令，也可以持续比较目标和现实。这个人叫 James Watt，他改进蒸汽机并使用离心调速器，使反馈控制成为自动化和控制工程史上的经典例子。",
  ...
  "0715": {
    ...
    storyBodyZh: "在精密制造之前，零件常常要手工修配，坏了也难以替换。螺丝看起来小，却决定机器能不能被拆装、维修和复制。他改进螺纹车床，让螺纹加工更准确、更一致，也推动机床成为制造其他机器的“母机器”。机械与金属行业在这里显出基础性：现代工业不只是发明一台机器，而是让零件、标准、工具和工人的技能形成可重复的制造体系。这个人叫 Henry Maudslay，他发展精密螺纹车床和机床技术，被视为英国机床工业和精密机械制造的重要奠基人物之一。",
  ...
  "0716": {
    ...
    storyBodyZh: "他们并不是只把发动机装到翅膀上。此前他们做风洞实验，测试翼型，研究滑翔，尤其盯住一个关键问题：飞起来之后怎样控制？许多失败让他们明白，航空器不是单一部件的胜利，而是升力、推力、结构重量、操纵面和飞行员身体判断的协调。机动车、船舶与航空器领域正是这样：移动系统必须把速度、稳定、安全、材料和环境放在一起。那十二秒并不长，却证明有动力、可控、持续的重于空气飞行成为可能。这个人叫 Orville Wright 和 Wilbur Wright，他们完成 1903 年 Kitty Hawk 飞行，成为航空器发展史上的关键人物。",
  ...
  "0719": {
    ...
    storyBodyZh: "问题并不适合被慢慢放进整齐研发流程。飞行员在空中需要立即可靠的动力，发动机在负 G 机动中供油异常，完整改造又来不及。她研究化油器问题，设计一个简单节流装置，让燃油流量在关键时刻不至于失控。这个小零件不是华丽发明，却让飞机在等待更彻底方案前获得实用改善。未另分类的工程行业常常这样：现场约束、临时修复、安全验证和制造可行性一起逼迫工程师作出足够可靠的判断。这个人叫 Beatrice Shilling，她设计的 R.A.E. restrictor 帮助缓解 Merlin 发动机负 G 供油问题，成为航空工程现场解决方案的经典故事。",
  ...
  "0720": {
    ...
    storyBodyZh: "他想解决的不是单台汽车能不能造出来，而是怎样让更多人买得起、怎样让每一步工作稳定重复。装配线把任务拆小，把零件标准化，把节拍固定，也把工人的动作纳入严格流程。这个方法提高产量、降低成本，同时也带来劳动单调、控制和工人压力等问题。制造与加工在这里变得现代：产品不是只由技术发明决定，还由流程、时间、供应链、工人技能和管理制度共同决定。这个人叫 Henry Ford，他在 Highland Park 工厂推广移动装配线，使汽车大规模生产成为 20 世纪制造业的重要范式。",
  ...
  "0722": {
    ...
    storyBodyZh: "他不是在整洁实验室里顺利推进，而是在失败、贫困和执念里不断尝试。天然橡胶有弹性，却太受温度影响，难以成为可靠工业材料。后来橡胶与硫在加热条件下发生变化，材料变得更稳定、更耐用、更适合制造。材料领域的关键就在这里：玻璃、纸、塑料、木材或橡胶都不是只有外观，它们有结构、性能、加工条件和使用环境。一个材料被真正理解，意味着人知道它在压力、温度、时间和反复使用中会怎样。这个人叫 Charles Goodyear，他发现橡胶硫化工艺，使橡胶成为现代工业中更稳定可用的材料。",
  ...
  "0723": {
    ...
    storyBodyZh: "他改进织机，让打孔卡片控制经线抬起的顺序。卡片上的孔不是花纹本身，却像一套可执行指令，告诉机器何时让哪根线通过。纺织品领域在这里不只是衣料和皮革，也包括纤维结构、图案、机器、劳动和可重复生产。这个发明带来效率，也引发工人对失业的恐惧；技术进步从来不只是机器更聪明，也会改变人的工作。这个人叫 Joseph Marie Jacquard，他推广 Jacquard loom，使复杂织物图案可通过打孔卡控制，并对自动化和早期计算思想产生深远影响。",
  ...
  "0724": {
    ...
    storyBodyZh: "他看到的不是地下宝藏的浪漫，而是危险劳动：塌方、毒气、积水、矿石分类、冶炼烟尘和工具磨损。于是他把采矿、地质、机械、冶金和劳动现场写成系统知识，配上图像，让经验可以被传递和讨论。采矿与开采的核心由此显现：资源从地下进入社会，必须经过发现、提取、安全、环境和供应链，每一步都有代价。这个人叫 Georgius Agricola，他的《De Re Metallica》系统记录 16 世纪矿业与冶金实践，成为采矿工程史上的经典著作。",
  ...
  "0729": {
    ...
    storyBodyZh: "传统直觉会觉得机器不停才有效率，库存多才安全。他反过来观察：过量生产会掩盖问题，等待会吞掉时间，搬运和返工会消耗人。生产线如果出现异常，应该让问题显露出来，而不是继续把缺陷向后推。他推动 just-in-time、看板和持续改进等实践，让制造不只是加工物品，也是在设计学习系统。未另分类的制造与加工常常处理这种跨流程、管理、现场技能和质量的混合知识。这个人叫 Taiichi Ohno，他发展 Toyota Production System，对精益生产和现代制造管理产生深远影响。",
  ...
  "0730": {
    ...
    storyBodyZh: "他不把建筑只看成墙和屋顶，也不把美当成表面装饰。一个建筑物必须坚固，能服务人的使用，也要有比例和秩序带来的美感。材料、地基、方向、公共用途、机械和人体尺度，都被放进同一套思考。建筑与施工的基础问题在这里很早就被说清：建造不是堆东西，而是在安全、用途、技术、气候、身体和文化之间达成一种可持久的安排。这个人叫 Vitruvius，他的《De architectura》提出 firmitas、utilitas、venustas 等思想，深刻影响建筑理论和建筑教育。",
  ...
  "0731": {
    ...
    storyBodyZh: "当时许多规划者迷恋大尺度清除、分区和高速道路，觉得旧街区混乱低效。她却从日常生活里看到另一套秩序：小店的眼睛、短街区的穿行、混合用途带来的活力、不同时间出现的人群，以及邻里之间不必认识也能互相照看的关系。建筑与城镇规划在这里从鸟瞰图回到人的身体高度。城市不是只给汽车、模型和开发指标看的，它首先是人们不断相遇、停留、绕行、照看和争论的生活场。这个人叫 Jane Jacobs，她的《The Death and Life of Great American Cities》改变了现代城市规划对街道、社区和混合用途的理解。",
  ...
  "0732": {
    ...
    storyBodyZh: "她原本不是官方意义上的工程师，却在丈夫因减压病无法到现场后，承担起传递计算、材料、索缆、沉箱和施工指令的工作。她学习技术细节，和工人、政界、工程团队沟通，也在质疑声中维护项目连续性。建筑与土木工程在这里不是单个天才的图纸，而是结构力学、材料、施工风险、公共资金、疾病和沟通共同组成的长期承诺。桥真正跨越的不只是河流，还有设计和现实之间的漫长距离。这个人叫 Emily Warren Roebling，她在 Brooklyn Bridge 建设后期发挥关键工程协调作用，成为土木工程史上重要女性人物。",
  ...
  "0788": {
    ...
    storyBodyZh: "他不是只想做奇特造型，而是着迷于效率：张力怎样分布，三角形为什么稳定，球面结构如何把重量分散，临时住房和大型空间能不能更轻、更快、更省。geodesic dome 把数学几何、结构工程、制造节点、建筑空间和资源伦理放在一起。它也不是万能答案，实际使用会遇到防水、维护、舒适和成本问题；但跨学科工程的价值正是在这里显现：一个形状同时要求几何、材料、建造、居住和社会理想共同受检验。这个人叫 Buckminster Fuller，他推广 geodesic dome，并以系统设计和“doing more with less”的思想影响工程、建筑和设计教育。",
  ...
  "0799": {
    ...
    storyBodyZh: "他面对的是一个被城市增长放大的系统性麻烦：厕所、河流、潮汐、疾病、街道、预算、政治拖延和公众恐惧全缠在一起。解决方案不是清理一条水沟，而是设计截流下水道、泵站和排放系统，把污水从城市生活核心转移出去。今天我们会继续追问污染被转移到哪里、谁承担环境代价，但这个工程确实让现代城市意识到，基础设施决定公共健康。未另分类的工程、制造与建筑常常就发生在这种边界：它既是土木工程，也是卫生、行政、政治和城市生活的重新组织。这个人叫 Joseph Bazalgette，他设计伦敦现代下水道系统，成为城市基础设施和公共卫生工程史上的重要人物。",
  ...
  "0800": {
    ...
    storyBodyZh: "他面对的不是一株植物的漂亮问题，而是饥饿、病害、产量、土壤、灌溉、肥料和国家粮食政策。高产小麦如果太高，施肥后容易倒伏；如果抗病性不足，一场病害就能毁掉收成。他和团队反复杂交、筛选、试种，把矮秆、高产和抗病性结合起来。农业、林业、渔业与兽医的宽镜头在这里很清楚：人类照料生命并不是只追产量，还要面对生态代价、社会分配和长期可持续。这个人叫 Norman Borlaug，他推动半矮秆高产小麦育种和绿色革命，因对粮食增产的贡献获得 1970 年诺贝尔和平奖。",
  ...
  "0810": {
    ...
    storyBodyZh: "他并不是只想做一台新机器，而是对土地上的浪费感到不安。种子如果能按固定深度、固定间距进入土壤，就更容易发芽，也便于后续除草和管理。他改进 seed drill，让播种变得更有秩序。今天看来，机械化也带来单一化和土地管理的新问题，但这个故事说明农业的基础问题从来不是“把种子扔进地里”这么简单。它涉及工具、土壤、时间、劳动力和对生命条件的精确安排。这个人叫 Jethro Tull，他推广播种机和条播思想，成为英国农业改良史上的重要人物。",
  ...
  "0811": {
    ...
    storyBodyZh: "他知道农民不是不努力，而是被单一作物、贫困和土壤退化困住。棉花长期消耗土地，也让农户收入脆弱。他研究豆科作物、轮作、土壤改良和可替代用途，向农民推广花生、甘薯等作物的种植和加工方法。作物与畜牧生产在这里不只是产量竞赛，而是土地、营养、市场、家庭收入和生态恢复的关系。这个人叫 George Washington Carver，他在 Tuskegee Institute 推动作物轮作、土壤改良和花生等作物用途研究，成为美国农业教育史上的重要人物。",
  ...
  "0812": {
    ...
    storyBodyZh: "他没有把园艺只当作把植物养漂亮。每一株植物都有差异，哪一株更甜，哪一株更耐寒，哪一株花色更特别，哪一株适合当地市场，都需要被观察、选择和繁殖。他培育李子、马铃薯、仙人掌和许多观赏植物，也留下关于育种商业化和科学严谨性的争议。园艺在这里显出双重性：它既是审美和照料，也是遗传、环境、市场和时间共同塑造植物的实践。这个人叫 Luther Burbank，他以大量植物育种和园艺新品种闻名，影响了美国园艺和植物改良文化。",
  ...
  "0819": {
    ...
    storyBodyZh: "他并不是因为不懂科学才反对过度干预，恰恰相反，他见过病理学和农业技术如何解释植物，也看到农民越来越依赖耕作、化肥、农药和劳力。他在稻田里试验不耕作、覆盖稻草、混播、减少外部投入，让田地成为一个更自我调节的生态系统。这个方法并不适合被简单神化，也需要根据地区和产量现实审慎判断；但它说明未另分类的农业经常处在科学、哲学、生态和生活实践之间。这个人叫 Masanobu Fukuoka，他提出 natural farming，并通过《The One-Straw Revolution》影响了生态农业和永续农业思潮。",
  ...
  "0821": {
    ...
    storyBodyZh: "他并不是反对使用森林，而是反对只把森林当作一次性矿藏。木材、水源、土壤、火灾、野生动物和地方经济都需要长期管理。他推动专业林务、国家森林和持续产出思想，主张为了公共利益管理自然资源。今天我们也会批判早期保护主义里对原住民和地方社区的忽视，但林业作为学科的一个核心问题由此凸显：森林的时间尺度比商业周期长得多。这个人叫 Gifford Pinchot，他是美国林务改革重要人物，首任 U.S. Forest Service 局长，并推动 conservation 林业理念。",
  ...
  "0831": {
    ...
    storyBodyZh: "他意识到一个危险：每一代人都把自己年轻时见到的鱼群数量当成“正常”。如果基准不断下降，大家就会在越来越贫瘠的海里继续觉得情况还可以。他提出 shifting baseline 的概念，提醒渔业不能只看今年和去年，还要看更长的生态记忆。渔业研究在这里不只是捕多少鱼，也要理解种群、食物网、捕捞压力、政策和人类记忆如何共同影响海洋。这个人叫 Daniel Pauly，他提出 shifting baseline syndrome，并通过全球渔业数据研究影响了现代渔业科学和海洋保护。",
  ...
  "0841": {
    ...
    storyBodyZh: "动物生病不是只影响一个主人。马牵动交通和军队，牛牵动耕作、食物和家庭收入。传统马医经验有价值，却缺少系统解剖、病理、教学和公共防疫。他推动建立专门学校，让动物医学成为可训练、可研究、可传承的专业。兽医领域在这里清楚出现：它既照料动物个体，也保护畜群、食品、农业经济和人与动物共同生活的安全。这个人叫 Claude Bourgelat，他在 Lyon 创办世界最早的兽医学校之一，被视为现代兽医学教育的重要奠基人。",
  ...
  "0888": {
    ...
    storyBodyZh: "她的感知方式和许多人不同，也让她更容易注意到动物在空间里的恐惧。她没有只责怪动物不听话，而是蹲到它们的视线高度，看光线、声音、地面、防滑、转弯和人的动作。她设计弧形通道和更低压力的处理系统，把动物行为学、工程设计、畜牧生产和伦理关怀放在一起。这个跨学科领域不只问怎样提高效率，也问人在利用动物时怎样减少恐惧和痛苦。这个人叫 Temple Grandin，她以畜牧设施设计和动物福利倡导闻名，推动农业、工程、兽医和动物行为之间的跨学科实践。",
  ...
  "0899": {
    ...
    storyBodyZh: "这个项目看起来像仓库，却不只是储藏。每一份种子都代表一种作物遗传资源，也代表某个地区的农业记忆和未来适应可能。战争、灾害、气候变化、病害和市场单一化，都可能让种子多样性消失。未另分类的农业、林业、渔业与兽医领域正需要这种边界意识：它不完全是种植，也不只是科研或外交，而是食物系统为未来保留选择。这个人叫 Cary Fowler，他长期推动作物多样性保护，并作为 Svalbard Global Seed Vault 的关键倡导者之一影响了全球种质资源保存。",
  ...
  "0900": {
    ...
    storyBodyZh: "他看到的不只是病原体和症状。饥饿、恶劣住房、缺乏教育、贫困、政治无力和公共卫生缺位，都在让疾病扩散。单纯开药无法解决这种病，因为病人回到同样的生活条件，风险还在那里。他把报告写成一种更尖锐的医学判断：医学是一门社会科学，政治不过是大规模的医学。健康与福利在这里被连接起来：人的身体状态常常是社会制度写在皮肤、肺和血液里的结果。这个人叫 Rudolf Virchow，他通过上西里西亚斑疹伤寒报告和社会医学思想，成为公共卫生、病理学和健康社会决定因素思想的重要人物。",
  ...
  "0910": {
    ...
    storyBodyZh: "他所处的时代，疾病常被解释成神灵惩罚或神秘力量。可他和传统中的同伴把注意力放到更具体的地方：症状何时开始，脉象和呼吸如何，饮食、季节、地点和体质有什么关系，医生应怎样谨慎判断而不伤害病人。许多文本并非都出自同一人之手，也带有时代局限；但健康领域的一个重要转向已经出现：照护身体需要观察、经验、记录和伦理约束，而不是只靠巫术或权威。这个人叫 Hippocrates，他所代表的 Hippocratic tradition 成为西方医学观察、临床伦理和医生职业形象的重要源头。",
  ...
  "0911": {
    ...
    storyBodyZh: "当时很多牙病由理发师、游医或拔牙匠处理，常常只在疼痛无法忍受时才动手。他把牙齿解剖、龋齿原因、牙周问题、矫治、假牙和器械整理成系统知识，强调保存牙齿、清洁和专业判断。牙科研究在这里变得清楚：口腔不是身体之外的小零件，牙齿结构、疼痛、营养、感染、说话和人的尊严都连在一起。这个人叫 Pierre Fauchard，他出版《Le Chirurgien Dentiste》，被广泛称为现代牙科学的重要奠基人之一。",
  ...
  "0912": {
    ...
    storyBodyZh: "他没有先把死亡归咎于命运，而是比较班次、人员、流程和尸检接触。他注意到医生和学生从解剖室进入产房，可能把看不见的致命物质带到产妇身边。要求用含氯石灰洗手后，死亡率显著下降。可是这个发现并没有立刻得到欢迎，因为它暗示医生自己的手可能造成伤害。医学在这里显出痛苦的一面：正确证据如果挑战职业自尊和制度习惯，仍然会被抵抗。这个人叫 Ignaz Semmelweis，他提出产科洗手消毒可降低产褥热死亡率，成为感染控制和医学证据史上的关键人物。",
  ...
  "0913": {
    ...
    storyBodyZh: "刚到医院时，她看到的不是传说里的英雄场面，而是一连串很具体的麻烦：脏床单、通风差、排水糟糕、物资混乱，病人有时不是死于伤口，而是死于伤口之后的环境。她带人清洁、整理供应、改善卫生，也一遍遍记录死亡原因和病房情况。夜里，她提着灯巡视，不只是为了安慰伤兵，更是在看呼吸、疼痛、发热和恐惧有没有改变。真正重要的不是浪漫的光，而是她把照护变成一种有纪律的专业：观察、记录、卫生、训练和制度。这个人叫 Florence Nightingale，她建立现代护理训练的重要传统，并用统计和公共卫生改革改变了护理与助产的专业地位。",
  ...
  "0914": {
    ...
    storyBodyZh: "他没有把异常当成干扰丢掉，而是反复遮挡、测试、记录，发现一种未知射线能穿过纸板和软组织，却被骨头和金属阻挡。他拍下妻子的手，骨骼和戒指清晰显现。医学诊断与治疗技术由此被彻底改变：医生可以不用切开身体就看见内部结构。可是技术也带来新风险，早期 X 光使用曾因不了解辐射伤害而造成损害。这个领域因此一直同时包含设备、图像、质量控制和安全边界。这个人叫 Wilhelm Conrad Rontgen，他发现 X-rays，并于 1901 年获得首届诺贝尔物理学奖。",
  ...
  "0915": {
    ...
    storyBodyZh: "他看到医院常把治疗重点放在疾病消失或伤口愈合，却没有充分回答之后怎么办。一个人可能需要重新训练肌肉、学习使用辅助器具、处理疼痛、调整家庭和工作环境，也要重新获得尊严。他推动 rehabilitation medicine，把物理治疗、作业治疗、心理支持、社会安排和长期目标放在同一个计划里。治疗与康复因此不只是把人恢复到过去，而是在新的身体条件下重新组织生活能力。这个人叫 Howard A. Rusk，他推动现代康复医学发展，被称为康复医学的重要奠基人物之一。",
  ...
  "0916": {
    ...
    storyBodyZh: "药物能救人，也能伤人。粉末、酊剂、植物提取物和处方如果没有标准，病人很难知道自己真正拿到什么。他不满足于药剂师只靠师徒经验和商业买卖，而是推动药学教育、专业组织、药典标准和伦理责任。药学在这里从“把药交出去”变成一门保护药物效果和安全的专业：成分、剂量、相互作用、储存、说明和患者理解都重要。这个人叫 William Procter Jr.，他推动美国药学教育和专业化，被称为美国药学的重要奠基人物之一。",
  ...
  "0917": {
    ...
    storyBodyZh: "他没有把传统当成一成不变的权威。相反，他反复校对古书，记录产地，辨别同名异物，补充民间经验，也纠正前人错误。这个过程说明传统与补充医学最严肃的部分不是神秘化，而是长期积累、辨伪、剂量、适应症和风险边界。今天看传统疗法，更需要尊重历史经验，也需要现代证据和安全评估。这个人叫 Li Shizhen，他编写《本草纲目》，系统整理药物知识，成为中国本草学和传统医学史上的重要人物。",
  ...
  "0919": {
    ...
    storyBodyZh: "他一开始以为自己在研究某种特定物质的作用。可是无论注射什么，动物都出现胃溃疡、肾上腺变化、免疫组织萎缩等相似反应。他开始怀疑，身体可能是在对各种有害刺激作出一种一般性反应。这个想法后来发展为 stress 的生理研究，也经历过概念扩张和争议。未另分类的健康领域常常这样出现：问题不完全属于单一疾病，也不只是心理或社会，而是身体、环境、情绪和长期负荷交织。这个人叫 Hans Selye，他提出 general adaptation syndrome 并推动 stress 进入现代健康研究。",
  ...
  "0920": {
    ...
    storyBodyZh: "他面对的不是某个家庭的一次困难，而是社会中反复出现的风险：没有工作、生病、年老、孩子多、收入不足。过去的救济常常零散、羞辱性强，也难以覆盖人生不同阶段。他提出更系统的社会保险和福利国家设想，试图对抗所谓“五大巨人”：贫困、疾病、无知、肮脏和失业。福利在这里不是施舍，而是现代社会如何共同分担风险、保障最低安全和人的尊严。这个人叫 William Beveridge，他的 1942 年 Beveridge Report 深刻影响英国福利国家和现代社会保障制度。",
  ...
  "0921": {
    ...
    storyBodyZh: "别人常把他的需求理解成护理和保护，他却不断追问：为什么帮助必须以失去自主为代价？他和同伴争取校园无障碍、个人助理、住房选择和自我决定权，后来推动独立生活运动。老人和残障成人照护在这里发生了重要转向：照护不只是替人做事，也不是把人安置到方便管理的地方，而是支持一个人尽可能掌握自己的生活节奏、关系和选择。这个人叫 Ed Roberts，他推动 Berkeley Independent Living Movement，成为残障权利和独立生活运动的重要人物。",
  ...
  "0922": {
    ...
    storyBodyZh: "他并不把孩子只看成等待成人塑造的半成品。孩子会恐惧，会犯错，会需要规则，也有被认真倾听的尊严。他在孤儿院里让孩子参与自治，处理冲突，表达意见，练习责任。后来在纳粹占领和犹太隔都的极端处境中，他仍尽力保护孩子的尊严。儿童照护与青少年服务在这里不是简单看管，而是创造一个年轻人能够被保护、被听见、能学习承担责任的环境。这个人叫 Janusz Korczak，他以儿童权利思想、孤儿院实践和最后陪伴孩子进入 Treblinka 的选择，成为儿童照护与教育伦理的重要人物。",
  ...
  "0923": {
    ...
    storyBodyZh: "她看到贫困背后可能有失业、疾病、亲属关系、住房、债务、羞耻和制度缺口。帮助如果只看眼前请求，很容易误解人，也容易重复失败。她强调调查、访谈、记录、家庭和社区资源，把个案工作变成有方法的专业实践。今天我们会更敏感地批判早期慈善中的阶级眼光和道德判断，但她推动的一个转向仍然重要：社会工作与咨询必须理解一个人所处的关系网，而不是只评价个人。这个人叫 Mary Ellen Richmond，她通过《Social Diagnosis》等作品奠定现代社会个案工作的重要方法基础。",
  ...
  "0929": {
    ...
    storyBodyZh: "他原本不是来创办组织的，却被眼前场面困住：不同国家的士兵一样流血，医疗力量远远不足，平民临时参与救助。他组织当地人照顾伤员，后来把经历写成书，提出建立中立救援组织和国际规则。未另分类的福利正像这种实践：它不只是医院，不只是军队，也不只是慈善，而是在灾难、战争、法律和人道责任之间为脆弱者开出一条保护通道。这个人叫 Henry Dunant，他推动 International Committee of the Red Cross 和 Geneva Convention 的形成，并成为现代人道主义救援的重要奠基人。",
  ...
  "0988": {
    ...
    storyBodyZh: "她发现病人的痛苦并不只在身体里。疼痛、恐惧、家庭关系、宗教疑问、经济压力和被遗弃感会叠在一起。如果医学只在治愈失败后才想起照护，就太晚了。她提出 total pain 的理解，建立 hospice 照护，把症状控制、心理支持、家属陪伴、社会工作和尊严放在同一套体系里。健康与福利的跨学科意义在这里非常清楚：人不是一组器官，也不是一张福利表格，而是在生命末端仍需要被完整看见。这个人叫 Cicely Saunders，她创办 St Christopher's Hospice，并奠定现代 hospice 和 palliative care 的重要基础。",
  ...
  "0999": {
    ...
    storyBodyZh: "她不是只做临时善事。战争让她看到，伤员护理、物资协调、失踪人员信息、志愿者组织和灾后救援需要长期制度，而不该每次都从混乱开始。战后，她继续推动建立更稳定的人道救援组织，使救护从战争现场延伸到灾害、公共应急和社会支持。未另分类的健康与福利常常就站在这种边界：它既不是普通医院，也不是单一福利机构，而是在危机里把照护、信息、物资和组织能力接起来。这个人叫 Clara Barton，她创办 American Red Cross，并推动美国加入国际红十字人道救援体系。",
  ...
  "1000": {
    ...
    storyBodyZh: "他意识到，服务不是总部文件里的承诺，而是旅客和员工相遇的每一个瞬间：电话是否被接起，柜台是否有权解决问题，延误时信息是否诚实，员工是否被信任去判断现场。于是他强调 moments of truth，让组织把权力下放到前线，把服务体验看成无数接触点共同形成的结果。服务领域在这里变得具体：体验不是微笑装饰，而是流程、信息、权限、情绪和时间是否对齐。这个人叫 Jan Carlzon，他在 Scandinavian Airlines 推动服务管理转型，并以 moments of truth 思想影响现代服务管理。",
  ...
  "1010": {
    ...
    storyBodyZh: "她明白顾客来这里不只是买一瓶霜。她们想被认真接待，想学习如何照顾自己，也想进入一种新的城市女性形象。她建立美容院、培训销售人员、统一产品和服务话术，把个人服务组织成可复制的体验系统。这个过程当然也和消费主义、阶层和审美压力纠缠在一起；但它说明个人服务并不是低级边角行业，而是身体、情绪、身份、信任和商业组织相遇的地方。这个人叫 Elizabeth Arden，她建立全球美容品牌和 salon 服务体系，深刻影响现代个人护理和美容服务业。",
  ...
  "1011": {
    ...
    storyBodyZh: "她不把家务看成天生会做的女性本能。水质、污水、通风、食物营养、清洁剂、厨房动线和家庭预算，都需要知识和标准。她推动 domestic science 和 home economics，把家庭运行放进教育和公共卫生视野。今天我们会警惕家政知识被用来固定性别分工，但她的工作也提醒我们：一个家是否安全、健康、好用，背后有化学、卫生、营养和管理。这个人叫 Ellen Swallow Richards，她是美国早期女性化学家和 home economics 重要奠基人物之一。",
  ...
  "1012": {
    ...
    storyBodyZh: "她知道头发不只是外表，也关系到工作、自尊、种族压力和女性互助。她开发产品、培训销售代理、开办美容学校，让许多黑人女性通过美发和美容服务获得收入与社群地位。今天我们也会讨论当时审美标准与种族政治的复杂性，但她的故事说明，美发与美容服务不是简单“变好看”，而是技术、身体、身份、商业和社会机会交织的行业。这个人叫 Madam C. J. Walker，她建立护发美容企业和培训体系，成为美国黑人女性创业和美容服务史上的标志性人物。",
  ...
  "1013": {
    ...
    storyBodyZh: "他并不只追求菜品精致，也关心厨房怎样在高压下稳定交付。谁负责酱汁，谁负责烤肉，谁负责冷盘，菜单怎样简化，服务怎样按节奏送到餐桌，都需要组织。他把 brigade de cuisine 和现代菜单、酒店餐饮服务结合起来，让餐饮从个人手艺扩展成团队系统。酒店、餐厅与餐饮在这里变得清楚：食物只是体验的一部分，卫生、时间、分工、前后台协作和顾客感受同样决定记忆。这个人叫 Auguste Escoffier，他改革专业厨房组织和现代法餐服务，被视为现代餐饮管理和厨艺体系的重要人物。",
  ...
  "1014": {
    ...
    storyBodyZh: "他需要一种室内运动，既能消耗体力，又不至于像橄榄球那样冲撞受伤。他把桃篮钉高，用足球传递，写下十三条规则，强调传球、空间、目标和限制身体接触。体育在这里不是随便竞争，而是通过规则设计让身体、团队、公平和安全同时存在。一个好运动并不只是让人赢，还要让人愿意反复练习、合作、遵守边界并在限制中创造。这个人叫 James Naismith，他于 1891 年发明 basketball，使篮球成为全球重要体育项目。",
  ...
  "1015": {
    ...
    storyBodyZh: "他面对的不是远方风景，而是让一群普通人安全、便宜、有计划地抵达目的地。火车票、团体价格、行程安排、住宿、说明和陪同服务慢慢连成一个新行业。旅行、旅游与休闲在这里不再只是富人的个人游历，而成为被组织出来的体验：路线怎样设计，风险怎样降低，地方文化怎样被介绍，游客自由又怎样依赖别人提前安排。这个人叫 Thomas Cook，他组织早期团体旅行并创办旅行服务企业，成为现代旅游业和旅行社服务的重要先驱。",
  ...
  "1019": {
    ...
    storyBodyZh: "传统服务窗口很难覆盖这种小而急的需求：不是医疗，不是旅游，不是家政，也不是普通客服。一个人只需要另一个可靠的人通过手机摄像头看一眼，告诉他颜色、文字、按钮或路线。这样的服务把志愿者、视频通话、无障碍和个人日常支持连接起来，也提醒我们服务价值不一定来自复杂流程，有时来自在正确时刻补上一点人的感知。这个人叫 Hans Jorgen Wiberg，他创立 Be My Eyes，使志愿者通过视频协助视障者处理日常视觉问题，成为未另分类个人服务的现代案例。",
  ...
  "1020": {
    ...
    storyBodyZh: "他关心空气、水、住房、排污和城市环境，也建立实验和教学体系，让卫生不只是日常清洁习惯，而成为可研究、可训练、可争论的公共专业。他的某些理论后来被修正，特别是在病菌理论发展后；但他推动卫生学进入大学、实验室和城市治理的努力，说明卫生与职业健康服务的基础意义：预防必须发生在疾病出现之前，发生在水、空气、建筑、工作和制度中。这个人叫 Max von Pettenkofer，他建立慕尼黑卫生学研究传统，被视为现代 hygiene 和公共卫生教育的重要先驱之一。",
  ...
  "1021": {
    ...
    storyBodyZh: "他发现，责怪穷人不爱干净很容易，却忽略了他们生活在怎样的街道、水源和排污条件里。污水横流、垃圾堆积、饮水污染和住房拥挤，让疾病传播成为结构性后果。他的报告推动公共卫生改革，也带着当时阶级眼光和治理控制的问题，需要被批判阅读。但社区卫生的核心已经清楚：干净不是只靠个人习惯，而要靠供水、排水、垃圾处理、住房和公共制度。这个人叫 Edwin Chadwick，他的 1842 年《Report on the Sanitary Condition of the Labouring Population》推动英国公共卫生和城市卫生改革。",
  ...
  "1022": {
    ...
    storyBodyZh: "她没有只在诊室等待病人，而是去看病人工作的地方。毒物在哪里产生，粉尘怎样被吸入，通风是否足够，工人有没有防护，雇主是否隐瞒风险？这些问题让职业健康与安全成为一门现场科学。工作场所的伤害不是“粗心”两个字能解释的，它常常来自材料、设备、节奏、权力和缺乏监管。这个人叫 Alice Hamilton，她开创美国职业医学和工业毒理调查传统，推动工作场所健康与安全改革。",
  ...
  "1029": {
    ...
    storyBodyZh: "那场火灾暴露的不只是一个工厂的事故，而是逃生通道、工时、童工、消防检查、雇主责任和政府监管的失败。她后来参与调查和改革，推动工厂安全、最低工资、失业保险等劳动保护制度。未另分类的卫生与职业健康服务常常出现在这种交界处：它不是单一卫生措施，也不是单个安全培训，而是法律、工作现场、公共行政和人的生命价值如何被重新安排。这个人叫 Frances Perkins，她在 Triangle 火灾后推动劳动与安全改革，后来成为美国首位女性内阁部长并参与 New Deal 社会保障制度建设。",
  ...
  "1030": {
    ...
    storyBodyZh: "他要解决的不是单次抓捕，而是一个城市怎样在不变成军营的情况下维持公共秩序。新警察需要可识别的制服、巡逻、纪律、预防原则和公众信任。这个制度也一直伴随权力滥用、阶级控制和监督问题，必须被批判地看；但现代安全服务的一个核心矛盾已经出现：保护公众需要权力，而权力又必须被规则、透明和责任约束。这个人叫 Robert Peel，他创立 London Metropolitan Police，并使现代公共警务原则成为安全服务史上的重要起点。",
  ...
  "1031": {
    ...
    storyBodyZh: "他并不把战争写成单纯勇敢。真正的将领要先计算代价，理解地形，保存士气，使用信息，避免被愤怒驱动，也要知道不战而屈人之兵有时高于硬碰硬。军事与国防在这里显出冷静的一面：力量不是全部，组织、补给、情报、时间、心理和政治目标共同决定安全。古代文本不能直接替代现代伦理和国际法，但它提醒我们，防御和战争从来不是单纯武器问题。这个人叫 Sun Tzu，他的《The Art of War》成为军事战略、组织竞争和安全思考史上的经典文本。",
  ...
  "1032": {
    ...
    storyBodyZh: "他相信犯罪现场不是沉默的。鞋底带走泥土，衣袖留下纤维，玻璃碎片交换微粒，人与物只要接触就会互相留下痕迹。这个思想改变了安全服务：保护人身与财产不只是锁门、巡逻和抓人，也包括保存现场、分析证据、重建事件和让判断经得起法庭检验。证据工作也必须受程序和权利约束，否则技术会变成新的不公。这个人叫 Edmond Locard，他建立 Lyon police laboratory，并提出 Locard's exchange principle，成为现代法医学和犯罪调查的重要人物。",
  ...
  "1039": {
    ...
    storyBodyZh: "他的经历并不适合简单歌颂，也充满道德复杂性。正因为熟悉犯罪现场的语言和习惯，他能从细节里看出伪装，建立档案，使用卧底和线人，把调查从单纯巡逻变成信息工作。后来他创办私人侦探机构，使安全服务出现警务、商业调查、情报和个人委托之间的灰色地带。未另分类的安全服务正需要审慎处理这种边界：有效信息、合法权力和隐私风险总是同时存在。这个人叫 Eugene Francois Vidocq，他从罪犯转为侦探并创办侦探机构，被视为现代侦探和私人调查史上的重要人物。",
    supportZh: "Eugene Francois Vidocq 是法国犯罪者、警方线人和侦探，曾领导 Surete 相关工作并创办私人侦探机构。他对刑侦档案、卧底和侦探形象产生深远影响。",
  ...
  "1041": {
    ...
    storyBodyZh: "他大胆舍弃精确距离，把线路画成水平、垂直和 45 度角，把站点间距简化，让换乘关系变得清楚。这个图一开始并不符合传统地图直觉，却更符合乘客在运输系统里的真实需要：我在哪，去哪换，下一站怎么走。运输服务在这里不仅是车辆移动，也包括信息设计、时间承诺、可达性和人在压力下的判断。一个系统如果让人看不懂，再准时也会让人迷失。这个人叫 Harry Beck，他设计 London Underground diagram，成为现代交通信息设计和运输服务体验的经典案例。",
  ...
  "1088": {
    ...
    storyBodyZh: "一次酒店入住、银行开户或维修预约，看起来是几句对话，背后却有表格、系统、培训、库存、授权、等待时间和失败补救。她提出 service blueprint，把顾客行为、前台接触、后台流程和有形证据画在一起。这样，服务不再只是态度好不好，而成为可以分析、设计和跨部门协调的系统。服务跨学科课程也由此清楚：运营、心理、空间、信息、人员和技术必须同时工作。这个人叫 G. Lynn Shostack，她提出 service blueprinting，成为服务设计和服务营销中的重要方法来源。",
  ...
  "1099": {
    ...
    storyBodyZh: "他发现，许多人并不是一开始就能走进医院、警局、福利机构或教堂。他们可能只需要一个不审判、不急着训诫、愿意在深夜听完的人。于是志愿者被训练去接电话，重点不是立刻给答案，而是让来电者在最危险、最孤单的时刻不再独自承受。这样的服务很难归类：它不是普通医疗，也不是正式咨询，不是安保，也不是家政；但它在许多系统之间守住了一条细小通道。未另分类的服务正需要容纳这种看似无名却极其关键的支持。这个人叫 Chad Varah，他创立 Samaritans，让危机倾听热线成为现代志愿服务和情绪支持服务的重要形式。",
...
function renderCategoryTree(category) {
  ...
  const conceptFableMatchesGroup = conceptFable && activeGroup.fields.some(([fieldCode]) => fieldCode === conceptFable.selectedFieldCode);
  const fieldStories = activeGroup.fields
    .map(([fieldCode, fieldTitle]) => {
      const fieldStory = getLensStoryForField(category.code, activeGroup.code, fieldCode);
      if (!fieldStory) return "";
      const href = `/lens-stories/${fieldStory.id}`;
      const displayTitle = getLensStoryFieldTitle(fieldStory, fieldCode, fieldTitle);
      return `
        <a class="submodule-story-button" href="${href}" data-route="${href}">
          <span>${escapeHtml(displayTitle)}</span>
          <small>${escapeHtml(getLensStoryValue(fieldStory, "title"))}</small>
          <em>${escapeHtml(t("openStory"))}</em>
        </a>`;
    })
    .join("");
  const conceptFableButton = conceptFableMatchesGroup
    ...
    : "";
  const conceptButtons = `${fieldStories}${conceptFableButton}`.trim();
  target.innerHTML = `
      ...
      <section class="submodule-story-panel" aria-live="polite">
        ...
        <div class="submodule-story-section">
          ...
          <div class="submodule-story-button-list">
            ${conceptButtons || `<div class="submodule-story-button is-empty"><span>${escapeHtml(t("importantConceptStories"))}</span><small>${escapeHtml(t("noStoryReady"))}</small></div>`}
          </div>
        </div>
      </section>
    </div>`;
