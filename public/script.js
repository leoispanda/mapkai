...
function renderPdcRecap(recap) {
  const sections = [
    ["Decision Frame", recap.sections?.decisionFrame],
    ["Core Tension", recap.sections?.coreTension],
    ["Council Highlights", recap.sections?.councilHighlights],
    ["Debate Snapshot", recap.sections?.debateSnapshot],
    ["Condensed Review", recap.sections?.condensedReview],
    ["Final Recommendation", recap.sections?.finalRecommendation],
    ["Next Actions", recap.sections?.nextActions],
    ["What Not To Do", recap.sections?.whatNotToDo],
    ["Reflection Note", recap.sections?.reflectionNote],
  ];
  return `
