...
const uiText = {
  en: {
    ...
    reflectionSnippetsTitle: "Quiet observations from exploration",
    reflectionSnippets: [
      "You rarely stay inside confusion for long.",
      "Observation itself\ncan become a way to delay action.",
      "Many redesigns\nare not proof that the direction was wrong.",
  ...
  zh: {
    ...
    homeLearning: "查看知识地图",
    homeCategories: "浏览领域",
    reflectionSnippetsTitle: "探索中的安静观察",
    reflectionSnippets: [
      "你很少真正停留在混乱里。",
      "观察本身，\n有时也会变成一种延迟行动的方法。",
      "很多重新设计，\n并不是因为方向错了。",
