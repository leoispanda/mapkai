...
const uiText = {
  en: {
    ...
    lensStoryShelfTitle: "Every lens now starts with a story.",
    lensStoryShelfCopy: "Open a short everyday story for each knowledge lens, then continue into its subcategory and field.",
  ...
  zh: {
    ...
    lensStoryShelfTitle: "每个知识镜头先有一个生活故事。",
    lensStoryShelfCopy: "先从每个 Lens 的代表性子类进入一个日常情景，再回到它对应的知识领域。",
