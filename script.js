...
const reviewedLensStoryOverridesZh = {
  "000-general-starter-course": {
    "storyBodyZh": "他二十出头，离贫穷还不远，所以很清楚：书、谈话和可靠的朋友，真的可能改变一个人的命运。来聚会的人并不都是学者，有工匠、店员、测量员、制造者，也有人只是想把生意、品格、政治和自然知识弄明白一点。他们带来的不是考试，而是问题：这周你学到什么有用的东西？城市应该避免什么错误？下一本书借什么？谁需要帮忙找工作？当这些练习被放在同一个夜晚或同一张桌上，学习不再像一串零散任务，而像进入世界前先搭好的扶手。",
    "knowledgePointZh": "关键转向在于：人在进入具体道路前，先练习怎样读、问、表达和共同判断。"
  },
  "011-dewey-lab-school": {
    "storyBodyZh": "参与这所学校的那位哲学家，原本研究哲学和心理学。他一直被一个很朴素的问题困住：为什么学校常常把“会思考”和“会生活”分开？他看孩子做饭、缝纫、制作、测量、交谈，然后追问为什么。一节早餐课可以同时牵出化学、数量、历史、合作和语言。教室并不是把所有活动都浪漫化，老师仍然需要准备、观察、连接和提问。问题从“把哪些内容教完”，变成“学习者在怎样的情境里开始自己连接经验和知识”。桌上的工具、对话和反复尝试一旦连起来，课堂就不只是传递答案，而是在安排一种能发生理解的场面。",
    "knowledgePointZh": "关键转向在于：教学的关键不是把答案搬给学生，而是设计一种能让经验、行动和解释相遇的情境。"
  },
  "020-family-photo-meaning": {
    "storyBodyZh": "他不满足于只用作者、年代和风格来解释一幅画。文艺复兴图像里抬起的手臂，会让他想起古代雕像；硬币上的女神，好像又出现在报纸图片里；节庆服装、占星图、政治海报，可能都把古老的姿势带进新的生活。晚年，他把几百张复制图钉在黑布板上，一次次挪动位置。图谱上几乎没有说明文字，因为重点不是给观众一个整齐答案，而是让图像彼此靠近，让记忆、恐惧、欲望、仪式和权力的暗线浮现出来。当图像、文本或物件被反复放到一起，意义不再只贴在标签上，而是在观看和解释的往返里慢慢露出来。",
    "knowledgePointZh": "关键转向在于：作品、文本和物件不是孤立陈列，它们会带着记忆、权力、材料和观看方式一起生产意义。"
  },
  "030-neighbor-notice-board": {
    "storyBodyZh": "她不是从安静书房里开始理解社会的。她住进一个工人和移民聚居的街区，听见母亲为孩子找托管，工人为工资争论，年轻人想学英语，病人不知道去哪里求助。问题看起来分散：贫困、语言、教育、卫生、劳动、住房、信息不通。问题从“谁说对了”，变成“信息、位置、利益和证据怎样把一群人的判断推向不同方向”。当名单、地图、访谈或记录被摊开，个人抱怨开始显出背后的路径：谁被听见，谁被漏掉，什么证据还能继续追。",
    "knowledgePointZh": "关键转向在于：公共事实要靠记录、核对、解释和传播被做出来，也要不断追问谁在资料里出现，谁被排除。"
  },
  "040-kitchen-repair-budget": {
    "storyBodyZh": "他见过铁路、制造、银行和贸易如何改变美国，也见过市场扩张带来的混乱。账目、合同、组织、法律、货币、运输和公共责任纠缠在一起，年轻人却常常只能靠店铺学徒或家族关系慢慢摸索。他提出一个当时并不自然的想法：商业也应该进入大学，被系统研究和训练。后来商学院有过许多争议，也不断被重新批判，但这个起点说明，现代商业已经复杂到需要制度化学习。问题从“哪个选择更划算”，变成“成本、责任、风险和规则怎样被摆到同一张桌面上”。等账本、合同、承诺和后果一起出现，选择就不再只是个人聪明，而成了共同承担之前必须说清的安排。",
    "knowledgePointZh": "关键转向在于：组织和交易不是只靠意愿运行，资源、责任、风险和规则必须被摆出来比较。"
  },
  "050-balcony-plant-observation": {
    "storyBodyZh": "山脚还有热气，标本纸却已经被高处的潮气弄软。一个年轻旅行者把采下的叶片压进纸页，在旁边写上海拔、温度和气压。许多自然学者习惯先问：这是什么植物，应该放进哪个柜格。可同一座山不肯只给出名字。往上走，阔叶少了，矮小的草本贴近石缝；再高处，颜色更暗，枝叶更硬。他翻回旧笔记，把南美山坡上的记录同欧洲高山、热带低地放在一起比较。问题从“这株植物叫什么”，变成“为什么它只在这样的高度、湿度和温度里出现”。当数字、叶片和位置被排到同一张图上，山坡不再只是背景，而像一条能被阅读的剖面：每一层生命都连着空气、冷暖、水分和地形。",
    "knowledgePointZh": "关键转向在于：一株植物不再只是标本名，而是同时带着海拔、温度、水分和位置；数字与图像把这些关系放到同一张可检查的图上。"
  },
  "061-phone-backup-help": {
    "storyBodyZh": "电话实验室里，纸带穿过电报码机，耳机里混着轻微噪声。工程师通常先问线路怎样更清楚、机器怎样更稳定；一个年轻数学家却把纸上的字母暂时放下，只数另一件事：接收者原本有多少可能，现在被这条消息排除了多少可能。他画通道，计算噪声，比较冗余和压缩，也把“带宽”从一根线的粗细变成可以计算的限制。问题从“这条消息是什么意思”，变成“它减少了多少不确定性，又能在多吵的通道里被送到”。当情书、订单和天气报告都能先被看成选择的减少，通信就不再只靠更响的声音，而开始靠编码、容量和可检查的错误控制。",
    "knowledgePointZh": "关键转向在于：信息可以先被拆成可计量的选择，再讨论它怎样穿过噪声、编码和通道抵达另一端。"
  },
  "070-wobbly-shelf-repair": {
    "storyBodyZh": "桥要跨得更远，隧道要穿过更危险的地层，铁路要让城市和港口重新连接，船要在大西洋上承受风浪、燃料和钢铁结构的限制。他常常大胆到让人害怕，也并非每个项目都顺利；成本、事故、健康和公众信任不断压过来。问题从“能不能做出来”，变成“材料、结构、流程和安全边界怎样让它经得住反复使用”。等重量、温度、磨损、尺寸和人的操作被一起检查，设计就不再只是图纸上的愿望，而要接受真实世界的压力。",
    "knowledgePointZh": "关键转向在于：想法只有经过材料、结构、流程、维护和风险的检验，才会成为可靠的实体系统。"
  },
  "080-community-garden-seedlings": {
    "storyBodyZh": "他面对的不是一株植物的漂亮问题，而是饥饿、病害、产量、土壤、灌溉、肥料和国家粮食政策。高产小麦如果太高，施肥后容易倒伏；如果抗病性不足，一场病害就能毁掉收成。他和团队反复杂交、筛选、试种，把矮秆、高产和抗病性结合起来。问题从“怎样多收一点”，变成“生命系统、土壤、水、疾病和人的选择怎样一起改变结果”。当季节、品种、工具和照料被放回同一块地，产量就不再是单个数字，而是一串长期后果。",
    "knowledgePointZh": "关键转向在于：照料生命不能只看眼前产出，还要看土壤、水、疾病、动物、人和长期风险怎样互相牵动。"
  },
  "090-medicine-schedule-care": {
    "storyBodyZh": "他看到的不只是病原体和症状。饥饿、恶劣住房、缺乏教育、贫困、政治无力和公共卫生缺位，都在让疾病扩散。单纯开药无法解决这种病，因为病人回到同样的生活条件，风险还在那里。他把报告写成一种更尖锐的医学判断：医学是一门社会科学，政治不过是大规模的医学。问题从“怎样处理一个症状”，变成“身体、照护环境、风险和尊严怎样一起决定恢复的可能”。当病床、家庭、制度和日常动作连起来，帮助就不只是把问题拿走，还要让人继续拥有自己的生活。",
    "knowledgePointZh": "关键转向在于：照护不是把人缩成症状，而是在身体风险、生活条件、制度支持和尊严之间寻找可持续的安排。"
  },
  "100-rainy-event-service-desk": {
    "storyBodyZh": "登机口的队伍没有很长，却每隔几分钟就停住。乘客问的是改签、行李和错过转机，柜台员工手里却只有固定话术和需要层层请示的权限。过去公司容易把服务理解成礼貌和微笑，可延误那一刻真正卡住人的，是信息慢、决定慢、承诺不清。管理者开始数这些短暂接触：电话多久接起，柜台能不能当场处理，消息是否诚实，前线员工有没有权力判断现场。问题从“怎样把事情办完”，变成“人在一条路径上会遇到什么阻力，系统怎样托住那一刻”。当前台、后台、空间、时间和人的身体感受连起来，服务才不只是态度，而是一条被细心安排的路。",
    "knowledgePointZh": "关键转向在于：好的服务把流程、空间、信息、权限和人的感受连成一条可走的路径。"
  },
  "001-birkbeck-evening-lecture": {
    "storyBodyZh": "他受过医学训练，也教自然哲学，但工厂现场让他产生了一种不安。那些熟练工人能修机器、判断材料、用手感受力，却常常没有一条负担得起的路，去学习描述这些经验的科学语言。于是他把课放到下工之后，用仪器、演示和朴素解释讲热、运动、化学和机械。重点不是让每个工人一夜之间变成大学学者，而是搭出第一阶台阶：让有实践经验的人，不必假装已经准备好，也能进入正式知识。那个小问题没有马上变成答案，却改变了提问方式：不是急着给结论，而是先弄清楚什么正在影响结果。当这些练习被放在同一个夜晚或同一张桌上，学习不再像一串零散任务，而像进入世界前先搭好的扶手。",
    "knowledgePointZh": "关键转向在于：人在进入具体道路前，先练习怎样读、问、表达和共同判断。"
  },
  "002-braille-raised-dots": {
    "storyBodyZh": "学校里有凸字书，但它们厚重、缓慢，也很少给盲学生真正“写回去”的机会。后来，一个士兵发明的夜间书写法传到学校：把点压进纸里，让人能在黑暗中摸读信息。这个少年试了试，却发现那套点太大，一个指尖很难一次读完，也不适合日常阅读。于是他不断缩小、测试、重新排列，直到六个凸点组成的小格子可以表达字母、标点、数字，后来还可以表达音乐。问题从“先补哪一门课”，变成“人在确定方向以前，怎样练习提问、表达、合作和判断”。当这些练习被放在同一个夜晚或同一张桌上，学习不再像一串零散任务，而像进入世界前先搭好的扶手。",
    "knowledgePointZh": "关键转向在于：人在进入具体道路前，先练习怎样读、问、表达和共同判断。"
  },
  "003-carnegie-speaking-class": {
    "storyBodyZh": "他做过销售，试过表演，也教过课，所以很懂那种从身体里冒出来的尴尬。于是他没有先讲漂亮理论，而是让他们站起来，讲一个真实小故事，倾听别人，记住名字，具体地赞美，再下周继续试。慢慢地，这门课变宽了。表达不只是声音，它还包括注意力、信心、同理心、记忆，以及让另一个人感觉自己被看见的能力。个人技能之所以可以被训练，不是因为人格可以被制造，而是因为勇气可以在一个个小小的公开行动里练习。问题从“先补哪一门课”，变成“人在确定方向以前，怎样练习提问、表达、合作和判断”。当这些练习被放在同一个夜晚或同一张桌上，学习不再像一串零散任务，而像进入世界前先搭好的扶手。",
    "knowledgePointZh": "关键转向在于：人在进入具体道路前，先练习怎样读、问、表达和共同判断。"
  },
  "009-brownsea-scout-camp": {
    "storyBodyZh": "组织者曾是军人，但这次营地并不只是军事训练。他曾见过少年担任信使、助手和观察者，也开始想：普通年轻人能不能通过实践，而不是只听讲，学会勇气、服务、户外判断、团队合作和公民责任？营地每天混合着很难被整齐课表分开的内容：绳结、追踪、急救、野外技能、讲故事、纪律、游戏，以及对小队的照看。问题从“先补哪一门课”，变成“人在确定方向以前，怎样练习提问、表达、合作和判断”。当这些练习被放在同一个夜晚或同一张桌上，学习不再像一串零散任务，而像进入世界前先搭好的扶手。",
    "knowledgePointZh": "关键转向在于：人在进入具体道路前，先练习怎样读、问、表达和共同判断。"
  },
  "018-reggio-emilia-school": {
    "storyBodyZh": "那位年轻教育者在 Reggio Emilia 一带长大，战争期间仍在学习教育学。1945 年，他听说一个受战争破坏的村庄里，家长们正在为孩子建学校，就去看了看。那不是一个整齐的官方项目，更像是一群普通人用砖块和手艺告诉孩子：未来还没有被夺走。他看到的不是已经成型的方法，而是一个社区试着围绕孩子重新组织生活。后来慢慢长出来的学校，没有把学习切成整齐的小盒子。孩子们画画、搭建、争论、倾听、塑形、测量、表演，也一次次回到自己的想法。老师记录过程，家长参与讨论，教室环境本身也成了教学的一部分。问题从“把哪些内容教完”，变成“学习者在怎样的情境里开始自己连接经验和知识”。",
    "knowledgePointZh": "关键转向在于：教学的关键不是把答案搬给学生，而是设计一种能让经验、行动和解释相遇的情境。"
  },
  "021-bauhaus-workshop": {
    "storyBodyZh": "他不希望学生把美只当作博物馆装饰，也不希望制作被看成较低级的劳动。在这所新学校里，学生先学习材料、色彩、形式、工具和工坊，再进入具体方向。一把椅子、一张海报、一盏灯、一栋建筑、一件舞台服装、一个字形，都在问同一个问题：形式怎样服务生活，同时不失去想象力？问题从“它属于哪一种作品”，变成“哪些姿势、材料和记忆让它在不同时代继续发声”。当图像、文本或物件被反复放到一起，意义不再只贴在标签上，而是在观看和解释的往返里慢慢露出来。",
    "knowledgePointZh": "关键转向在于：作品、文本和物件不是孤立陈列，它们会带着记忆、权力、材料和观看方式一起生产意义。"
  },
  "022-petrarch-mountain-letter": {
    "storyBodyZh": "他多年热爱旧书，抄写书信，寻找古代作者，也越来越觉得：过去并没有死，只要仍有人带着自己的生命去回应它。登山时，外面的风景变成了内心的震动。他翻开随身带着的 Augustine 小书，读到的话仿佛在提醒他：人为何追逐世界，却忘了自己的灵魂。那封信的每个细节是否都完全符合现代历史标准，并不影响它呈现出的注意力：风景、古典记忆、基督教式自省、友谊、野心，以及一个人被拉在不同时代之间的感觉。人文就从这种张力里开始：古老文本、信念、历史和内心问题，怎样仍在塑造活着的人。那个小问题没有马上变成答案，却改变了提问方式：不是急着给结论，而是先弄清楚什么正在影响结果。当图像、文本或物件被反复放到一起，意义不再只贴在标签上，而是在观看和解释的往返里慢慢露出来。",
    "knowledgePointZh": "关键转向在于：作品、文本和物件不是孤立陈列，它们会带着记忆、权力、材料和观看方式一起生产意义。"
  },
  "023-rosetta-cartouche": {
    "storyBodyZh": "那块让欧洲学者着迷的石碑，用几种文字写着同一份诏令，可象形文字仍然拒绝被读懂。他没有把那些符号只当作装饰，而是反复比较王名，尤其是椭圆框里的名字，把它们同希腊字母、以及他熟悉的科普特语联系起来。一个在某处看似图画的符号，在另一处开始表现得像声音。一旦这一点被确认，纪念碑、墓葬、名字、祷文和官方记录，开始重新进入历史。问题从“它属于哪一种作品”，变成“哪些姿势、材料和记忆让它在不同时代继续发声”。当图像、文本或物件被反复放到一起，意义不再只贴在标签上，而是在观看和解释的往返里慢慢露出来。",
    "knowledgePointZh": "关键转向在于：作品、文本和物件不是孤立陈列，它们会带着记忆、权力、材料和观看方式一起生产意义。"
  },
  "028-black-mountain-studio": {
    "storyBodyZh": "他们加入的那所学院很小，小到学生会参与学校决策，和老师一起生活，处理材料，读哲学，建造东西，表演，争论，做饭，也常常在没有传统地图的情况下失败。围绕这些练习，舞者、诗人、作曲家、画家、织物艺术家、建筑师和思想者彼此靠近。问题从“它属于哪一种作品”，变成“哪些姿势、材料和记忆让它在不同时代继续发声”。当图像、文本或物件被反复放到一起，意义不再只贴在标签上，而是在观看和解释的往返里慢慢露出来。",
    "knowledgePointZh": "关键转向在于：作品、文本和物件不是孤立陈列，它们会带着记忆、权力、材料和观看方式一起生产意义。"
  },
  "029-lomax-field-recorder": {
    "storyBodyZh": "他坐进监狱、门廊、教堂、厨房、田野和小房间，录下那些很少进入官方文化的歌声。乍看之下，他是在采集音乐；但录音里也有口音、劳动节奏、玩笑、地方历史、种族暴力、迁徙、记忆，以及那些常被当成文化素材而不是文化作者的人所保有的尊严。这项工作很难放进一个格子。它既是音乐学，也是民俗学、档案建设、口述史、纪录实践，更是一种政治主张：每个共同体都应该有机会听见自己被保存。问题从“它属于哪一种作品”，变成“哪些姿势、材料和记忆让它在不同时代继续发声”。当图像、文本或物件被反复放到一起，意义不再只贴在标签上，而是在观看和解释的往返里慢慢露出来。",
    "knowledgePointZh": "关键转向在于：作品、文本和物件不是孤立陈列，它们会带着记忆、权力、材料和观看方式一起生产意义。"
  },
  "031-bus-stop-price": {
    "storyBodyZh": "他的人生并不安稳，家族经历瘟疫，仕途几次卷入政治风浪。他开始怀疑，历史书里只记谁胜谁败是不够的。为什么一些群体能团结起来，为什么进入富裕城市后又慢慢松散，为什么税收、奢侈、教育、地理和共同体精神会一起改变政权命运？他把亲身见过的部落联盟、城市官僚和王朝循环放在一起分析，试着找出社会行为背后的力量。问题从“谁说对了”，变成“信息、位置、利益和证据怎样把一群人的判断推向不同方向”。当名单、地图、访谈或记录被摊开，个人抱怨开始显出背后的路径：谁被听见，谁被漏掉，什么证据还能继续追。",
    "knowledgePointZh": "关键转向在于：公共事实要靠记录、核对、解释和传播被做出来，也要不断追问谁在资料里出现，谁被排除。"
  },
  "032-rumor-before-the-storm": {
    "storyBodyZh": "他关心的不是某一条新闻，而是人类怎样保存和共享所有已经写下来的东西。书、论文、报告、图片、剪报、统计表，如果不能被分类、编号、引用和检索，就像散在地上的碎片。他和同伴设计通用十进分类法，建立庞大的卡片目录，试图让任何地方的人都能提出问题并获得相关资料。问题从“谁说对了”，变成“信息、位置、利益和证据怎样把一群人的判断推向不同方向”。当名单、地图、访谈或记录被摊开，个人抱怨开始显出背后的路径：谁被听见，谁被漏掉，什么证据还能继续追。",
    "knowledgePointZh": "关键转向在于：公共事实要靠记录、核对、解释和传播被做出来，也要不断追问谁在资料里出现，谁被排除。"
  },
  "038-community-data-project": {
    "storyBodyZh": "当时许多人仍相信坏空气是主要原因。他却把注意力放到人喝了什么水、住在哪里、谁离开、谁留下，以及哪些看似例外其实有共同解释。他不是一个人完成全部调查；当地牧师和居民提供了关键访问线索。病例被标到地图上后，Broad Street 水泵周围的黑点越来越密。这个判断既是医学问题，也是社会信息问题：数据要来自街道，访谈要校正地图，地图又要说服公共机构采取行动。那个小问题没有马上变成答案，却改变了提问方式：不是急着给结论，而是先弄清楚什么正在影响结果。当名单、地图、访谈或记录被摊开，个人抱怨开始显出背后的路径：谁被听见，谁被漏掉，什么证据还能继续追。",
    "knowledgePointZh": "关键转向在于：公共事实要靠记录、核对、解释和传播被做出来，也要不断追问谁在资料里出现，谁被排除。"
  },
  "039-unusual-community-signal": {
    "storyBodyZh": "流行说法常把公共资源讲成两种结局：要么被市场私有化，要么由国家统一管理，否则人人都会多拿一点直到系统崩溃。她不满足于这个太整齐的故事。她和同伴比较世界各地的灌溉社群、渔业、牧场和森林，发现有些社区会自己制定边界、监测、惩罚、冲突解决和分层规则。它们不是完美乌托邦，也会失败，但它们证明社会现实比二分法复杂。当名单、地图、访谈或记录被摊开，个人抱怨开始显出背后的路径：谁被听见，谁被漏掉，什么证据还能继续追。",
    "knowledgePointZh": "关键转向在于：公共事实要靠记录、核对、解释和传播被做出来，也要不断追问谁在资料里出现，谁被排除。"
  },
  "041-cafe-closing-sheet": {
    "storyBodyZh": "他不是工程师出身，也不是只看财务报表的人。他关心一个更朴素的问题：当公司越来越大，谁在决定目标？经理人的责任是什么？员工是不是只是一颗螺丝？顾客、社会和长期生存又放在哪里？他观察通用汽车这样的组织，发现管理不是命令链条那么简单，而是让知识、权责、绩效、创新和人的尊严保持可工作的关系。它既要看数字，也要看人；既要看效率，也要看责任。问题从“哪个选择更划算”，变成“成本、责任、风险和规则怎样被摆到同一张桌面上”。等账本、合同、承诺和后果一起出现，选择就不再只是个人聪明，而成了共同承担之前必须说清的安排。",
    "knowledgePointZh": "关键转向在于：组织和交易不是只靠意愿运行，资源、责任、风险和规则必须被摆出来比较。"
  },
  "042-bicycle-deposit": {
    "storyBodyZh": "当时普通法常被认为只能在律师事务所和法院里慢慢熬出来，外人很难进入。判例、惯例、术语和程序像一片森林，既保护权利，也让许多人迷路。后来他的书影响巨大，也带着时代局限，尤其在殖民和社会等级问题上需要被批判阅读。问题从“哪个选择更划算”，变成“成本、责任、风险和规则怎样被摆到同一张桌面上”。等账本、合同、承诺和后果一起出现，选择就不再只是个人聪明，而成了共同承担之前必须说清的安排。",
    "knowledgePointZh": "关键转向在于：组织和交易不是只靠意愿运行，资源、责任、风险和规则必须被摆出来比较。"
  },
  "048-pop-up-market-rules": {
    "storyBodyZh": "他并不把法律只看成诉讼技巧。对他来说，法律、商业和行政必须一起回答一个问题：普通人在复杂市场里怎样不被制度性弱势吞掉？他研究保险成本、公司利润、储蓄银行制度和公共监管，提出通过 savings bank life insurance 让普通家庭获得更便宜、更透明的人寿保险。问题从“哪个选择更划算”，变成“成本、责任、风险和规则怎样被摆到同一张桌面上”。等账本、合同、承诺和后果一起出现，选择就不再只是个人聪明，而成了共同承担之前必须说清的安排。",
    "knowledgePointZh": "关键转向在于：组织和交易不是只靠意愿运行，资源、责任、风险和规则必须被摆出来比较。"
  },
  "049-strange-side-business": {
    "storyBodyZh": "她没有按当时化妆品行业的常规走。包装可以简单，动物测试可以被质疑，原料故事可以告诉顾客，商业也可以公开站在环保和人权议题旁边。她的做法后来同样需要复杂评价：品牌扩张、供应链、并购和市场叙事都会让理想变得不纯粹。问题从“哪个选择更划算”，变成“成本、责任、风险和规则怎样被摆到同一张桌面上”。等账本、合同、承诺和后果一起出现，选择就不再只是个人聪明，而成了共同承担之前必须说清的安排。",
    "knowledgePointZh": "关键转向在于：组织和交易不是只靠意愿运行，资源、责任、风险和规则必须被摆出来比较。"
  },
  "051-yogurt-on-the-counter": {
    "storyBodyZh": "他出发时还不是一个准备推翻传统观念的人，更像一个爱观察的年轻人：写笔记、收集昆虫、寄回标本、和船员一起经历风浪。真正改变他的不是某一个瞬间，而是大量小差异慢慢堆在一起：相近的岛屿有不同的鸟嘴，化石和现生动物彼此呼应，人工育种显示性状可以被选择。多年后，他才把这些线索组织成一个更大的解释：生命不是固定陈列，而是在变异、遗传、环境和选择中逐渐改变。那个小问题没有马上变成答案，却改变了提问方式：不是急着给结论，而是先弄清楚什么正在影响结果。当标本、显微镜、田野记录和长期比较连起来，生命不再只是分类表上的名称，而是会在关系里变化的过程。",
    "knowledgePointZh": "关键转向在于：生命要在尺度、遗传、环境和行为的关系里被理解，而不只是被命名。"
  },
  "052-stream-after-rain": {
    "storyBodyZh": "她原本写过海洋，也擅长把科学写给普通读者。面对杀虫剂，她没有只问它能不能杀死目标害虫，而是追问它进入土壤、水、昆虫、鸟、鱼和人体之后会怎样移动。她阅读研究、整理案例、承受化工行业攻击，也小心避免把复杂生态写成简单恐吓。一个“有效”的工具，如果看不到长期代价，就可能把春天本身变安静。问题从“哪一处出了污染或破坏”，变成“水、土、空气、物种和人的选择怎样沿着系统移动”。当长期记录、来信、样本和地方生活放在一起，一个局部现象才露出它穿过生态和制度的路径。",
    "knowledgePointZh": "关键转向在于：环境问题常常沿着水、土、空气、食物链和制度一起移动，不能只在一个点上处理。"
  },
  "053-kitchen-ice-and-steam": {
    "storyBodyZh": "他并不满足于背诵古代权威关于重物下落的说法。真实下落太快，不容易测；于是他把斜面变成放慢运动的工具，让时间、距离和速度之间的关系可以被观察。小球每次滚动都像在提醒他：自然不是只能被辩论，也可以被设计实验来询问。学生在实验室里重复这种动作时，学到的不只是公式，而是怎样让自然用可检查的方式回答问题。那颗小球滚下去的时间很短，却把科学学习拉长了：人开始愿意为了看清关系而重新设计问题。当天平、尺子、光线、时间或样品被反复调整，直觉退到一边，关系才开始变得可验证。",
    "knowledgePointZh": "关键转向在于：物质、运动和地球变化需要实验、测量和模型一起逼近，而不是只靠直觉争论。"
  },
  "054-shared-bill-pattern": {
    "storyBodyZh": "他面对的不是纯粹游戏，而是继承、贸易、测量、税收和土地分配中的真实计算。旧方法可以算，但不够统一，也不容易传播。他把印度数字和十进位计算介绍给阿拉伯语读者，又系统讨论线性和二次方程的解法。后来无数课堂、账本和程序都沿着这条路继续走：先把关系写清楚，更多人才能一起检查、改进和使用它。问题从“算出的答案是多少”，变成“结构、变化、不确定性和推理路径怎样让答案站得住”。当符号、数据、尺子或平均数被重新安排，数字不再只是结果，而变成检查关系的工具。",
    "knowledgePointZh": "关键转向在于：数量和数据最有用的地方，是让关系、偏差、不确定性和推理路径被看见。"
  },
  "058-school-air-quality": {
    "storyBodyZh": "她的工作头衔并不显赫，很多女性计算员被安排做重复而精细的记录。可她在麦哲伦云的变星中发现一种关系：某些造父变星变化周期越长，真实亮度越高。这个关系像一把宇宙尺子，只要知道周期，就能推算亮度，再进一步估计距离。她的发现后来帮助人类测量银河系之外的距离。这也是数据和自然科学相遇时最动人的地方：微小记录不会自动说话，但耐心比较能让它们变成尺度。她面对的是一张张安静底片，但真正困难的是在重复记录中相信微小差别值得被认真比较。当一张张底片、表格或曲线被耐心比较，微小差别才可能变成解释远方世界的尺度。",
    "knowledgePointZh": "关键转向在于：观察、模型和数据推断需要彼此校正，单独一个记录还不能自动成为尺度。"
  },
  "059-mystery-stain": {
    "storyBodyZh": "传统几何喜欢光滑线条，可真实世界的云、山、树、河流和海岸都不那么听话。用大尺子量，很多弯曲被忽略；用小尺子量，细节不断冒出来，长度似乎没有稳定终点。他把这种粗糙、重复、自相似的形状发展成新的数学语言。这个方向既不像普通几何，也不只是物理或统计，却能帮助人描述自然界大量不规则形态。问题从“它属于哪一个现成分支”，变成“现象本身需要什么新工具来描述”。当边界现象反复打断旧分类，新的图形、尺度或模型就从不方便的细节里长出来。",
    "knowledgePointZh": "关键转向在于：有些现象先打破分类，后来才逼出新的模型、尺度和语言。"
  },
  "068-repairing-the-club-website": {
    "storyBodyZh": "他看到的不是单一工程问题。雷达给出信息，炮塔需要动作，目标在移动，系统根据误差反馈调整；类似过程也出现在神经系统、动物运动、通信网络和自动控制里。于是他把“控制与通信”作为共同问题来思考，提出 feedback、信息和系统调节的语言。那个小问题没有马上变成答案，却改变了提问方式：不是急着给结论，而是先弄清楚什么正在影响结果。一旦系统能听见误差，机器就不再只是执行命令；它开始在偏差里学习怎样回到可控状态。当反馈回路被画出来，机器、通信和人的使用场景开始在同一种问题里相遇。",
    "knowledgePointZh": "关键转向在于：控制、通信和计算连接在一起时，关键不只是执行命令，而是根据反馈修正行动。"
  },
  "071-flickering-hall-light": {
    "storyBodyZh": "他面对的不是普通计算题。建筑形态大胆，预算和政治压力不断增加，原本的曲面难以制造和支撑。工程团队必须把美学愿望、几何规则、预制构件、受力路径和施工方法重新组合，直到壳体可以被分解、制造和安装。这个过程并不完美，也伴随争议，但它说明工程行业的核心不只是按图施工。真正的工程要在愿望与现实之间翻译：哪些形状能被建造，哪些材料能承受，哪些步骤能让危险变小。问题从“能不能做出来”，变成“材料、结构、流程和安全边界怎样让它经得住反复使用”。等重量、温度、磨损、尺寸和人的操作被一起检查，设计就不再只是图纸上的愿望，而要接受真实世界的压力。",
    "knowledgePointZh": "关键转向在于：想法只有经过材料、结构、流程、维护和风险的检验，才会成为可靠的实体系统。"
  },
  "072-soup-that-travels": {
    "storyBodyZh": "他想解决的不是单台汽车能不能造出来，而是怎样让更多人买得起、怎样让每一步工作稳定重复。装配线把任务拆小，把零件标准化，把节拍固定，也把工人的动作纳入严格流程。这个方法提高产量、降低成本，同时也带来劳动单调、控制和工人压力等问题。问题从“能不能做出来”，变成“材料、结构、流程和安全边界怎样让它经得住反复使用”。等重量、温度、磨损、尺寸和人的操作被一起检查，设计就不再只是图纸上的愿望，而要接受真实世界的压力。",
    "knowledgePointZh": "关键转向在于：想法只有经过材料、结构、流程、维护和风险的检验，才会成为可靠的实体系统。"
  },
  "073-crosswalk-at-school": {
    "storyBodyZh": "他不把建筑只看成墙和屋顶，也不把美当成表面装饰。一个建筑物必须坚固，能服务人的使用，也要有比例和秩序带来的美感。材料、地基、方向、公共用途、机械和人体尺度，都被放进同一套思考。学生读建筑时真正要练习的，正是这种同时看见结构、使用者和城市生活的能力。问题从“能不能做出来”，变成“材料、结构、流程和安全边界怎样让它经得住反复使用”。等重量、温度、磨损、尺寸和人的操作被一起检查，设计就不再只是图纸上的愿望，而要接受真实世界的压力。",
    "knowledgePointZh": "关键转向在于：想法只有经过材料、结构、流程、维护和风险的检验，才会成为可靠的实体系统。"
  },
  "078-community-kitchen-build": {
    "storyBodyZh": "他不是只想做奇特造型，而是着迷于效率：张力怎样分布，三角形为什么稳定，球面结构如何把重量分散，临时住房和大型空间能不能更轻、更快、更省。geodesic dome 把数学几何、结构工程、制造节点、建筑空间和资源伦理放在一起。圆顶的问题看似像几何游戏，真正牵动的却是住房、材料浪费和人类怎样更轻地占用世界。问题从“能不能做出来”，变成“材料、结构、流程和安全边界怎样让它经得住反复使用”。等重量、温度、磨损、尺寸和人的操作被一起检查，设计就不再只是图纸上的愿望，而要接受真实世界的压力。",
    "knowledgePointZh": "关键转向在于：想法只有经过材料、结构、流程、维护和风险的检验，才会成为可靠的实体系统。"
  },
  "079-unusual-repair-material": {
    "storyBodyZh": "他面对的是一个被城市增长放大的系统性麻烦：厕所、河流、潮汐、疾病、街道、预算、政治拖延和公众恐惧全缠在一起。解决方案不是清理一条水沟，而是设计截流下水道、泵站和排放系统，把污水从城市生活核心转移出去。问题从“能不能做出来”，变成“材料、结构、流程和安全边界怎样让它经得住反复使用”。等重量、温度、磨损、尺寸和人的操作被一起检查，设计就不再只是图纸上的愿望，而要接受真实世界的压力。",
    "knowledgePointZh": "关键转向在于：想法只有经过材料、结构、流程、维护和风险的检验，才会成为可靠的实体系统。"
  },
  "081-balcony-tomato-plan": {
    "storyBodyZh": "他并不是只想做一台新机器，而是对土地上的浪费感到不安。种子如果能按固定深度、固定间距进入土壤，就更容易发芽，也便于后续除草和管理。他改进 seed drill，让播种变得更有秩序。它涉及工具、土壤、时间、劳动力和对生命条件的精确安排。那个小问题没有马上变成答案，却改变了提问方式：不是急着给结论，而是先弄清楚什么正在影响结果。当季节、品种、工具和照料被放回同一块地，产量就不再是单个数字，而是一串长期后果。",
    "knowledgePointZh": "关键转向在于：照料生命不能只看眼前产出，还要看土壤、水、疾病、动物、人和长期风险怎样互相牵动。"
  },
  "082-fallen-branch-trail": {
    "storyBodyZh": "他并不是反对使用森林，而是反对只把森林当作一次性矿藏。木材、水源、土壤、火灾、野生动物和地方经济都需要长期管理。他推动专业林务、国家森林和持续产出思想，主张为了公共利益管理自然资源。问题从“怎样多收一点”，变成“生命系统、土壤、水、疾病和人的选择怎样一起改变结果”。当季节、品种、工具和照料被放回同一块地，产量就不再是单个数字，而是一串长期后果。",
    "knowledgePointZh": "关键转向在于：照料生命不能只看眼前产出，还要看土壤、水、疾病、动物、人和长期风险怎样互相牵动。"
  },
  "083-fish-market-morning": {
    "storyBodyZh": "他意识到一个危险：每一代人都把自己年轻时见到的鱼群数量当成“正常”。如果基准不断下降，大家就会在越来越贫瘠的海里继续觉得情况还可以。这也是许多环境问题难被察觉的原因：失去不是一次发生的，而是在一代代“正常”的习惯里慢慢被接受。问题从“怎样多收一点”，变成“生命系统、土壤、水、疾病和人的选择怎样一起改变结果”。当季节、品种、工具和照料被放回同一块地，产量就不再是单个数字，而是一串长期后果。",
    "knowledgePointZh": "关键转向在于：照料生命不能只看眼前产出，还要看土壤、水、疾病、动物、人和长期风险怎样互相牵动。"
  },
  "084-dog-that-stopped-eating": {
    "storyBodyZh": "动物生病不是只影响一个主人。马牵动交通和军队，牛牵动耕作、食物和家庭收入。传统马医经验有价值，却缺少系统解剖、病理、教学和公共防疫。他推动建立专门学校，让动物医学成为可训练、可研究、可传承的专业。问题从“怎样多收一点”，变成“生命系统、土壤、水、疾病和人的选择怎样一起改变结果”。当季节、品种、工具和照料被放回同一块地，产量就不再是单个数字，而是一串长期后果。",
    "knowledgePointZh": "关键转向在于：照料生命不能只看眼前产出，还要看土壤、水、疾病、动物、人和长期风险怎样互相牵动。"
  },
  "088-farm-visit-class": {
    "storyBodyZh": "她的感知方式和许多人不同，也让她更容易注意到动物在空间里的恐惧。她没有只责怪动物不听话，而是蹲到它们的视线高度，看光线、声音、地面、防滑、转弯和人的动作。她设计弧形通道和更低压力的处理系统，把动物行为学、工程设计、畜牧生产和伦理关怀放在一起。学生从这里能学到，真正的专业不是把生命系统压服，而是愿意从另一个身体的位置重新检查设计。这条通道也把伦理带进工程：如果设计能减少恐惧，效率就不该建立在忽略恐惧之上。问题从“怎样多收一点”，变成“生命系统、土壤、水、疾病和人的选择怎样一起改变结果”。当季节、品种、工具和照料被放回同一块地，产量就不再是单个数字，而是一串长期后果。",
    "knowledgePointZh": "关键转向在于：照料生命不能只看眼前产出，还要看土壤、水、疾病、动物、人和长期风险怎样互相牵动。"
  },
  "089-unusual-animal-garden": {
    "storyBodyZh": "这个项目看起来像仓库，却不只是储藏。每一份种子都代表一种作物遗传资源，也代表某个地区的农业记忆和未来适应可能。战争、灾害、气候变化、病害和市场单一化，都可能让种子多样性消失。问题从“怎样多收一点”，变成“生命系统、土壤、水、疾病和人的选择怎样一起改变结果”。当季节、品种、工具和照料被放回同一块地，产量就不再是单个数字，而是一串长期后果。",
    "knowledgePointZh": "关键转向在于：照料生命不能只看眼前产出，还要看土壤、水、疾病、动物、人和长期风险怎样互相牵动。"
  },
  "091-cough-in-the-waiting-room": {
    "storyBodyZh": "他所处的时代，疾病常被解释成神灵惩罚或神秘力量。可他和传统中的同伴把注意力放到更具体的地方：症状何时开始，脉象和呼吸如何，饮食、季节、地点和体质有什么关系，医生应怎样谨慎判断而不伤害病人。这也是医学学习最早要守住的东西：先把人当作会变化的身体来看见，再谨慎决定知识该怎样介入。那个小问题没有马上变成答案，却改变了提问方式：不是急着给结论，而是先弄清楚什么正在影响结果。当仪器、记录、身体变化和安全边界放在一起，治疗不再只是动作本身，也包含解释和防护。",
    "knowledgePointZh": "关键转向在于：身体照护要把证据、技术、风险、解释和人的处境放在一起判断。"
  },
  "092-key-under-the-mat": {
    "storyBodyZh": "他面对的不是某个家庭的一次困难，而是社会中反复出现的风险：没有工作、生病、年老、孩子多、收入不足。过去的救济常常零散、羞辱性强，也难以覆盖人生不同阶段。问题从“怎样帮这个人一把”，变成“支持怎样既降低风险，又不拿走人的尊严和选择”。当家庭、机构、法律和日常生活被一起看见，帮助才不只是善意，而是一种需要边界的安排。",
    "knowledgePointZh": "关键转向在于：福利和照护要托住脆弱时刻，同时尽量保留人的选择、尊严和参与。"
  },
  "098-after-discharge-plan": {
    "storyBodyZh": "她发现病人的痛苦并不只在身体里。疼痛、恐惧、家庭关系、宗教疑问、经济压力和被遗弃感会叠在一起。如果医学只在治愈失败后才想起照护，就太晚了。她提出 total pain 的理解，建立 hospice 照护，把症状控制、心理支持、家属陪伴、社会工作和尊严放在同一套体系里。问题从“怎样处理一个症状”，变成“身体、照护环境、风险和尊严怎样一起决定恢复的可能”。当病床、家庭、制度和日常动作连起来，帮助就不只是把问题拿走，还要让人继续拥有自己的生活。",
    "knowledgePointZh": "关键转向在于：照护不是把人缩成症状，而是在身体风险、生活条件、制度支持和尊严之间寻找可持续的安排。"
  },
  "099-neighborhood-listening-chair": {
    "storyBodyZh": "她不是只做临时善事。战争让她看到，伤员护理、物资协调、失踪人员信息、志愿者组织和灾后救援需要长期制度，而不该每次都从混乱开始。战后，她继续推动建立更稳定的人道救援组织，使救护从战争现场延伸到灾害、公共应急和社会支持。问题从“怎样处理一个症状”，变成“身体、照护环境、风险和尊严怎样一起决定恢复的可能”。当病床、家庭、制度和日常动作连起来，帮助就不只是把问题拿走，还要让人继续拥有自己的生活。",
    "knowledgePointZh": "关键转向在于：照护不是把人缩成症状，而是在身体风险、生活条件、制度支持和尊严之间寻找可持续的安排。"
  },
  "101-haircut-before-wedding": {
    "storyBodyZh": "红门后面有香粉味、镜面和一排被擦亮的玻璃瓶。顾客来这里不只是买一瓶霜；有人想在面试前显得精神，有人想学会照顾皮肤，有人想短暂离开街上的评判。过去这种工作常被看成装饰性的买卖，可她在柜台前发现，手法、话语和接待方式会改变一个人怎样面对自己的身体。她训练员工记住顾客需求，讲清产品用法，也把美容院布置成让女性愿意停留和交谈的地方。问题从“怎样卖出护肤品”，变成“身体、身份、舒适、信任和经济机会怎样同时在场”。当服务贴近身体和日常生活，技术就不能离开沟通、尊严和对人的理解。",
    "knowledgePointZh": "关键转向在于：贴身服务从来不只是完成一个动作，它还牵动身体感受、身份、信任和机会。"
  },
  "102-clean-hands-station": {
    "storyBodyZh": "他关心空气、水、住房、排污和城市环境，也建立实验和教学体系，让卫生不只是日常清洁习惯，而成为可研究、可训练、可争论的公共专业。问题从“谁没有保持干净或小心”，变成“环境、工作流程、材料和制度怎样反复制造风险”。当排水沟、车间、出口门或防护设备被一起检查，危险就不再只是个人疏忽，而是现场在重复说话。",
    "knowledgePointZh": "关键转向在于：卫生和职业安全要看环境、流程、材料、制度和权力关系怎样一起制造或降低风险。"
  },
  "103-night-watch-call": {
    "storyBodyZh": "他要解决的不是单次抓捕，而是一个城市怎样在不变成军营的情况下维持公共秩序。新警察需要可识别的制服、巡逻、纪律、预防原则和公众信任。那个小问题没有马上变成答案，却改变了提问方式：不是急着给结论，而是先弄清楚什么正在影响结果。当制服、痕迹、情报或战略被放到同一张图上，安全就不只是力量，也包括程序和约束。",
    "knowledgePointZh": "关键转向在于：保护人需要力量，也需要证据、边界、责任和能约束权力的程序。"
  },
  "104-missed-connection": {
    "storyBodyZh": "他大胆舍弃精确距离，把线路画成水平、垂直和 45 度角，把站点间距简化，让换乘关系变得清楚。这个图一开始并不符合传统地图直觉，却更符合乘客在运输系统里的真实需要：我在哪，去哪换，下一站怎么走。一个系统如果让人看不懂，再准时也会让人迷失。问题从“路怎么走”，变成“人在匆忙、陌生和压力下怎样仍能做出清楚选择”。当线路、站点、时间和换乘被重新画出来，移动不再只是车辆运行，也包括人的判断能不能跟上。",
    "knowledgePointZh": "关键转向在于：运输不只是让人或物移动，还要让路径、时间、信息和安全在压力下仍然可读。"
  },
  "108-festival-operations-plan": {
    "storyBodyZh": "一次酒店入住、银行开户或维修预约，看起来是几句对话，背后却有表格、系统、培训、库存、授权、等待时间和失败补救。她提出 service blueprint，把顾客行为、前台接触、后台流程和有形证据画在一起。这样，服务不再只是态度好不好，而成为可以分析、设计和跨部门协调的系统。如果只评价前台那一句话，很多服务失败就会被误判；真正要看的，是前台背后有没有足够清楚的流程在托住它。当蓝图把看得见和看不见的动作画到一起，服务失败才不容易被误判成某个人的态度问题。",
    "knowledgePointZh": "关键转向在于：跨部门服务要把前台体验、后台流程、技术、人员和质量证据放在同一张蓝图里。"
  },
  "109-service-that-had-no-name": {
    "storyBodyZh": "他发现，许多人并不是一开始就能走进医院、警局、福利机构或教堂。他们可能只需要一个不审判、不急着训诫、愿意在深夜听完的人。于是志愿者被训练去接电话，重点不是立刻给答案，而是让来电者在最危险、最孤单的时刻不再独自承受。问题从“它到底算哪一种服务”，变成“人在正式系统之间掉下去时，谁先接住这一刻”。当一条热线、一个志愿者或一次即时帮助出现，分类空白处也能长出真正的支持。",
    "knowledgePointZh": "关键转向在于：有些支持很难归类，但它们守住的是人在正式系统之间最容易掉落的时刻。"
  },
  "0111-education-science": {
  ...
  "0112-training-for-pre-school-teachers": {
    "storyBodyZh": "很多大人看见孩子玩，只会觉得那是消遣。他看见一个孩子握住木球，又把它滚出去；另一个孩子把方块叠起来，再推倒重来；还有孩子把线穿过纸面，像是在用手指慢慢理解形状、方向和秩序。他停下来，看得比别人久了一点。他年轻时并不是一路从学校走向学校的人。也许正因为这样，他看幼儿时，不只看见“不懂事的小孩”，还看见身体、材料、空间和节奏正在一起工作。问题开始变得不一样了：孩子真的只是在玩吗？还是正在用手、眼睛、声音和身体，练习理解世界？后来，他开始设计一套材料和活动，让孩子可以通过游戏感知形状、数量、关系和自然，也让照看孩子的成人学会怎样陪伴，而不是急着打断。很多年后，人们回头谈幼儿园的起点，常会提到这个名字：Friedrich Froebel。成人的专业，不只是看住孩子，而是看懂孩子正在怎样学习，并为这种学习准备安全、丰富、合适的环境。问题从“把哪些内容教完”，变成“学习者在怎样的情境里开始自己连接经验和知识”。",
    "knowledgePointZh": "关键转向在于：教学的关键不是把答案搬给学生，而是设计一种能让经验、行动和解释相遇的情境。"
  },
  "0113-teacher-training-without-subject-specialisation": {
    "storyBodyZh": "这所学校的第一位负责人，原本长期在学校和教会之间工作。他在岛上办过学校，也做过牧师，见过太多真实课堂里的小麻烦：孩子会走神，会害怕，会同时处在不同进度，课堂也会因为一个问题没有说清楚而乱掉。那时很多人以为，只要一个人会读、会算、有品行，就自然能当老师。可他越来越明白，教师不是临时站上讲台的人，而是要学习怎样提问、怎样安排一节课、怎样观察学生是否真的明白、怎样让纪律不是恐惧，而是学习可以继续发生的秩序。最初只有少数学生，反而让这个实验更像是一次安静的试问：老师是不是也需要被系统训练？那个小问题没有马上变成答案，却改变了提问方式：不是急着给结论，而是先弄清楚什么正在影响结果。",
    "knowledgePointZh": "关键转向在于：教学的关键不是把答案搬给学生，而是设计一种能让经验、行动和解释相遇的情境。"
  },
  "0114-teacher-training-with-subject-specialisation": {
    "storyBodyZh": "这位数学家年轻时已经在几何研究里很出名，后来在 Göttingen 组织讲座、研讨班和研究机构。他越接近大学数学的深处，越觉得中学数学不该只是被切碎的公式。一个函数、一条曲线、一个证明，在专家眼里已经很自然，在学生眼里却可能像一堵墙。老师如果只会做更难的题，并不一定会教会学生；但如果老师能看见学校数学背后的结构、联系和来处，就能把抽象知识翻译成学生一步步能进入的路径。问题从“把哪些内容教完”，变成“学习者在怎样的情境里开始自己连接经验和知识”。桌上的工具、对话和反复尝试一旦连起来，课堂就不只是传递答案，而是在安排一种能发生理解的场面。",
    "knowledgePointZh": "关键转向在于：教学的关键不是把答案搬给学生，而是设计一种能让经验、行动和解释相遇的情境。"
  },
  "0119-education-not-elsewhere-classified": {
    "storyBodyZh": "传统识字课常从课本句子开始，像是把世界先关在门外。他反过来做：先听人们平时说什么，工作里用什么词，害怕什么，想改变什么，再把这些词变成识字和讨论的入口。学习字母的同时，人也开始讨论土地、劳动、权利和沉默。识字不再只是技术，它变成一种重新说出自己生活的能力。桌上的工具、对话和反复尝试一旦连起来，课堂就不只是传递答案，而是在安排一种能发生理解的场面。",
    "knowledgePointZh": "关键转向在于：教学的关键不是把答案搬给学生，而是设计一种能让经验、行动和解释相遇的情境。"
  },
  "0211-audio-visual-techniques-and-media-production": {
    "storyBodyZh": "那对兄弟从小生活在摄影工业里，家里做感光材料和照相器材。他们并不是一开始就想拍大片，也没有明星、剧情和宏大布景。真正让人震动的是一个很小的技术问题：怎样让连续照片被拍下、显影、放映，并让一群陌生人同时看见“时间在动”。他们把机器、胶片、放映和公开观看连在一起，让工厂门口、火车进站、婴儿吃饭这些普通场面突然有了新的力量。观众不是只看图像，而是在黑暗房间里共同经历运动、时间和注意力。视听技术从这里变得清楚：技术不是冷冰冰的设备，它会改变人如何记住一件事、相信一件事、一起观看一件事。问题从“它属于哪一种作品”，变成“哪些姿势、材料和记忆让它在不同时代继续发声”。当图像、文本或物件被反复放到一起，意义不再只贴在标签上，而是在观看和解释的往返里慢慢露出来。",
    "knowledgePointZh": "关键转向在于：作品、文本和物件不是孤立陈列，它们会带着记忆、权力、材料和观看方式一起生产意义。"
  },
  "0212-fashion-interior-and-industrial-design": {
    "storyBodyZh": "他不是单纯反对机器，而是反对人和物之间的关系被粗糙地切断。漂亮不该只属于画廊，桌布、墙纸、椅子、书页、窗帘和房间的比例，也会影响一个人怎样生活。于是他开始研究染料、织物、木工、印刷和图案，让植物的枝叶重新爬上墙面，让手工的节奏回到家庭内部。他的理想有矛盾：手工产品常常昂贵，未必真的能让普通人都买得起。但他提出的问题仍然尖锐：如果生活中的物件都没有尊严，人怎么在日常里学习美感和自由？设计从这里不再只是“好看”，而是追问材料、劳动、使用者和社会理想之间的关系。当图像、文本或物件被反复放到一起，意义不再只贴在标签上，而是在观看和解释的往返里慢慢露出来。",
    "knowledgePointZh": "关键转向在于：作品、文本和物件不是孤立陈列，它们会带着记忆、权力、材料和观看方式一起生产意义。"
  },
  "0213-fine-arts": {
    "storyBodyZh": "他在巴黎受过冷落，也被展览体系拒绝过很久。别人画苹果，可能追求像；他画苹果，却像是在追问视觉本身为什么不稳定。桌面微微倾斜，盘子好像要滑落，色块彼此推挤，山体在光里变成结构。很多人起初看不懂，觉得这些画笨拙、不完整、不够讨好。可是他慢慢让后来者看见：绘画不必只是复制眼前物，也可以把观看拆开，重新组织成形、色、重量和时间。我用什么方式把它放到画面上？当图像、文本或物件被反复放到一起，意义不再只贴在标签上，而是在观看和解释的往返里慢慢露出来。",
    "knowledgePointZh": "关键转向在于：作品、文本和物件不是孤立陈列，它们会带着记忆、权力、材料和观看方式一起生产意义。"
  },
  "0214-handicrafts": {
    "storyBodyZh": "他看到的不是昂贵古董，也不是宫廷珍品，而是普通人使用过的碗、盘、织物和木器。它们常常没有署名，价格不高，用途明确，形状朴素，却有一种无法被炫耀替代的安静力量。那个小问题没有马上变成答案，却改变了提问方式：不是急着给结论，而是先弄清楚什么正在影响结果。当图像、文本或物件被反复放到一起，意义不再只贴在标签上，而是在观看和解释的往返里慢慢露出来。",
    "knowledgePointZh": "关键转向在于：作品、文本和物件不是孤立陈列，它们会带着记忆、权力、材料和观看方式一起生产意义。"
  },
  "0215-music-and-performing-arts": {
    "storyBodyZh": "他出身并不贫寒，家里有条件让他接触剧场，也正因此，他早早看见舞台上最虚假的部分。演员站到台口，等提词人喂词，再用漂亮声音把台词甩给观众；角色之间并不真的互相听见。于是他开始记录自己的失败：什么时候情绪是装出来的，什么时候身体先于理解，什么时候一个角色有目标，表演才不再散掉。他把排练室当实验室，让演员追问“我在这个时刻想要什么”，练习注意力、行动、动机和真实交流。问题从“它属于哪一种作品”，变成“哪些姿势、材料和记忆让它在不同时代继续发声”。当图像、文本或物件被反复放到一起，意义不再只贴在标签上，而是在观看和解释的往返里慢慢露出来。",
    "knowledgePointZh": "关键转向在于：作品、文本和物件不是孤立陈列，它们会带着记忆、权力、材料和观看方式一起生产意义。"
  },
  "0219-arts-not-elsewhere-classified": {
    "storyBodyZh": "那件东西不是雕刻出来的，也没有传统意义上的美；它的冲击来自选择、挪用、命名、展示位置和制度反应。展览规则说付费即可展出，但作品没有被摆出来。问题从“它属于哪一种作品”，变成“哪些姿势、材料和记忆让它在不同时代继续发声”。当图像、文本或物件被反复放到一起，意义不再只贴在标签上，而是在观看和解释的往返里慢慢露出来。",
    "knowledgePointZh": "关键转向在于：作品、文本和物件不是孤立陈列，它们会带着记忆、权力、材料和观看方式一起生产意义。"
  },
  "0221-religion-and-theology": {
    "storyBodyZh": "他原本是修道院里极其认真的人，对罪、良心和救赎有近乎痛苦的敏感。他不是一开始就想制造席卷欧洲的风暴，而是先从牧灵问题出发：如果人们以为钱可以买到灵魂的安心，那么悔改、信心、恩典和教会权威到底被理解成了什么？于是他写下用于学术辩论的条目，寄给教会高层，也很快被印刷和传播。接下来的历史远比他最初能控制的复杂，带来了信仰更新，也带来冲突、政治利用和痛苦分裂。问题从“它属于哪一种作品”，变成“哪些姿势、材料和记忆让它在不同时代继续发声”。当图像、文本或物件被反复放到一起，意义不再只贴在标签上，而是在观看和解释的往返里慢慢露出来。",
    "knowledgePointZh": "关键转向在于：作品、文本和物件不是孤立陈列，它们会带着记忆、权力、材料和观看方式一起生产意义。"
  },
  "0222-history-and-archaeology": {
    "storyBodyZh": "他并不是从大学讲台一路走来的学者，年轻时先靠绘画能力进入埃及考古现场，临摹壁画、记录细节、学习如何在沙土中保护易碎证据。多年寻找让人疲惫，资助人也接近放弃。直到工人发现一级石阶，清理继续向下，一道封门出现。洞口打开时，里面不是一个简单答案，而是成千上万件需要编号、保护、研究和搬运的物品。那一刻常被记成一句惊叹，但真正的考古不止是看见“奇迹”，还包括在兴奋之后缓慢、克制、系统地让过去说话。问题从“它属于哪一种作品”，变成“哪些姿势、材料和记忆让它在不同时代继续发声”。当图像、文本或物件被反复放到一起，意义不再只贴在标签上，而是在观看和解释的往返里慢慢露出来。",
    "knowledgePointZh": "关键转向在于：作品、文本和物件不是孤立陈列，它们会带着记忆、权力、材料和观看方式一起生产意义。"
  },
  "0223-philosophy-and-ethics": {
    "storyBodyZh": "他没有留下自己的书，也不像收学费的教师那样提供一套现成答案。他更像一个让人不舒服的邻居：将军说勇敢，他问勇敢是什么；政治人物说正义，他问正义能不能自相矛盾；年轻人说想过好生活，他问好生活是否只是成功和名声。许多人被他问得恼火，因为问题会把漂亮话拆开，让人看见自己其实没有想清楚。我怎样对别人负责？我愿不愿意让自己的观念接受追问？问题从“它属于哪一种作品”，变成“哪些姿势、材料和记忆让它在不同时代继续发声”。当图像、文本或物件被反复放到一起，意义不再只贴在标签上，而是在观看和解释的往返里慢慢露出来。",
    "knowledgePointZh": "关键转向在于：作品、文本和物件不是孤立陈列，它们会带着记忆、权力、材料和观看方式一起生产意义。"
  },
  "0229-humanities-except-languages-not-elsewhere-classified": {
    "storyBodyZh": "她小时候听过许多故事：玩笑、传说、夸张的比喻、夜晚的闲谈、宗教和日常混在一起的声音。离开家乡后，她进入学术世界，学会访谈、记录和分析；可真正困难的是回到那些熟人之间时，既不能把他们当成标本，也不能只凭怀旧替他们说话。她坐在门廊上，跟人聊天、听笑话、记方言，也把自己的位置写进文本里。那些材料既像文学，又像民俗学、民族志、历史和语言研究，无法被单一标签收拢。那个小问题没有马上变成答案，却改变了提问方式：不是急着给结论，而是先弄清楚什么正在影响结果。当图像、文本或物件被反复放到一起，意义不再只贴在标签上，而是在观看和解释的往返里慢慢露出来。",
    "knowledgePointZh": "关键转向在于：作品、文本和物件不是孤立陈列，它们会带着记忆、权力、材料和观看方式一起生产意义。"
  },
  "0231-language-acquisition": {
    "storyBodyZh": "她没有先问孩子会不会背语法术语，而是给他们一个从未听过的词。图上只有一只小动物，她说这是一个 Wug；再出现一只，她问：现在有两个，叫两个什么？如果孩子回答出复数形式，就说明他们不是只在模仿听过的词，而是在把规则带到新情境里。问题从“它属于哪一种作品”，变成“哪些姿势、材料和记忆让它在不同时代继续发声”。当图像、文本或物件被反复放到一起，意义不再只贴在标签上，而是在观看和解释的往返里慢慢露出来。",
    "knowledgePointZh": "关键转向在于：作品、文本和物件不是孤立陈列，它们会带着记忆、权力、材料和观看方式一起生产意义。"
  },
  "0232-literature-and-linguistics": {
    "storyBodyZh": "一个词为什么有意义？这个看法听起来安静，却改变巨大：文学里的意象、日常里的称呼、诗歌里的节奏、社会里的身份，都可以被看成符号关系的一部分。问题从“它属于哪一种作品”，变成“哪些姿势、材料和记忆让它在不同时代继续发声”。当图像、文本或物件被反复放到一起，意义不再只贴在标签上，而是在观看和解释的往返里慢慢露出来。",
    "knowledgePointZh": "关键转向在于：作品、文本和物件不是孤立陈列，它们会带着记忆、权力、材料和观看方式一起生产意义。"
  },
  "0239-languages-not-elsewhere-classified": {
    "storyBodyZh": "他起初并不会读写任何现成文字，却被一个问题抓住：为什么纸上的痕迹能让远方的人听见消息，而自己的族人却必须依靠口头传递？身边人嘲笑他，甚至怀疑那是巫术；家里的生活也被他长时间的试验拖累。他先想给每个词画一个符号，后来发现太多，记不住。经过多年试验，系统终于足够简洁，普通人可以很快学会。问题从“它属于哪一种作品”，变成“哪些姿势、材料和记忆让它在不同时代继续发声”。当图像、文本或物件被反复放到一起，意义不再只贴在标签上，而是在观看和解释的往返里慢慢露出来。",
    "knowledgePointZh": "关键转向在于：作品、文本和物件不是孤立陈列，它们会带着记忆、权力、材料和观看方式一起生产意义。"
  },
  "0311-economics": {
    "storyBodyZh": "他并不是坐在账房里只想着利润的人。可他总觉得，面包为什么会到餐桌上，工资为什么会这样定，一件小商品为什么能卖到远方，这些问题并不只是商人的私事。他在书里写下一个很不起眼的例子：一枚别针。如果一个人从拉铁丝、切断、磨尖到装盒全都自己做，产量很有限；如果许多人把工作拆开，各做一小步，速度会突然变得惊人。这个例子后来常被记住，因为它让人看见，财富不是凭空出现的，也不是单靠某个聪明人创造的。它来自分工、工具、市场大小、价格信号，以及许多陌生人之间并不亲密却持续发生的合作。问题从“谁说对了”，变成“信息、位置、利益和证据怎样把一群人的判断推向不同方向”。",
    "knowledgePointZh": "关键转向在于：公共事实要靠记录、核对、解释和传播被做出来，也要不断追问谁在资料里出现，谁被排除。"
  },
  "0312-political-sciences-and-civics": {
    "storyBodyZh": "他本来是来考察监狱制度，却很快被更小的场景吸引。人们在教堂、报纸、协会和镇会里组织自己，争吵也合作；他们对政府保持警惕，却又愿意为了公共事务花时间。他看到民主不是一句口号，而是一整套习惯：结社、发言、妥协、地方自治、对多数权力的担忧，以及普通人学习公共判断的笨拙过程。问题从“谁说对了”，变成“信息、位置、利益和证据怎样把一群人的判断推向不同方向”。当名单、地图、访谈或记录被摊开，个人抱怨开始显出背后的路径：谁被听见，谁被漏掉，什么证据还能继续追。",
    "knowledgePointZh": "关键转向在于：公共事实要靠记录、核对、解释和传播被做出来，也要不断追问谁在资料里出现，谁被排除。"
  },
  "0313-psychology": {
    "storyBodyZh": "那位教师原本受过医学和生理学训练，也熟悉哲学问题。他关心意识，但不满足于只在书本里争论心灵是什么。他让学生听声音、看光点、按键、记录反应时间，并练习把自己的感觉描述得尽量准确。那个小问题没有马上变成答案，却改变了提问方式：不是急着给结论，而是先弄清楚什么正在影响结果。当名单、地图、访谈或记录被摊开，个人抱怨开始显出背后的路径：谁被听见，谁被漏掉，什么证据还能继续追。",
    "knowledgePointZh": "关键转向在于：公共事实要靠记录、核对、解释和传播被做出来，也要不断追问谁在资料里出现，谁被排除。"
  },
  "0314-sociology-and-cultural-studies": {
    "storyBodyZh": "他知道，如果只听报纸和政客的说法，这个社区会被简化成问题本身。于是他做了一件慢事：访问家庭、记录职业、收入、教育、住房、迁徙和邻里关系，把地图、统计和生活叙述放在一起。他不是把人当成数字，而是用数字抵抗懒惰的偏见；也不是把贫困归咎于某个群体，而是追问工作机会、歧视、居住条件和城市制度如何制造后果。问题从“谁说对了”，变成“信息、位置、利益和证据怎样把一群人的判断推向不同方向”。当名单、地图、访谈或记录被摊开，个人抱怨开始显出背后的路径：谁被听见，谁被漏掉，什么证据还能继续追。",
    "knowledgePointZh": "关键转向在于：公共事实要靠记录、核对、解释和传播被做出来，也要不断追问谁在资料里出现，谁被排除。"
  },
  "0319-social-and-behavioural-sciences-not-elsewhere-classified": {
    "storyBodyZh": "她受过心理学和人类学训练，却越来越不愿把人的行为拆成孤立变量。孩子吃什么，不只取决于母亲是否知道营养，也取决于收入、种族隔离、学校制度、地方食物习惯、农场生产和政府项目。她做访谈、观察餐桌、记录家庭安排，也研究政策怎样进入厨房。这个工作很难只归入心理学、社会学、教育或公共卫生，因为它关心的是行为在真实社会生态中如何发生。问题从“谁说对了”，变成“信息、位置、利益和证据怎样把一群人的判断推向不同方向”。当名单、地图、访谈或记录被摊开，个人抱怨开始显出背后的路径：谁被听见，谁被漏掉，什么证据还能继续追。",
    "knowledgePointZh": "关键转向在于：公共事实要靠记录、核对、解释和传播被做出来，也要不断追问谁在资料里出现，谁被排除。"
  },
  "0321-journalism-and-reporting": {
    "storyBodyZh": "她没有满足于当时白人报纸常用的说法，也没有把恐惧写成空泛控诉。她收集报纸剪报，核对姓名、地点和借口，比较案件，追问所谓“罪名”怎样被制造出来为暴力辩护。她写文章、发表小册子、演讲，也因此遭到威胁，被迫离开原来的城市。真正的记者工作，有时就是在多数人已经接受谎言的时候，仍然逐条核对事实。问题从“谁说对了”，变成“信息、位置、利益和证据怎样把一群人的判断推向不同方向”。当名单、地图、访谈或记录被摊开，个人抱怨开始显出背后的路径：谁被听见，谁被漏掉，什么证据还能继续追。",
    "knowledgePointZh": "关键转向在于：公共事实要靠记录、核对、解释和传播被做出来，也要不断追问谁在资料里出现，谁被排除。"
  },
  "0322-library-information-and-archival-studies": {
    "storyBodyZh": "他看到很多图书馆像安静仓库，书被保护得很好，却不一定抵达需要它的人。数学训练让他喜欢秩序，但图书馆现场让他明白，秩序必须服务读者。他提出几条朴素却深刻的原则：书是为了使用的；每个读者有他的书；每本书有它的读者；节省读者时间；图书馆是生长的有机体。这些话听起来温和，其实改变了信息工作的重心：编目、分类、借阅、开放时间和馆员服务，都不只是内部技术，而是让社会记忆和个人问题相遇的方式。问题从“谁说对了”，变成“信息、位置、利益和证据怎样把一群人的判断推向不同方向”。当名单、地图、访谈或记录被摊开，个人抱怨开始显出背后的路径：谁被听见，谁被漏掉，什么证据还能继续追。",
    "knowledgePointZh": "关键转向在于：公共事实要靠记录、核对、解释和传播被做出来，也要不断追问谁在资料里出现，谁被排除。"
  },
  "0329-journalism-and-information-not-elsewhere-classified": {
    "storyBodyZh": "她看到的问题不是传统报纸能独自解决的。事件分散，消息混乱，很多人有手机却没有安全渠道把地点、危险和求助信息送到公共视野。于是开发者、志愿者和公民一起搭起平台，把短信、网页报告和地图连起来。它不等同于新闻社，也不只是技术产品，更不是政府档案；它在危机中把零散目击转为可视化信息，同时也暴露出核实、偏差和安全的难题。问题从“谁说对了”，变成“信息、位置、利益和证据怎样把一群人的判断推向不同方向”。当名单、地图、访谈或记录被摊开，个人抱怨开始显出背后的路径：谁被听见，谁被漏掉，什么证据还能继续追。",
    "knowledgePointZh": "关键转向在于：公共事实要靠记录、核对、解释和传播被做出来，也要不断追问谁在资料里出现，谁被排除。"
  },
  "0411-accounting-and-taxation": {
    "storyBodyZh": "城市贸易越来越复杂，单靠脑子记住谁欠谁、货从哪里来、钱到哪里去，已经很危险。他把商人实际使用的复式记账方法写进书里，说明每笔交易都要从两个方向进入账本：一边记录来源，一边记录去向。这个方法不是让商业变得道德完美，却让错误、欺骗、成本和责任更容易被发现。那个小问题没有马上变成答案，却改变了提问方式：不是急着给结论，而是先弄清楚什么正在影响结果。等账本、合同、承诺和后果一起出现，选择就不再只是个人聪明，而成了共同承担之前必须说清的安排。",
    "knowledgePointZh": "关键转向在于：组织和交易不是只靠意愿运行，资源、责任、风险和规则必须被摆出来比较。"
  },
  "0412-finance-banking-and-insurance": {
    "storyBodyZh": "他关心的不是个体命运能不能被预测，而是许多人的寿命放在一起，会不会呈现可用于公共判断的规律。年金和保险长期依赖粗略估计，价格常常不公平。于是他整理 Breslau 的年龄与死亡数据，计算不同年龄的人还能活多久的概率。保险不是消灭不确定性，而是用大量记录、概率和合同把不确定性分担开来。问题从“哪个选择更划算”，变成“成本、责任、风险和规则怎样被摆到同一张桌面上”。等账本、合同、承诺和后果一起出现，选择就不再只是个人聪明，而成了共同承担之前必须说清的安排。",
    "knowledgePointZh": "关键转向在于：组织和交易不是只靠意愿运行，资源、责任、风险和规则必须被摆出来比较。"
  },
  "0413-management-and-administration": {
    "storyBodyZh": "她看到冲突常被处理成输赢：老板命令，工人服从；部门争资源，谁声音大谁赢。可她越来越相信，真正的管理不该只是压制冲突，而要把不同经验组织起来，让问题本身把人带向新的解决方案。她提出“power with”而不是“power over”，强调协调、参与、情境判断和共同责任。她的思想一度不如科学管理那样显眼，却在后来影响组织行为、领导力和协作管理。问题从“哪个选择更划算”，变成“成本、责任、风险和规则怎样被摆到同一张桌面上”。等账本、合同、承诺和后果一起出现，选择就不再只是个人聪明，而成了共同承担之前必须说清的安排。",
    "knowledgePointZh": "关键转向在于：组织和交易不是只靠意愿运行，资源、责任、风险和规则必须被摆出来比较。"
  },
  "0414-marketing-and-advertising": {
    "storyBodyZh": "他把广告当作可以测试的实验，而不是纯粹灵感。他关心标题能不能让人停下，优惠券能不能追踪回应，产品承诺是不是能进入人的日常习惯。推广牙膏时，广告不只是说产品好，而是抓住“牙齿表面那层膜”的感觉，让人每天用舌头确认自己是否需要清洁。这个方法后来也必须被批判，因为营销可以帮助人理解需求，也可以制造焦虑和欲望。问题从“哪个选择更划算”，变成“成本、责任、风险和规则怎样被摆到同一张桌面上”。等账本、合同、承诺和后果一起出现，选择就不再只是个人聪明，而成了共同承担之前必须说清的安排。",
    "knowledgePointZh": "关键转向在于：组织和交易不是只靠意愿运行，资源、责任、风险和规则必须被摆出来比较。"
  },
  "0415-secretarial-and-office-work": {
    "storyBodyZh": "他面对的不是浪漫的文学问题，而是办公室里极普通的痛点：信件太多，手写难读，副本难做，速度跟不上商业往来。早期机器笨重又不稳定，键位也不断调整。可一旦打字机进入办公室，文件格式、通信速度、记录保存、秘书职业和性别化劳动分工都被改变了。每一份议程、备忘录、合同副本和来往信件，都在帮助组织不用只靠个人记忆运转。从那以后，办公室里的速度变快了，但人们也不得不重新安排谁记录、谁校对、谁保存组织记忆。问题从“哪个选择更划算”，变成“成本、责任、风险和规则怎样被摆到同一张桌面上”。等账本、合同、承诺和后果一起出现，选择就不再只是个人聪明，而成了共同承担之前必须说清的安排。",
    "knowledgePointZh": "关键转向在于：组织和交易不是只靠意愿运行，资源、责任、风险和规则必须被摆出来比较。"
  },
  "0416-wholesale-and-retail-sales": {
    "storyBodyZh": "当时买东西常由店员在柜台后取货，顾客说，店员拿，价格和选择都被柜台隔开。他反过来设计商店动线：让顾客推开转门，沿着货架自己拿商品，看清包装和价格，最后到出口结账。顾客获得更多自由，也被新的货架设计影响选择。问题从“哪个选择更划算”，变成“成本、责任、风险和规则怎样被摆到同一张桌面上”。等账本、合同、承诺和后果一起出现，选择就不再只是个人聪明，而成了共同承担之前必须说清的安排。",
    "knowledgePointZh": "关键转向在于：组织和交易不是只靠意愿运行，资源、责任、风险和规则必须被摆出来比较。"
  },
  "0417-work-skills": {
    "storyBodyZh": "他们不是只想让人更快工作。真正的问题是，为什么同样的任务有人疲惫，有人顺手；为什么工人要做那么多多余动作；为什么家庭劳动也被当成不值得研究的自然习惯。他们拍摄砌砖动作，分析手的路径，也研究厨房高度、工具摆放和休息。它包括动作、工具、时间、沟通、身体保护和学习反馈。那个小问题没有马上变成答案，却改变了提问方式：不是急着给结论，而是先弄清楚什么正在影响结果。等账本、合同、承诺和后果一起出现，选择就不再只是个人聪明，而成了共同承担之前必须说清的安排。",
    "knowledgePointZh": "关键转向在于：组织和交易不是只靠意愿运行，资源、责任、风险和规则必须被摆出来比较。"
  },
  "0419-business-and-administration-not-elsewhere-classified": {
    "storyBodyZh": "他看到一些手工劳动者每天辛苦，却因为借原料的钱来自高利贷，永远被锁在极小利润里。传统银行嫌他们没有抵押，慈善又未必改变生产关系。于是他试着借出很小的钱，观察人们是否能通过互助小组、还款纪律和本地信任建立新的可能。它既像金融，也像发展项目、社会组织和制度实验。问题从“哪个选择更划算”，变成“成本、责任、风险和规则怎样被摆到同一张桌面上”。等账本、合同、承诺和后果一起出现，选择就不再只是个人聪明，而成了共同承担之前必须说清的安排。",
    "knowledgePointZh": "关键转向在于：组织和交易不是只靠意愿运行，资源、责任、风险和规则必须被摆出来比较。"
  },
  "0511-biology": {
    "storyBodyZh": "他没有大学教授头衔，也没有现代实验室。他靠的是手艺、耐心和好奇：把镜片磨得更亮，把样本放到光下，把牙垢、雨水、湖水和血液拿来观察。透过那些小镜片，他看到会动的微小生命，看到细胞、细菌和精子等肉眼从未进入过日常经验的世界。起初这些发现很难让人相信，因为它们太小，也太陌生。问题从“这是什么生命”，变成“变异、遗传、环境和尺度怎样一起改变生命的样子”。当标本、显微镜、田野记录和长期比较连起来，生命不再只是分类表上的名称，而是会在关系里变化的过程。",
    "knowledgePointZh": "关键转向在于：生命要在尺度、遗传、环境和行为的关系里被理解，而不只是被命名。"
  },
  "0512-biochemistry": {
    "storyBodyZh": "当时很多人认为发酵必须依赖完整活细胞。可那瓶无细胞酵母汁仍然把糖变成酒精和二氧化碳，像是在提醒人们：生命活动背后还有更小的化学执行者。他反复确认不是污染，也不是残余细胞在偷偷工作。这个发现把问题从“细胞是否活着”推向“细胞内部是什么在催化反应”。当标本、显微镜、田野记录和长期比较连起来，生命不再只是分类表上的名称，而是会在关系里变化的过程。",
    "knowledgePointZh": "关键转向在于：生命要在尺度、遗传、环境和行为的关系里被理解，而不只是被命名。"
  },
  "0519-biological-and-related-sciences-not-elsewhere-classified": {
    "storyBodyZh": "她的工作很安静，也很孤独。显微镜下的染色体、田里的玉米穗、纸上的谱系图，被她年复一年地连在一起。许多人期待基因像固定位置上的字母，她却从异常颜色和断裂模式里看到另一种可能：某些遗传因子会移动，会调控别的基因表达。这个发现一开始并没有被充分理解，因为它超出了当时主流想象。一粒玉米籽上的斑点很小，却让她意识到基因并不总像固定文字那样安静排列。问题从“这是什么生命”，变成“变异、遗传、环境和尺度怎样一起改变生命的样子”。当标本、显微镜、田野记录和长期比较连起来，生命不再只是分类表上的名称，而是会在关系里变化的过程。",
    "knowledgePointZh": "关键转向在于：生命要在尺度、遗传、环境和行为的关系里被理解，而不只是被命名。"
  },
  "0521-environmental-sciences": {
    "storyBodyZh": "他做的事看起来枯燥：校准仪器，排除局地污染，重复测量，保存长期记录。可正是这种近乎执拗的精确，让大气中二氧化碳逐年上升的趋势变得无法忽视。那条曲线还带着季节性起伏，像地球植被呼吸的节律：春夏下降，秋冬上升。问题从“哪一处出了污染或破坏”，变成“水、土、空气、物种和人的选择怎样沿着系统移动”。当长期记录、来信、样本和地方生活放在一起，一个局部现象才露出它穿过生态和制度的路径。",
    "knowledgePointZh": "关键转向在于：环境问题常常沿着水、土、空气、食物链和制度一起移动，不能只在一个点上处理。"
  },
  "0522-natural-environments-and-wildlife": {
    "storyBodyZh": "她一开始没有传统博士训练，带着笔记本、望远镜和极大的耐心进入森林。很多天里，动物只是远远躲开。后来她看到一只黑猩猩把草茎伸进白蚁丘，再把沾满白蚁的草茎送入口中。这个小动作意义巨大：工具使用不再能轻易被说成只有人类才会。更重要的是，长期观察让每只动物有了个体性格、亲属关系、冲突、照料和学习。那个小问题没有马上变成答案，却改变了提问方式：不是急着给结论，而是先弄清楚什么正在影响结果。那根草茎很轻，却让“会不会使用工具”这个问题变得沉重起来。它要求观察者把耐心放在判断之前。",
    "knowledgePointZh": "关键转向在于：环境问题常常沿着水、土、空气、食物链和制度一起移动，不能只在一个点上处理。"
  },
  "0529-environment-not-elsewhere-classified": {
    "storyBodyZh": "她没有把这些抱怨当作零散生活困难。树被砍掉，水源变差，土壤流失，妇女走更远的路找燃料，家庭和地方政治都被牵动。于是她从最朴素的动作开始：组织妇女育苗、种树、照看树，也让种树变成教育、收入、社区权利和民主参与的入口。当长期记录、来信、样本和地方生活放在一起，一个局部现象才露出它穿过生态和制度的路径。",
    "knowledgePointZh": "关键转向在于：环境问题常常沿着水、土、空气、食物链和制度一起移动，不能只在一个点上处理。"
  },
  "0531-chemistry": {
    "storyBodyZh": "当时流行的燃素说把燃烧解释成某种东西逃走。可他的天平总把问题拉回物质本身：如果燃烧后质量增加，是否说明空气中的某部分加入了反应？学生第一次认真看一个反应时，学到的不只是物质名称，而是守恒、测量和证据如何一起改变解释。称量让解释变得克制。它把“好像消失了”的感觉，变成了可以追问空气、物质和反应关系的证据。当天平、尺子、光线、时间或样品被反复调整，直觉退到一边，关系才开始变得可验证。",
    "knowledgePointZh": "关键转向在于：物质、运动和地球变化需要实验、测量和模型一起逼近，而不是只靠直觉争论。"
  },
  "0532-earth-sciences": {
    "storyBodyZh": "他不是地质学正统圈里的权威人物。除了海岸线，他还比较化石分布、岩层、古气候痕迹和冰川证据，提出大陆曾经连在一起，后来漂移分开。许多地质学家一开始反对，尤其因为他无法解释大陆移动的可靠机制。这个理论长期被冷落，直到海底扩张、古地磁和板块构造证据出现，才重新获得力量。问题从“现象看起来怎样”，变成“什么条件、数量和实验安排能让它被反复检查”。当天平、尺子、光线、时间或样品被反复调整，直觉退到一边，关系才开始变得可验证。",
    "knowledgePointZh": "关键转向在于：物质、运动和地球变化需要实验、测量和模型一起逼近，而不是只靠直觉争论。"
  },
  "0533-physics": {
    "storyBodyZh": "故事常被讲成苹果砸头的瞬间，其实更重要的是他愿意把两个世界连起来：苹果为什么落下，月亮为什么不直线飞走，而是绕着地球？如果同一种吸引力既作用在地面物体，也作用在天体上，那么自然界就不是由两套规则管理。他用数学表达运动定律和万有引力，把经验、几何和天文观测组织成新的体系。问题从“现象看起来怎样”，变成“什么条件、数量和实验安排能让它被反复检查”。当天平、尺子、光线、时间或样品被反复调整，直觉退到一边，关系才开始变得可验证。",
    "knowledgePointZh": "关键转向在于：物质、运动和地球变化需要实验、测量和模型一起逼近，而不是只靠直觉争论。"
  },
  "0539-physical-sciences-not-elsewhere-classified": {
    "storyBodyZh": "他原本想展示的是电学实验，却被一个看似偶然的小动作抓住：电流经过时，磁针不再安静指北。这个现象说明电和磁之间可能有深层联系。后来更多实验者接过问题，把电流、磁场、感应和力的关系逐渐展开。科学进展有时不是给旧抽屉再贴标签，而是承认抽屉本身需要重做。问题从“现象看起来怎样”，变成“什么条件、数量和实验安排能让它被反复检查”。当天平、尺子、光线、时间或样品被反复调整，直觉退到一边，关系才开始变得可验证。",
    "knowledgePointZh": "关键转向在于：物质、运动和地球变化需要实验、测量和模型一起逼近，而不是只靠直觉争论。"
  },
  "0541-mathematics": {
    "storyBodyZh": "他没有从最华丽的图形讲起，而是从最小的东西开始：什么是点，什么是线，什么可以被假定，什么必须证明。一个命题接一个命题，像砖块一样搭起几何体系。重要的不只是结论，而是任何人都可以沿着理由回走，检查每一步是否成立。那个小问题没有马上变成答案，却改变了提问方式：不是急着给结论，而是先弄清楚什么正在影响结果。几何从点和线开始，却把人带到一种更大的训练里：每一步都要能被别人沿着理由重新走一遍。当符号、数据、尺子或平均数被重新安排，数字不再只是结果，而变成检查关系的工具。",
    "knowledgePointZh": "关键转向在于：数量和数据最有用的地方，是让关系、偏差、不确定性和推理路径被看见。"
  },
  "0542-statistics": {
    "storyBodyZh": "天文观测总有误差。这个年轻人慢慢学会，不必把每个偏差都当成失败；很多偏差放在一起，反而会显出一种分布。后来，他把这种耐心从天空带回城市。出生、死亡、婚姻、身高、犯罪记录，这些原本散在登记册里的数字，被他一列一列整理出来。一个人的一生不能被表格解释，但很多人的记录放在一起，会露出某种社会形状。他提出“平均人”的想法，启发很大，也很危险：平均值能让混乱变得可读，却也可能压平真实差异。问题从“算出的答案是多少”，变成“结构、变化、不确定性和推理路径怎样让答案站得住”。当符号、数据、尺子或平均数被重新安排，数字不再只是结果，而变成检查关系的工具。",
    "knowledgePointZh": "关键转向在于：数量和数据最有用的地方，是让关系、偏差、不确定性和推理路径被看见。"
  },
  "0611-computer-use": {
    "storyBodyZh": "舞台上的屏幕不是只显示一串命令。文字被选中、移动，窗口彼此切换，一个小光标跟着手边的装置在屏幕上滑动。那时许多人把计算机想成大型计算机器：输入指令，等待结果，最好别打扰它。台上的工程师却让观众看见另一种动作：手可以指向想法，眼睛可以追踪结构，远处的人可以一起编辑同一份文本。他演示链接、共享屏幕和协作文件，反复把机器拉回人的工作过程。问题从“机器能不能算得更快”，变成“符号、界面和协作工具怎样让人的意图可靠地走过去”。当指令、文件、网络和权限被拆开检查，数字系统就不再像黑箱，而是一条需要维护的路径。",
    "knowledgePointZh": "关键转向在于：信息要被机器处理，必须先被表示、组织、传输、检查，并且能在失败时恢复。"
  },
  "0612-database-and-network-design-and-administration": {
    "storyBodyZh": "当时许多数据系统依赖复杂文件结构，应用程序必须知道数据怎样存放，改一点结构就可能牵动一片代码。他提出用关系模型表示数据：把数据看作表，把关系和约束说清楚，再用更高层的语言查询，而不是让每个程序都迷失在存储细节里。问题从“机器能不能算或传”，变成“符号、通道、数据结构和界面怎样让人的意图可靠地走过去”。当指令、文件、网络和权限被拆开检查，数字系统就不再像黑箱，而是一条需要维护的路径。",
    "knowledgePointZh": "关键转向在于：信息要被机器处理，必须先被表示、组织、传输、检查，并且能在失败时恢复。"
  },
  "0613-software-and-applications-development-and-analysis": {
    "storyBodyZh": "那个女孩才十七岁。她站在机器旁边，看着人们围过来，听他们谈论计算、速度和精确。那时的计算表常靠人一点点手算，出错并不稀奇。如果机器能替人算得更快，已经足够让很多人兴奋。可她停得久了一点。她想的不是这台机器能算多少，而是另一个问题：如果数字不只代表数量，也能代表音符、图案、关系和规则，那么机器处理的，真的只是数字吗？这个问题没有马上变成答案。几年后，她翻译一篇介绍 Analytical Engine 的文章。翻译本来只需要转述原文，她却把注释越写越长，试着说明机器怎样一步一步计算 Bernoulli numbers：先取什么数，再做什么运算，什么时候重复，什么时候停止。很多年后，人们回头寻找计算机程序最早的影子，常会翻到那篇译文和后面的 Notes。署名处的名字，是 Ada Lovelace。对学生来说，信息技术不是只会操作工具，而是看懂工具背后有哪些假设、路径和责任。当指令、文件、网络和权限被拆开检查，数字系统就不再像黑箱，而是一条需要维护的路径。",
    "knowledgePointZh": "关键转向在于：信息要被机器处理，必须先被表示、组织、传输、检查，并且能在失败时恢复。"
  },
  "0619-information-and-communication-technologies-icts-not-elsewhere-classified": {
    "storyBodyZh": "她喜欢把抽象问题讲得可操作，也相信计算机不该只属于少数能背机器指令的人。她推动自动编程和编译器思想，让人可以用更接近英语的方式表达商业计算任务，再由机器翻译成可执行指令。许多人起初怀疑机器怎么可能理解这种语言，但这条路改变了软件生产和普通组织使用计算机的可能。问题从“机器能不能算或传”，变成“符号、通道、数据结构和界面怎样让人的意图可靠地走过去”。当指令、文件、网络和权限被拆开检查，数字系统就不再像黑箱，而是一条需要维护的路径。",
    "knowledgePointZh": "关键转向在于：信息要被机器处理，必须先被表示、组织、传输、检查，并且能在失败时恢复。"
  },
  "0711-chemical-engineering-and-processes": {
    "storyBodyZh": "实验室里反应成功，不等于工厂就能稳定、安全、便宜地生产。温度、压力、流量、腐蚀、废气、管道和工人安全都会改变结果。他开始把不同化工行业中的共同操作抽出来讲：蒸馏、吸收、过滤、传热、物料平衡。这个思路让化学工程有了自己的对象：不是单个化学反应，而是把反应变成连续、可控、可规模化流程的全部条件。那个小问题没有马上变成答案，却改变了提问方式：不是急着给结论，而是先弄清楚什么正在影响结果。从实验室到工厂，成功不只是反应发生了，而是反应能不能被稳定、可控、可维护地重复。等重量、温度、磨损、尺寸和人的操作被一起检查，设计就不再只是图纸上的愿望，而要接受真实世界的压力。",
    "knowledgePointZh": "关键转向在于：想法只有经过材料、结构、流程、维护和风险的检验，才会成为可靠的实体系统。"
  },
  "0712-environmental-protection-technology": {
    "storyBodyZh": "他关心的不只是把水变清，而是怎样让数十万人每天喝到足够安全的水。氯能杀菌，但剂量、接触时间、味道、管网污染和公众信任都要被精确处理。人们最好永远不要想起它，因为想起它时往往已经出事。一杯清水看起来普通，背后却有剂量、管网、病菌和公众信任共同维持的脆弱平衡。问题从“能不能做出来”，变成“材料、结构、流程和安全边界怎样让它经得住反复使用”。等重量、温度、磨损、尺寸和人的操作被一起检查，设计就不再只是图纸上的愿望，而要接受真实世界的压力。",
    "knowledgePointZh": "关键转向在于：想法只有经过材料、结构、流程、维护和风险的检验，才会成为可靠的实体系统。"
  },
  "0713-electricity-and-energy": {
    "storyBodyZh": "直流系统可以点亮城市的一部分，但远距离输电困难。这个年轻人想象电流可以周期性改变方向，利用变压器升压降压，让电能走得更远。他的交流电机和多相系统并不是只解决一个机器问题，而是改变了发电、输电、工业动力和家庭用电的基础结构。问题从“能不能做出来”，变成“材料、结构、流程和安全边界怎样让它经得住反复使用”。等重量、温度、磨损、尺寸和人的操作被一起检查，设计就不再只是图纸上的愿望，而要接受真实世界的压力。",
    "knowledgePointZh": "关键转向在于：想法只有经过材料、结构、流程、维护和风险的检验，才会成为可靠的实体系统。"
  },
  "0714-electronics-and-automation": {
    "storyBodyZh": "他改进蒸汽机时面对的不只是功率问题，还有稳定性。机器如果负载变化就失控，工厂就无法可靠运转。离心调速器通过旋转球感知速度变化，速度快时收小蒸汽，速度慢时放开，让机器根据自身状态自动修正。这个装置看似机械，却包含自动化的核心思想：传感、反馈、调节和控制。问题从“能不能做出来”，变成“材料、结构、流程和安全边界怎样让它经得住反复使用”。等重量、温度、磨损、尺寸和人的操作被一起检查，设计就不再只是图纸上的愿望，而要接受真实世界的压力。",
    "knowledgePointZh": "关键转向在于：想法只有经过材料、结构、流程、维护和风险的检验，才会成为可靠的实体系统。"
  },
  "0715-mechanics-and-metal-trades": {
    "storyBodyZh": "在精密制造之前，零件常常要手工修配，坏了也难以替换。螺丝看起来小，却决定机器能不能被拆装、维修和复制。他改进螺纹车床，让螺纹加工更准确、更一致，也推动机床成为制造其他机器的“母机器”。标准化听起来冷，但它让陌生零件可以彼此配合，也让维修、制造和安全不再完全依赖个人手感。问题从“能不能做出来”，变成“材料、结构、流程和安全边界怎样让它经得住反复使用”。等重量、温度、磨损、尺寸和人的操作被一起检查，设计就不再只是图纸上的愿望，而要接受真实世界的压力。",
    "knowledgePointZh": "关键转向在于：想法只有经过材料、结构、流程、维护和风险的检验，才会成为可靠的实体系统。"
  },
  "0716-motor-vehicles-ships-and-aircraft": {
    "storyBodyZh": "他们并不是只把发动机装到翅膀上。此前他们做风洞实验，测试翼型，研究滑翔，尤其盯住一个关键问题：飞起来之后怎样控制？许多失败让他们明白，航空器不是单一部件的胜利，而是升力、推力、结构重量、操纵面和飞行员身体判断的协调。那十二秒并不长，却证明有动力、可控、持续的重于空气飞行成为可能。问题从“能不能做出来”，变成“材料、结构、流程和安全边界怎样让它经得住反复使用”。等重量、温度、磨损、尺寸和人的操作被一起检查，设计就不再只是图纸上的愿望，而要接受真实世界的压力。",
    "knowledgePointZh": "关键转向在于：想法只有经过材料、结构、流程、维护和风险的检验，才会成为可靠的实体系统。"
  },
  "0719-engineering-and-engineering-trades-not-elsewhere-classified": {
    "storyBodyZh": "问题并不适合被慢慢放进整齐研发流程。飞行员在空中需要立即可靠的动力，发动机在负 G 机动中供油异常，完整改造又来不及。她研究化油器问题，设计一个简单节流装置，让燃油流量在关键时刻不至于失控。这个小零件不是华丽发明，却让飞机在等待更彻底方案前获得实用改善。那个小问题没有马上变成答案，却改变了提问方式：不是急着给结论，而是先弄清楚什么正在影响结果。她听见的不是抱怨，而是机器在极端动作里暴露出的限制；真正的修复从愿意相信现场声音开始。等重量、温度、磨损、尺寸和人的操作被一起检查，设计就不再只是图纸上的愿望，而要接受真实世界的压力。",
    "knowledgePointZh": "关键转向在于：想法只有经过材料、结构、流程、维护和风险的检验，才会成为可靠的实体系统。"
  },
  "0721-food-processing": {
    "storyBodyZh": "他并不知道后来微生物理论会怎样解释这一切。他面对的是更实际的问题：军队和远航需要食物不那么快腐坏。经过多年试验，他发现把食物放入瓶中、加热、密封，可以显著延长保存时间。问题从“能不能做出来”，变成“材料、结构、流程和安全边界怎样让它经得住反复使用”。等重量、温度、磨损、尺寸和人的操作被一起检查，设计就不再只是图纸上的愿望，而要接受真实世界的压力。",
    "knowledgePointZh": "关键转向在于：想法只有经过材料、结构、流程、维护和风险的检验，才会成为可靠的实体系统。"
  },
  "0722-materials-glass-paper-plastic-and-wood": {
    "storyBodyZh": "他不是在整洁实验室里顺利推进，而是在失败、贫困和执念里不断尝试。天然橡胶有弹性，却太受温度影响，难以成为可靠工业材料。后来橡胶与硫在加热条件下发生变化，材料变得更稳定、更耐用、更适合制造。一个材料被真正理解，意味着人知道它在压力、温度、时间和反复使用中会怎样。问题从“能不能做出来”，变成“材料、结构、流程和安全边界怎样让它经得住反复使用”。等重量、温度、磨损、尺寸和人的操作被一起检查，设计就不再只是图纸上的愿望，而要接受真实世界的压力。",
    "knowledgePointZh": "关键转向在于：想法只有经过材料、结构、流程、维护和风险的检验，才会成为可靠的实体系统。"
  },
  "0723-textiles-clothes-footwear-and-leather": {
    "storyBodyZh": "他改进织机，让打孔卡片控制经线抬起的顺序。卡片上的孔不是花纹本身，却像一套可执行指令，告诉机器何时让哪根线通过。这个发明带来效率，也引发工人对失业的恐惧；技术进步从来不只是机器更聪明，也会改变人的工作。问题从“能不能做出来”，变成“材料、结构、流程和安全边界怎样让它经得住反复使用”。等重量、温度、磨损、尺寸和人的操作被一起检查，设计就不再只是图纸上的愿望，而要接受真实世界的压力。",
    "knowledgePointZh": "关键转向在于：想法只有经过材料、结构、流程、维护和风险的检验，才会成为可靠的实体系统。"
  },
  "0724-mining-and-extraction": {
    "storyBodyZh": "他看到的不是地下宝藏的浪漫，而是危险劳动：塌方、毒气、积水、矿石分类、冶炼烟尘和工具磨损。于是他把采矿、地质、机械、冶金和劳动现场写成系统知识，配上图像，让经验可以被传递和讨论。矿井里的每个决定都贴着身体：一根木梯、一股空气、一点水位变化，都可能决定人能不能安全回来。问题从“能不能做出来”，变成“材料、结构、流程和安全边界怎样让它经得住反复使用”。等重量、温度、磨损、尺寸和人的操作被一起检查，设计就不再只是图纸上的愿望，而要接受真实世界的压力。",
    "knowledgePointZh": "关键转向在于：想法只有经过材料、结构、流程、维护和风险的检验，才会成为可靠的实体系统。"
  },
  "0729-manufacturing-and-processing-not-elsewhere-classified": {
    "storyBodyZh": "传统直觉会觉得机器不停才有效率，库存多才安全。他反过来观察：过量生产会掩盖问题，等待会吞掉时间，搬运和返工会消耗人。生产线如果出现异常，应该让问题显露出来，而不是继续把缺陷向后推。他推动 just-in-time、看板和持续改进等实践，让制造不只是加工物品，也是在设计学习系统。让工厂停下来并不是浪费时间，有时正是为了让被库存和速度遮住的问题终于露出来。问题从“能不能做出来”，变成“材料、结构、流程和安全边界怎样让它经得住反复使用”。等重量、温度、磨损、尺寸和人的操作被一起检查，设计就不再只是图纸上的愿望，而要接受真实世界的压力。",
    "knowledgePointZh": "关键转向在于：想法只有经过材料、结构、流程、维护和风险的检验，才会成为可靠的实体系统。"
  },
  "0731-architecture-and-town-planning": {
    "storyBodyZh": "当时许多规划者迷恋大尺度清除、分区和高速道路，觉得旧街区混乱低效。她却从日常生活里看到另一套秩序：小店的眼睛、短街区的穿行、混合用途带来的活力、不同时间出现的人群，以及邻里之间不必认识也能互相照看的关系。城市不是只给汽车、模型和开发指标看的，它首先是人们不断相遇、停留、绕行、照看和争论的生活场。那个小问题没有马上变成答案，却改变了提问方式：不是急着给结论，而是先弄清楚什么正在影响结果。街角不是抽象规划单位，而是孩子、老人、店主和路人每天互相确认安全感的地方。等重量、温度、磨损、尺寸和人的操作被一起检查，设计就不再只是图纸上的愿望，而要接受真实世界的压力。",
    "knowledgePointZh": "关键转向在于：想法只有经过材料、结构、流程、维护和风险的检验，才会成为可靠的实体系统。"
  },
  "0732-building-and-civil-engineering": {
    "storyBodyZh": "她原本不是官方意义上的工程师，却在丈夫因减压病无法到现场后，承担起传递计算、材料、索缆、沉箱和施工指令的工作。她学习技术细节，和工人、政界、工程团队沟通，也在质疑声中维护项目连续性。桥真正跨越的不只是河流，还有设计和现实之间的漫长距离。问题从“能不能做出来”，变成“材料、结构、流程和安全边界怎样让它经得住反复使用”。等重量、温度、磨损、尺寸和人的操作被一起检查，设计就不再只是图纸上的愿望，而要接受真实世界的压力。",
    "knowledgePointZh": "关键转向在于：想法只有经过材料、结构、流程、维护和风险的检验，才会成为可靠的实体系统。"
  },
  "0811-crop-and-livestock-production": {
    "storyBodyZh": "他知道农民不是不努力，而是被单一作物、贫困和土壤退化困住。棉花长期消耗土地，也让农户收入脆弱。他研究豆科作物、轮作、土壤改良和可替代用途，向农民推广花生、甘薯等作物的种植和加工方法。问题从“怎样多收一点”，变成“生命系统、土壤、水、疾病和人的选择怎样一起改变结果”。当季节、品种、工具和照料被放回同一块地，产量就不再是单个数字，而是一串长期后果。",
    "knowledgePointZh": "关键转向在于：照料生命不能只看眼前产出，还要看土壤、水、疾病、动物、人和长期风险怎样互相牵动。"
  },
  "0812-horticulture": {
    "storyBodyZh": "每一株植物都有差异，哪一株更甜，哪一株更耐寒，哪一株花色更特别，哪一株适合当地市场，都需要被观察、选择和繁殖。他培育李子、马铃薯、仙人掌和许多观赏植物，也留下关于育种商业化和科学严谨性的争议。问题从“怎样多收一点”，变成“生命系统、土壤、水、疾病和人的选择怎样一起改变结果”。当季节、品种、工具和照料被放回同一块地，产量就不再是单个数字，而是一串长期后果。",
    "knowledgePointZh": "关键转向在于：照料生命不能只看眼前产出，还要看土壤、水、疾病、动物、人和长期风险怎样互相牵动。"
  },
  "0819-agriculture-not-elsewhere-classified": {
    "storyBodyZh": "他在稻田里试验不耕作、覆盖稻草、混播、减少外部投入，让田地成为一个更自我调节的生态系统。他退回田里，不是为了拒绝知识，而是为了问知识是否还能听见土地自己的节奏。问题从“怎样多收一点”，变成“生命系统、土壤、水、疾病和人的选择怎样一起改变结果”。当季节、品种、工具和照料被放回同一块地，产量就不再是单个数字，而是一串长期后果。",
    "knowledgePointZh": "关键转向在于：照料生命不能只看眼前产出，还要看土壤、水、疾病、动物、人和长期风险怎样互相牵动。"
  },
  "0911-dental-studies": {
    "storyBodyZh": "当时很多牙病由理发师、游医或拔牙匠处理，常常只在疼痛无法忍受时才动手。他把牙齿解剖、龋齿原因、牙周问题、矫治、假牙和器械整理成系统知识，强调保存牙齿、清洁和专业判断。牙痛把人带到椅子上，但真正的牙科还要处理恐惧、预防、工具和长期卫生习惯。问题从“怎样看见或治疗这个身体问题”，变成“证据、技术、风险和照护怎样一起保护人”。当仪器、记录、身体变化和安全边界放在一起，治疗不再只是动作本身，也包含解释和防护。",
    "knowledgePointZh": "关键转向在于：身体照护要把证据、技术、风险、解释和人的处境放在一起判断。"
  },
  "0912-medicine": {
    "storyBodyZh": "他没有先把死亡归咎于命运，而是比较班次、人员、流程和尸检接触。他注意到医生和学生从解剖室进入产房，可能把看不见的致命物质带到产妇身边。要求用含氯石灰洗手后，死亡率显著下降。可是这个发现并没有立刻得到欢迎，因为它暗示医生自己的手可能造成伤害。那个小问题没有马上变成答案，却改变了提问方式：不是急着给结论，而是先弄清楚什么正在影响结果。当仪器、记录、身体变化和安全边界放在一起，治疗不再只是动作本身，也包含解释和防护。",
    "knowledgePointZh": "关键转向在于：身体照护要把证据、技术、风险、解释和人的处境放在一起判断。"
  },
  "0913-nursing-and-midwifery": {
    "storyBodyZh": "刚到医院时，她看到的不是传说里的英雄场面，而是一连串很具体的麻烦：脏床单、通风差、排水糟糕、物资混乱，病人有时不是死于伤口，而是死于伤口之后的环境。她带人清洁、整理供应、改善卫生，也一遍遍记录死亡原因和病房情况。夜里，她提着灯巡视，不只是为了安慰伤兵，更是在看呼吸、疼痛、发热和恐惧有没有改变。真正重要的不是浪漫的光，而是她把照护变成一种有纪律的专业：观察、记录、卫生、训练和制度。当仪器、记录、身体变化和安全边界放在一起，治疗不再只是动作本身，也包含解释和防护。",
    "knowledgePointZh": "关键转向在于：身体照护要把证据、技术、风险、解释和人的处境放在一起判断。"
  },
  "0914-medical-diagnostic-and-treatment-technology": {
    "storyBodyZh": "暗室里，涂了荧光物质的屏幕忽然亮了一下。一个物理学家没有急着把它当作实验干扰，而是用纸板、金属片和不同距离反复遮挡阴极射线管。那时医生要看身体内部，多半依靠触诊、疼痛、外部变形，或真正切开身体。可这道看不见的射线穿过软组织时，骨头和戒指却留下清楚影子。他把妻子的手拍成照片，问题从“屏幕为什么发光”，变成“什么东西能穿过皮肉，却被骨骼挡住”。新的能力很快进入诊室，但它没有只带来惊喜：越能看见内部，越需要知道剂量、解释、防护和误判的边界。",
    "knowledgePointZh": "关键转向在于：看见身体内部并不自动带来安全；影像、解释、剂量和防护必须一起进入判断。"
  },
  "0915-therapy-and-rehabilitation": {
    "storyBodyZh": "他看到医院常把治疗重点放在疾病消失或伤口愈合，却没有充分回答之后怎么办。一个人可能需要重新训练肌肉、学习使用辅助器具、处理疼痛、调整家庭和工作环境，也要重新获得尊严。他推动 rehabilitation medicine，把物理治疗、作业治疗、心理支持、社会安排和长期目标放在同一个计划里。问题从“怎样看见或治疗这个身体问题”，变成“证据、技术、风险和照护怎样一起保护人”。当仪器、记录、身体变化和安全边界放在一起，治疗不再只是动作本身，也包含解释和防护。",
    "knowledgePointZh": "关键转向在于：身体照护要把证据、技术、风险、解释和人的处境放在一起判断。"
  },
  "0916-pharmacy": {
    "storyBodyZh": "柜台后面有粉末、酊剂、植物提取物和写得并不总清楚的处方。药物能救人，也能伤人；如果剂量、来源和调配方法只靠师徒记忆，病人很难知道自己真正拿到什么。过去药房容易被看成把药交出去的地方，他却在每一次称量和贴签时看见另一种责任：成分要稳定，说明要清楚，训练要能被检查，行业也要有共同标准。他推动教育、药典和专业组织，问题从“怎样配出这份药”，变成“怎样让药物在真实生活里被正确、安全地使用”。当记录、剂量、储存和病人的理解被放在一起，药房才不只是柜台，而是防止好药变成风险的关口。",
    "knowledgePointZh": "关键转向在于：身体照护要把证据、技术、风险、解释和人的处境放在一起判断。"
  },
  "0917-traditional-and-complementary-medicine-and-therapy": {
    "storyBodyZh": "他没有把传统当成一成不变的权威。相反，他反复校对古书，记录产地，辨别同名异物，补充民间经验，也纠正前人错误。这个过程说明传统与补充医学最严肃的部分不是神秘化，而是长期积累、辨伪、剂量、适应症和风险边界。传统如果值得被尊重，就更值得被认真核对；辨名、辨物、辨剂量，本身就是保护人的一部分。问题从“怎样看见或治疗这个身体问题”，变成“证据、技术、风险和照护怎样一起保护人”。当仪器、记录、身体变化和安全边界放在一起，治疗不再只是动作本身，也包含解释和防护。",
    "knowledgePointZh": "关键转向在于：身体照护要把证据、技术、风险、解释和人的处境放在一起判断。"
  },
  "0919-health-not-elsewhere-classified": {
    "storyBodyZh": "他一开始以为自己在研究某种特定物质的作用。可是无论注射什么，动物都出现胃溃疡、肾上腺变化、免疫组织萎缩等相似反应。他开始怀疑，身体可能是在对各种有害刺激作出一种一般性反应。这个想法后来发展为 stress 的生理研究，也经历过概念扩张和争议。那个小问题没有马上变成答案，却改变了提问方式：不是急着给结论，而是先弄清楚什么正在影响结果。实验动物的反应让问题变得不舒服：身体里的缺乏有时不是单一器官的问题，而是一整套营养关系。当仪器、记录、身体变化和安全边界放在一起，治疗不再只是动作本身，也包含解释和防护。",
    "knowledgePointZh": "关键转向在于：身体照护要把证据、技术、风险、解释和人的处境放在一起判断。"
  },
  "0921-care-of-the-elderly-and-of-disabled-adults": {
    "storyBodyZh": "别人常把他的需求理解成护理和保护，他却不断追问：为什么帮助必须以失去自主为代价？他和同伴争取校园无障碍、个人助理、住房选择和自我决定权，后来推动独立生活运动。问题从“怎样帮这个人一把”，变成“支持怎样既降低风险，又不拿走人的尊严和选择”。当家庭、机构、法律和日常生活被一起看见，帮助才不只是善意，而是一种需要边界的安排。",
    "knowledgePointZh": "关键转向在于：福利和照护要托住脆弱时刻，同时尽量保留人的选择、尊严和参与。"
  },
  "0922-child-care-and-youth-services": {
    "storyBodyZh": "他并不把孩子只看成等待成人塑造的半成品。孩子会恐惧，会犯错，会需要规则，也有被认真倾听的尊严。他在孤儿院里让孩子参与自治，处理冲突，表达意见，练习责任。后来在纳粹占领和犹太隔都的极端处境中，他仍尽力保护孩子的尊严。问题从“怎样帮这个人一把”，变成“支持怎样既降低风险，又不拿走人的尊严和选择”。当家庭、机构、法律和日常生活被一起看见，帮助才不只是善意，而是一种需要边界的安排。",
    "knowledgePointZh": "关键转向在于：福利和照护要托住脆弱时刻，同时尽量保留人的选择、尊严和参与。"
  },
  "0923-social-work-and-counselling": {
    "storyBodyZh": "求助家庭坐在桌前，问题看起来像一袋煤、一张欠租通知，或孩子没有像样的鞋。简单发放物资最快，也最容易让工作人员以为事情已经结束。她却继续问：谁失业了，谁生病了，亲属能不能帮忙，房东怎样催租，邻里有没有可用的资源。她画出家庭和社区关系，写下访问记录，把反复出现的困难放到同一张图上。问题从“给什么东西能解燃眉之急”，变成“怎样看见一个人周围的关系、制度缺口和可恢复的能力”。当家庭、机构、法律和日常生活被一起看见，帮助才不只是善意，而是一种需要边界的安排。",
    "knowledgePointZh": "关键转向在于：福利和照护要托住脆弱时刻，同时尽量保留人的选择、尊严和参与。"
  },
  "0929-welfare-not-elsewhere-classified": {
    "storyBodyZh": "他原本不是来创办组织的，却被眼前场面困住：不同国家的士兵一样流血，医疗力量远远不足，平民临时参与救助。他组织当地人照顾伤员，后来把经历写成书，提出建立中立救援组织和国际规则。战场把照护问题推到最残酷的地方：如果没人组织善意，善意就可能来得太晚。问题从“怎样帮这个人一把”，变成“支持怎样既降低风险，又不拿走人的尊严和选择”。当家庭、机构、法律和日常生活被一起看见，帮助才不只是善意，而是一种需要边界的安排。",
    "knowledgePointZh": "关键转向在于：福利和照护要托住脆弱时刻，同时尽量保留人的选择、尊严和参与。"
  },
  "1011-domestic-services": {
    "storyBodyZh": "她不把家务看成天生会做的女性本能。水质、污水、通风、食物营养、清洁剂、厨房动线和家庭预算，都需要知识和标准。她推动 domestic science 和 home economics，把家庭运行放进教育和公共卫生视野。问题从“怎样满足一个个人需求”，变成“身体、身份、舒适、信任和经济机会怎样同时在场”。当服务贴近身体和日常生活，技术就不能离开沟通、尊严和对人的理解。",
    "knowledgePointZh": "关键转向在于：贴身服务从来不只是完成一个动作，它还牵动身体感受、身份、信任和机会。"
  },
  "1012-hair-and-beauty-services": {
    "storyBodyZh": "她知道头发不只是外表，也关系到工作、自尊、种族压力和女性互助。她开发产品、培训销售代理、开办美容学校，让许多黑人女性通过美发和美容服务获得收入与社群地位。那个小问题没有马上变成答案，却改变了提问方式：不是急着给结论，而是先弄清楚什么正在影响结果。当服务贴近身体和日常生活，技术就不能离开沟通、尊严和对人的理解。",
    "knowledgePointZh": "关键转向在于：贴身服务从来不只是完成一个动作，它还牵动身体感受、身份、信任和机会。"
  },
  "1013-hotel-restaurants-and-catering": {
    "storyBodyZh": "他并不只追求菜品精致，也关心厨房怎样在高压下稳定交付。谁负责酱汁，谁负责烤肉，谁负责冷盘，菜单怎样简化，服务怎样按节奏送到餐桌，都需要组织。他把 brigade de cuisine 和现代菜单、酒店餐饮服务结合起来，让餐饮从个人手艺扩展成团队系统。问题从“怎样满足一个个人需求”，变成“身体、身份、舒适、信任和经济机会怎样同时在场”。当服务贴近身体和日常生活，技术就不能离开沟通、尊严和对人的理解。",
    "knowledgePointZh": "关键转向在于：贴身服务从来不只是完成一个动作，它还牵动身体感受、身份、信任和机会。"
  },
  "1014-sports": {
    "storyBodyZh": "他需要一种室内运动，既能消耗体力，又不至于像橄榄球那样冲撞受伤。他把桃篮钉高，用足球传递，写下十三条规则，强调传球、空间、目标和限制身体接触。一个好运动并不只是让人赢，还要让人愿意反复练习、合作、遵守边界并在限制中创造。桃篮被钉上墙的那一刻，规则也被钉进了运动里：限制冲撞，留下配合，让身体在边界内创造。问题从“怎样满足一个个人需求”，变成“身体、身份、舒适、信任和经济机会怎样同时在场”。当服务贴近身体和日常生活，技术就不能离开沟通、尊严和对人的理解。",
    "knowledgePointZh": "关键转向在于：贴身服务从来不只是完成一个动作，它还牵动身体感受、身份、信任和机会。"
  },
  "1015-travel-tourism-and-leisure": {
    "storyBodyZh": "他面对的不是远方风景，而是让一群普通人安全、便宜、有计划地抵达目的地。火车票、团体价格、行程安排、住宿、说明和陪同服务慢慢连成一个新行业。问题从“怎样满足一个个人需求”，变成“身体、身份、舒适、信任和经济机会怎样同时在场”。当服务贴近身体和日常生活，技术就不能离开沟通、尊严和对人的理解。",
    "knowledgePointZh": "关键转向在于：贴身服务从来不只是完成一个动作，它还牵动身体感受、身份、信任和机会。"
  },
  "1019-personal-services-not-elsewhere-classified": {
    "storyBodyZh": "传统服务窗口很难覆盖这种小而急的需求：不是医疗，不是旅游，不是家政，也不是普通客服。一个人只需要另一个可靠的人通过手机摄像头看一眼，告诉他颜色、文字、按钮或路线。这样的服务把志愿者、视频通话、无障碍和个人日常支持连接起来，也提醒我们服务价值不一定来自复杂流程，有时来自在正确时刻补上一点人的感知。问题从“怎样满足一个个人需求”，变成“身体、身份、舒适、信任和经济机会怎样同时在场”。当服务贴近身体和日常生活，技术就不能离开沟通、尊严和对人的理解。",
    "knowledgePointZh": "关键转向在于：贴身服务从来不只是完成一个动作，它还牵动身体感受、身份、信任和机会。"
  },
  "1021-community-sanitation": {
    "storyBodyZh": "他发现，责怪穷人不爱干净很容易，却忽略了他们生活在怎样的街道、水源和排污条件里。污水横流、垃圾堆积、饮水污染和住房拥挤，让疾病传播成为结构性后果。他的报告推动公共卫生改革，也带着当时阶级眼光和治理控制的问题，需要被批判阅读。问题从“谁没有保持干净或小心”，变成“环境、工作流程、材料和制度怎样反复制造风险”。当排水沟、车间、出口门或防护设备被一起检查，危险就不再只是个人疏忽，而是现场在重复说话。",
    "knowledgePointZh": "关键转向在于：卫生和职业安全要看环境、流程、材料、制度和权力关系怎样一起制造或降低风险。"
  },
  "1022-occupational-health-and-safety": {
    "storyBodyZh": "她没有只在诊室等待病人，而是去看病人工作的地方。毒物在哪里产生，粉尘怎样被吸入，通风是否足够，工人有没有防护，雇主是否隐瞒风险？工作场所的伤害不是“粗心”两个字能解释的，它常常来自材料、设备、节奏、权力和缺乏监管。那个小问题没有马上变成答案，却改变了提问方式：不是急着给结论，而是先弄清楚什么正在影响结果。职业安全最怕把反复出现的伤害说成个人不小心；如果危险总在同一处出现，现场本身就在说话。当排水沟、车间、出口门或防护设备被一起检查，危险就不再只是个人疏忽，而是现场在重复说话。",
    "knowledgePointZh": "关键转向在于：卫生和职业安全要看环境、流程、材料、制度和权力关系怎样一起制造或降低风险。"
  },
  "1029-hygiene-and-occupational-health-services-not-elsewhere-classified": {
    "storyBodyZh": "那场火灾暴露的不只是一个工厂的事故，而是逃生通道、工时、童工、消防检查、雇主责任和政府监管的失败。她后来参与调查和改革，推动工厂安全、最低工资、失业保险等劳动保护制度。问题从“谁没有保持干净或小心”，变成“环境、工作流程、材料和制度怎样反复制造风险”。当排水沟、车间、出口门或防护设备被一起检查，危险就不再只是个人疏忽，而是现场在重复说话。",
    "knowledgePointZh": "关键转向在于：卫生和职业安全要看环境、流程、材料、制度和权力关系怎样一起制造或降低风险。"
  },
  "1031-military-and-defence": {
    "storyBodyZh": "帐前的地图摊开，粮草、山口、水源和军心都不是装饰。许多人愿意把战争讲成勇气和胜负，可这位古代军事思想者反复写下的，是行动之前的代价：走哪条路会断补给，什么时候愤怒会替判断发号施令，怎样让敌人退让比硬碰硬更少死人。他比较地形、间谍、时间、士气和君主的情绪，问题从“怎样打赢”，变成“什么时候不该打，怎样让胜利不把自己耗空”。当力量被放回资源、信息和政治目标里，克制不再像软弱，而成了一种更难的判断。",
    "knowledgePointZh": "关键转向在于：力量不是单独存在的答案；补给、地形、情报、士气和政治目标会一起决定行动是否值得。"
  },
  "1032-protection-of-persons-and-property": {
    "storyBodyZh": "实验台上摊着泥土、玻璃碎片、纤维和指纹卡。过去保护人身与财产常被想成巡逻、锁门和抓住嫌疑人，可这个法医学者盯着更小的东西：鞋底带走的土，衣袖留下的线，破窗边缘交换的微粒。他让调查员保存现场、比较样本、记录接触顺序，也提醒证据必须经得起程序和法庭检验。问题从“谁可能做了这件事”，变成“人与物接触后留下了哪些可以核对的痕迹”。当制服、痕迹、情报或战略被放到同一张图上，安全就不只是力量，也包括程序和约束。",
    "knowledgePointZh": "关键转向在于：保护人需要力量，也需要证据、边界、责任和能约束权力的程序。"
  },
  "1039-security-services-not-elsewhere-classified": {
    "storyBodyZh": "巴黎的街巷里，骗术、假名和关系网比门牌更难读。这个人的经历并不适合歌颂：他熟悉地下世界，也带着灰色过去。正因为如此，他能从口音、手势、旧案和伪装里看出线索，开始建立档案，使用卧底和线人，把调查从单纯巡逻变成信息工作。可这种经验也危险，越有效越需要被法律、伦理和监督框住。问题从“谁更懂犯罪现场”，变成“有用的信息怎样不越过权力和隐私的边界”。当制服、痕迹、情报或战略被放到同一张图上，安全就不只是力量，也包括程序和约束。",
    "knowledgePointZh": "关键转向在于：保护人需要力量，也需要证据、边界、责任和能约束权力的程序。"
  }
};
...
const reviewedPublishedStoryOverridesZh = {
  "well-runs-low": {
    "storyBodyZh": "井水不是某个早晨突然消失的。它已经低声提醒了很久：水龙头越来越慢，老水管旁的石头总是潮湿，菜园需要的水也越来越多。只是没人把这些信号连起来，直到面包店警报响起，水压却不够接上消防软管。托马想给幼苗留水，萨娜想先保证诊所，尼科摊开那张带了好几周的维修图。阿雅让大家先停下，不再保护各自的水桶，而是说出他们共同站在哪个系统里。争论就在那一刻变了：问题不只是水，而是记忆、维护、优先级和信任。镇上的人一直把井当作背景，直到它逼大家看见整套生活怎样靠它支撑。",
    "insightZh": "一场看得见的危机，常常是一个看不见系统的最后一章。同一口井可以被看成水管问题、健康风险、农作物威胁、公共规则问题，或者共同记忆失效。真正的分歧不只是大家想要不同结果，而是每个人先看见了不同的知识入口。"
  },
  "bread-price-debate": {
    "storyBodyZh": "奥托天还没亮就改了面包价格，希望镇上的人把它理解成算术。大家却把它理解成背叛。皮姆拍下新价格，贝娅要看账本，马洛追踪面粉从磨坊到推车再到面包架的路径。数字解释了一部分涨价，但不是全部。最后奥托说出没写在牌子上的那部分：他多加了一点，因为害怕下一批货会更糟。房间里的气氛因此改变。价格不再只是木板上的数字，而是一段被压缩的故事，里面有成本、风险、议价能力，以及害怕明天来临时自己成为被责怪的那个人。",
    "insightZh": "公平不能只从表面判断。价格是一个很小的公共符号，却压缩了成本、不确定性、议价能力、声誉和恐惧。真正的问题不是奥托是不是贪心，也不是镇民是不是情绪化，而是谁能把隐藏层一层层摊开。"
  },
  "school-curriculum-debate": {
    "storyBodyZh": "莉娜带来了三份教案，以为会议会很快投票结束。任带来的却是另一种证据：学生能背定义，却在面对坏掉的公交时刻表、看不懂的药品标签、班级群里扩散的谣言时停住。有人说学校不应该变成现实生活本身。萨娜轻声回答，现实生活早就走进了教学楼。莉娜擦掉议程，在白板上写下一句话：\"一个孩子应该能看见什么？\"房间安静下来。事实仍然重要，工具仍然重要。但问题已经移到更深处。课程不只是内容清单，它训练的是注意力：学习者会看见什么，会忽略什么，又能在世界要求他们行动之前，把什么连接起来。",
    "insightZh": "学习不只是储存答案，而是在建立注意力。课程会悄悄决定什么值得被看见，什么可以被忽略，一个学习者被允许建立哪些连接。真实问题很少带着学科标签出现；它们通常以混乱情境到来。"
  },
  "broad-street-pump": {
    "storyBodyZh": "九月的伦敦街口潮湿发冷，水泵铁柄被一只只手摸得发亮。门缝里传出哭声，床单被泡进石灰水，人们把窗户推开，想让坏空气散出去。那时许多人相信霍乱从臭味里来，街沟越脏，空气越沉，病就越容易钻进身体。一个医生没有先去闻哪条巷子更臭，而是敲开一户户门，问死者住在哪里，生前喝哪口井的水。他把地址记下来，在地图上点出死亡的位置，又把看似例外的人家圈出来：有些人在臭味浓重的地方工作却没病，有些住得远的人却喝过同一口水。问题从“哪片空气最脏”，变成“哪些人把同一口水送进了身体”。当记录围向 Broad Street 水泵时，他带着图和走访结果去找地方管理者。把手后来被拆下；疫情当时已经在下降，所以它不是神奇终点，却让一座城市第一次以水源、街道、习惯和病例的关系被重新阅读。",
    "insightZh": "真正的转向不只是拆掉一只水泵把手，而是改变了什么可以成为公共证据。分散死亡被放回地图、供水和生活习惯里，公共卫生才不再只盯着气味和恐惧。"
  },
  "challenger-launch-decision": {
    "storyBodyZh": "发射前夜，会议里的声音从电话线里传来。桌上有温度预报、旧飞行记录和几张关于 O 型密封圈的图。外面还没有火焰，争论已经在系统内部点燃。工程师担心低温会让固体火箭助推器接缝里的橡胶密封圈无法及时封住缝隙。他们拿出既有经验边界：不要在低于 53 华氏度的条件下发射。起初问题像是“数据够不够”。随后讨论换了方向。管理者质疑证据，承包商管理层离线重议，原本的工程建议被推翻。举证责任悄悄换了位置：不再是系统证明发射安全，而是警告者必须证明绝对不安全。第二天早晨，挑战者号升空，并在 73 秒后解体。后来的调查指出右侧固体火箭发动机接缝密封失效，也指出更深的问题在决策过程：安全信息没有获得足够清楚、受保护的上行路径。",
    "insightZh": "挑战者号不只是机器失效，也是知识流动路径失效。一个事实如果停在错误的会议层级里，就还没有成为组织能行动的知识。高风险系统真正要问的是：警告有没有权力打断惯性。"
  },
  "cuban-missile-crisis-excomm": {
    "storyBodyZh": "照片摊在桌上时，黑白影像里的发射场还在建设。房间里的人知道，几条线、几块阴影和几辆运输车，可能把世界推到核战争边缘。肯尼迪没有立刻公开，而是召集顾问秘密讨论。旧问题像是“怎样把导弹拿掉”。但每一种答案都带着下一步危险：空袭可能漏掉导弹，入侵可能杀死苏联人员，强硬表态可能关上谈判出口。顾问们反复比较措辞、军事动作和对方可能保留的退路。问题慢慢变成“怎样施压，同时让对手还能后退”。最后选择的海上隔离，比直接攻击低一级，却把危机推到公开场域。后来的解决方案包括苏联撤出古巴导弹、美国承诺不入侵古巴，以及秘密撤出土耳其 Jupiter 导弹。危机结束后，热线和核试验限制谈判继续出现，因为双方都看见了指挥、语言和时间在核危机里有多脆弱。",
    "insightZh": "这场危机最深的成就不是胜利，而是把升级控制在还能谈判的范围内。军事能力、政治信号、历史记忆、措辞、时间和公众合法性同时行动，任何单一视角都不足以解释房间里的选择。"
  }
};
