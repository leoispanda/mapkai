...
function getPdcPhaseLabel(roundNumber, phaseType) {
  return `Round ${roundNumber}${phaseType} — ${phaseType === "A" ? "Position Update" : "Challenge, Response & Voting"}`;
}
