...
const baseLensStories = [
  ...
  {
    id: "011-after-school-reading-plan",
    categoryCode: "01",
    groupCode: "011",
    ...
    imageAlt: "A teacher and a parent volunteer adjusting an after-school reading corner for children.",
    imageAltZh: "老师和家长志愿者在课后阅读角为孩子调整学习活动。",
    title: "The reading corner plan",
    titleZh: "阅读角计划",
    summary: "A quiet reading corner became a lesson in attention, feedback, and how children actually learn.",
    summaryZh: "一个安静的阅读角，变成了关于注意力、反馈和孩子真实学习方式的小课题。",
    scene: "After school, Lina helped set up a reading corner with soft mats, picture books, and a simple plan. Ten minutes later, half the children were whispering, one child was staring out the window, and another kept choosing books that were too hard.",
    sceneZh: "放学后，Lina 帮老师布置阅读角：软垫、图画书、一张简单流程表。十分钟后，一半孩子开始小声聊天，一个孩子望着窗外，另一个孩子总拿起自己还读不懂的书。",
    storyBody: "At first Lina thought the problem was discipline. The teacher looked more carefully. The youngest children needed shorter turns. The confident readers wanted to explain pictures aloud. Two children needed someone to read the first page with them before they could continue. They changed the activity: five minutes of shared looking, one choice, one small question, and one moment to show a page to someone else. The room did not become perfectly quiet, but it became more alive. The point was not to force every child into the same behavior. It was to design a learning situation where attention could return.",
    storyBodyZh: "Lina 一开始以为问题是纪律。老师却看得更细：年纪最小的孩子需要更短的轮次，会读的孩子想把图片讲出来，还有两个孩子需要有人陪读第一页，才敢继续。她们把活动改成：五分钟一起看图、一次自主选择、一个小问题，以及一次把某一页讲给别人听的机会。房间没有变得完全安静，但变得更有生命力。重点不是把每个孩子压进同一种行为，而是设计一个让注意力能够回来的学习情境。",
    knowledgePoint: "Education is not only the delivery of content. It studies how people enter, sustain, and revise learning through structure, feedback, and human development.",
    knowledgePointZh: "教育不只是传递内容。它关心人如何进入学习、维持学习、通过结构和反馈修正学习，也关心人的发展阶段本身。",
    reflectionQuestion: "When someone seems distracted, what would change if you treated attention as something to design for instead of something to demand?",
    reflectionQuestionZh: "当一个人看起来不专心时，如果你把注意力看成需要被设计的条件，而不是直接要求的结果，会发生什么变化？",
    tags: ["teaching", "feedback", "child development"],
    tagsZh: ["教学", "反馈", "儿童发展"],
  },
  {
...
const sublensStoryDrafts = [
  ...
  {
    id: "018-school-garden-project",
    categoryCode: "01",
    groupCode: "018",
    groupTitleZh: "教育相关跨学科课程与资格",
    title: "The school garden project",
    titleZh: "校园菜园项目",
    summary: "A garden lesson needed science, planning, language, and teaching design at the same time.",
    summaryZh: "一节菜园课同时需要科学、计划、语言和教学设计。",
    scene: "A teacher wanted students to grow herbs behind the classroom. The idea sounded simple until the lesson plan filled with soil, measurement, teamwork, writing, and safety.",
    sceneZh: "老师想让学生在教室后面种香草。这个想法听起来简单，直到教案里出现土壤、测量、合作、写作和安全。",
    storyBody: "The children learned plant needs, counted watering intervals, wrote observation notes, and negotiated whose turn it was to carry tools. The teacher learned that interdisciplinary education is not a pile of subjects. It is a situation where several ways of knowing must cooperate around one living task.",
    storyBodyZh: "孩子们学习植物需求，计算浇水间隔，写观察记录，还协商谁负责拿工具。老师也发现，跨学科教育不是把学科堆在一起，而是让几种认识方式围绕一个真实任务互相配合。",
    ...
    reflectionQuestion: "What project taught you more because it refused to stay inside one subject?",
    reflectionQuestionZh: "哪一个项目正因为不肯停留在单一学科里，反而让你学得更多？",
    tags: ["interdisciplinary", "project learning", "integration"],
    tagsZh: ["跨学科", "项目学习", "整合"],
  },
  {
