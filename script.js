...
const pdcWarmupPersonas = [
  ...
  { id: "marcus-lu", englishName: "Marcus Lu", name: "陆守衡", role: "Risk & Downside", responsibility: "Stress-test downside and cost." },
  { id: "adrian-xu", englishName: "Adrian Xu", name: "许望远", role: "Opportunity & Long View", responsibility: "Check long-term opportunity." },
  { id: "felix-jiang", englishName: "Felix Jiang", name: "江试舟", role: "Creativity & Third Path", responsibility: "Look for a third path." },
  { id: "iris-song", englishName: "Iris Song", name: "宋照微", role: "Blind Spots & Self-Deception", responsibility: "Check blind spots." },
  { id: "julian-cheng", englishName: "Julian Cheng", name: "程和鸣", role: "Relationships & Social Impact", responsibility: "Check relationship impact." },
  { id: "caleb-gu", englishName: "Caleb Gu", name: "顾安时", role: "Time, Energy & Sustainability", responsibility: "Check time and energy." },
...
const pdcWarmupStages = [
  {
    ...
    "ethan-shen": "Ethan Shen is reviewing evidence...",
    "clara-lin": "Clara Lin is checking emotional pressure...",
    "marcus-lu": "Marcus Lu is stress-testing downside...",
    "adrian-xu": "Adrian Xu is checking long-term opportunity...",
    "felix-jiang": "Felix Jiang is looking for a third path...",
    "iris-song": "Iris Song is checking blind spots...",
    "julian-cheng": "Julian Cheng is checking relationship impact...",
    "caleb-gu": "Caleb Gu is checking time and energy...",
    "orion-zhuge": "Orion Zhuge is checking timing and momentum...",
  },
  {
    "blue-whale": "Blue Whale is aligning the council rhythm...",
    "ethan-shen": "Ethan Shen has found the facts that need checking...",
    "clara-lin": "Clara Lin has sensed the emotional pressure point...",
    "marcus-lu": "Marcus Lu has found the main downside to test...",
    "adrian-xu": "Adrian Xu has spotted the long-term opening...",
    "felix-jiang": "Felix Jiang has found a possible alternative route...",
    "iris-song": "Iris Song has detected a possible self-deception risk...",
    "julian-cheng": "Julian Cheng has mapped who may be affected...",
    "caleb-gu": "Caleb Gu has noticed the energy cost...",
    "orion-zhuge": "Orion Zhuge has read the timing signal...",
  },
  {
    "blue-whale": "Blue Whale is organizing the first round...",
    "ethan-shen": "Ethan Shen is building the evidence frame...",
    "clara-lin": "Clara Lin is shaping the inner-desire question...",
    "marcus-lu": "Marcus Lu is arranging the risk warning...",
    "adrian-xu": "Adrian Xu is ranking the long-term upside...",
    "felix-jiang": "Felix Jiang is turning alternatives into options...",
    "iris-song": "Iris Song is sharpening the mirror question...",
    "julian-cheng": "Julian Cheng is weighing relationship consequences...",
    "caleb-gu": "Caleb Gu is balancing time and sustainability...",
    "orion-zhuge": "Orion Zhuge is setting the momentum frame...",
  },
  {
    "blue-whale": "Blue Whale is connecting the council to your decision...",
    "ethan-shen": "Ethan Shen is tying evidence back to the question...",
    "clara-lin": "Clara Lin is checking what the choice may emotionally cost...",
    "marcus-lu": "Marcus Lu is checking what could go wrong first...",
    "adrian-xu": "Adrian Xu is checking what future this decision may open...",
    "felix-jiang": "Felix Jiang is checking whether there is a third path...",
    "iris-song": "Iris Song is checking what assumption may be hidden...",
    "julian-cheng": "Julian Cheng is checking who else may be affected...",
    "caleb-gu": "Caleb Gu is checking whether the choice can be sustained...",
  ...
  },
  {
    ...
    "ethan-shen": "Ethan Shen is preparing a factual challenge...",
    "clara-lin": "Clara Lin is preparing an emotional counterpoint...",
    "marcus-lu": "Marcus Lu is preparing the downside case...",
    "adrian-xu": "Adrian Xu is preparing the opportunity case...",
    "felix-jiang": "Felix Jiang is preparing an alternative option...",
    "iris-song": "Iris Song is preparing a blind-spot challenge...",
    "julian-cheng": "Julian Cheng is preparing a relationship check...",
    "caleb-gu": "Caleb Gu is preparing an energy constraint...",
    "orion-zhuge": "Orion Zhuge is preparing a timing challenge...",
  },
  {
    "blue-whale": "Blue Whale is narrowing the first conflict...",
    "ethan-shen": "Ethan Shen is selecting the most useful evidence...",
    "clara-lin": "Clara Lin is separating desire from pressure...",
    "marcus-lu": "Marcus Lu is separating risk from fear...",
    "adrian-xu": "Adrian Xu is separating opportunity from fantasy...",
    "felix-jiang": "Felix Jiang is separating real options from distractions...",
    "iris-song": "Iris Song is separating insight from self-protection...",
    "julian-cheng": "Julian Cheng is separating support from social pressure...",
    "caleb-gu": "Caleb Gu is separating ambition from capacity...",
    "orion-zhuge": "Orion Zhuge is separating timing from impatience...",
  },
  {
    "blue-whale": "Blue Whale is preparing the speaking order...",
    "ethan-shen": "Ethan Shen is readying an evidence-based view...",
    "clara-lin": "Clara Lin is readying the emotional signal...",
    "marcus-lu": "Marcus Lu is readying the risk test...",
    "adrian-xu": "Adrian Xu is readying the long-view argument...",
    "felix-jiang": "Felix Jiang is readying the third-path proposal...",
    "iris-song": "Iris Song is readying the mirror question...",
    "julian-cheng": "Julian Cheng is readying the social-impact view...",
    "caleb-gu": "Caleb Gu is readying the sustainability check...",
    "orion-zhuge": "Orion Zhuge is readying the timing frame...",
  },
  {
    "blue-whale": "Blue Whale is waiting for the final council synthesis...",
    "ethan-shen": "Ethan Shen is holding the evidence frame...",
    "clara-lin": "Clara Lin is holding the emotional signal...",
    "marcus-lu": "Marcus Lu is holding the downside test...",
    "adrian-xu": "Adrian Xu is holding the opportunity frame...",
    "felix-jiang": "Felix Jiang is holding the alternative path...",
    "iris-song": "Iris Song is holding the blind-spot mirror...",
    "julian-cheng": "Julian Cheng is holding the relationship map...",
    "caleb-gu": "Caleb Gu is holding the energy boundary...",
    ...
    <section class="pdc-council-room" aria-labelledby="pdc-council-room-title">
      ...
      <div class="pdc-live-room ${selectedPersona ? "has-selected-profile" : ""}">
        ...
        <section class="pdc-dialogue-panel" aria-label="Live Council Dialogue">
          ...
          ${renderPdcDialogue(dialogue, activeSpeakerId, thinkingLine, showPhaseAfterPlayback, isWarmupPhase)}
...
function getPdcPhaseLabel(roundNumber, phaseType) {
  const prefix = Number(roundNumber) >= pdcMaxNormalRound ? `Final Round ${roundNumber}${phaseType}` : `Round ${roundNumber}${phaseType}`;
  return `${prefix} — ${phaseType === "A" ? "Position Update" : "Challenge, Response & Voting"}`;
}
...
function renderPdcDialogue(dialogue, activeSpeakerId = "", thinkingLine = null, phaseComplete = true, isWarmupPhase = false) {
...
function renderPdcFinalRoundPreview(currentRound) {
  ...
  pdcState.finalReenableSkippedReason = observers.length ? (rewarded.tie ? "contribution_vote_tie" : "") : "no_archived_perspective";
  if (observers.length && !pdcState.finalRoundPreviewSelection && !rewarded.tie) pdcState.finalRoundPreviewSelection = observers[0].speakerId;
  return `
    <section class="pdc-final-preview" aria-label="Final Round Preview">
      ...
      <div class="pdc-final-preview-grid">
        <div>
          ...
          ${rewarded.tie ? `<small>Contribution vote tie detected. You may choose an archived perspective manually.</small>` : ""}
        </div>
        <div>
          <strong>Available Archived Perspectives</strong>
          ${observers.length ? observers.map((observer) => `
            <label class="pdc-final-observer-option">
              <input type="radio" name="pdc-final-observer" value="${escapeHtml(observer.speakerId)}" ${pdcState.finalRoundPreviewSelection === observer.speakerId ? "checked" : ""}>
              <span>${escapeHtml(observer.name || observer.speakerId)} · ${escapeHtml(observer.role || "Archived Perspective")}</span>
            </label>
          `).join("") : `<p>No archived perspective is available.</p>`}
        </div>
      </div>
    </section>`;
}
...
function appendPdcMemberHistoryFromPhase(phase, phaseIndex = 0) {
  ...
  (Array.isArray(phase.dialogue) ? phase.dialogue : []).forEach((line, lineIndex) => {
    ...
    if (pdcState.observerRosterIds.includes(line.speakerId) && phase.rosterUpdate?.archivedSpeakerId !== line.speakerId && line.contentSource !== "final-reintroduced") return;
...
function shouldUsePdcLineForHistory(line) {
  ...
  if (line.contentSource === "final-reintroduced") return true;
...
function getPdcMostRewardedContributor() {
  ...
  getPdcPhases(pdcState.recap?.councilRoom || {}).forEach((phase) => {
    (phase.voteSummary?.contributionVotes || []).forEach((vote) => {
      if (!vote?.speakerId) return;
      counts.set(vote.speakerId, (counts.get(vote.speakerId) || 0) + Number(vote.count || 0));
    });
  });
  const rows = Array.from(counts.entries()).sort((a, b) => b[1] - a[1]);
  if (!rows.length) return { speakerId: "", name: "", count: 0, tie: false };
  const [speakerId, count] = rows[0];
  const tie = rows[1] && rows[1][1] === count;
  const persona = findPdcPersonaById(speakerId) || {};
  return { speakerId, name: persona.englishName || persona.name || speakerId, count, tie };
}

function maybeAddPdcFinalReintroducedPerspective(phase) {
  if (!phase || Number(phase.roundNumber) !== pdcMaxNormalRound || pdcState.finalReintroducedPerspective?.added) return;
  const selectedId = pdcState.finalRoundPreviewSelection;
  if (!selectedId || !pdcState.observerRosterIds.includes(selectedId)) return;
  ...
  phase.dialogue = [...(Array.isArray(phase.dialogue) ? phase.dialogue : []), line];
  pdcState.finalReintroducedPerspective = {
    speakerId: selectedId,
    speakerName: name,
    reasonForReintroduction: "Selected in Final Round Preview",
...
function cleanPdcFinalRecapText(value) {
  ...
  if (!text) return "";
  const replacements = [
    [/Ethan Shen\s*\/\s*沈知衡|沈知衡|Ethan Shen/g, "Ethan Shen / 沈知衡"],
    [/Clara Lin\s*\/\s*林问心|林问心|Clara Lin/g, "Clara Lin / 林问心"],
    [/Marcus Lu\s*\/\s*陆守衡|陆守衡|Marcus Lu/g, "Marcus Lu / 陆守衡"],
    [/Adrian Xu\s*\/\s*许望远|许望远|Adrian Xu/g, "Adrian Xu / 许望远"],
    [/Felix Jiang\s*\/\s*(江试舟|姜飞力)|姜飞力|江试舟|Felix Jiang/g, "Felix Jiang / 江试舟"],
    [/Iris Song\s*\/\s*宋照微|宋照微|Iris Song/g, "Iris Song / 宋照微"],
    [/Julian Cheng\s*\/\s*程和鸣|程和鸣|Julian Cheng/g, "Julian Cheng / 程和鸣"],
    [/Caleb Gu\s*\/\s*顾安时|顾安时|Caleb Gu/g, "Caleb Gu / 顾安时"],
...
function getPdcLifecycleDiagnostics(phaseDiagnostics = null) {
  ...
  const reenabled = pdcState.finalReintroducedPerspective || {};
  return {
    ...
    reEnabledObserverName: reenabled.speakerName || "",
